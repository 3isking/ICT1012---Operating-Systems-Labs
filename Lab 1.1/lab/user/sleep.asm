...
main(int argc, char *argv[])
{
  ...
  10:	196000ef          	jal	1a6 <atoi>
    ...
    pause(i);
  14:	344000ef          	jal	358 <pause>

  exit(0);
  18:	4501                	li	a0,0
  1a:	2ae000ef          	jal	2c8 <exit>
        fprintf(2, "usage: sleep [int]\n");
  1e:	00001597          	auipc	a1,0x1
  22:	89258593          	addi	a1,a1,-1902 # 8b0 <malloc+0x100>
  26:	4509                	li	a0,2
  28:	6aa000ef          	jal	6d2 <fprintf>
        exit(1);
  2c:	4505                	li	a0,1
  2e:	29a000ef          	jal	2c8 <exit>
...
stat(const char *n, struct stat *st)
{
 ...
 184:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 186:	85ca                	mv	a1,s2
 188:	198000ef          	jal	320 <fstat>
 18c:	892a                	mv	s2,a0
  close(fd);
 18e:	8526                	mv	a0,s1
 190:	160000ef          	jal	2f0 <close>
  return r;
 194:	64a2                	ld	s1,8(sp)
}
 196:	854a                	mv	a0,s2
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3a8:	52c50513          	addi	a0,a0,1324 # 8d0 <digits>
 3ac:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 646:	28eb8b93          	addi	s7,s7,654 # 8d0 <digits>
 ...
 6a8:	22490913          	addi	s2,s2,548 # 8c8 <malloc+0x118>
        for(; *s; s++)
