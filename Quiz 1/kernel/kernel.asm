...
kfree(void *pa)
{
  ...
  acquire(&kmem.lock);
    ...
    80000056:	055050ef          	jal	800058aa <acquire>
  ...
  release(&kmem.lock);
    ...
    80000066:	0dd050ef          	jal	80005942 <release>
}
    ...
    8000007e:	570050ef          	jal	800055ee <panic>
...
00000000800000ca <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    800000e2:	748050ef          	jal	8000582a <initlock>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80000112:	798050ef          	jal	800058aa <acquire>
  r = kmem.freelist;
  ...
  release(&kmem.lock);
    80000126:	01d050ef          	jal	80005942 <release>
  ...
  release(&kmem.lock);
    ...
    80000148:	7fa050ef          	jal	80005942 <release>
  if(r)
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000316:	7f3040ef          	jal	80005308 <printf>
  ...
  scheduler();        
    ...
    binit();         // buffer cache
    80000376:	3eb010ef          	jal	80001f60 <binit>
    iinit();         // inode table
    8000037a:	170020ef          	jal	800024ea <iinit>
    fileinit();      // file table
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  if(va >= MAXVA)
    ...
    800003f0:	1fe050ef          	jal	800055ee <panic>
...
000000008000054a <kvmmap>:
{
  ...
  if(mappages(kpgtbl, va, sz, pa, perm) != 0)
    ...
    8000056e:	080050ef          	jal	800055ee <panic>
...
uvmunmap(pagetable_t pagetable, uint64 va, uint64 npages, int do_free)
{
  ...
  for(a = va; a < va + npages*PGSIZE; a += PGSIZE){
    ...
    800006a8:	747040ef          	jal	800055ee <panic>
      continue;
    if(do_free){
...
freewalk(pagetable_t pagetable)
{
  ...
  for(int i = 0; i < 512; i++){
    ...
    80000820:	5cf040ef          	jal	800055ee <panic>
    }
  }
...
uvmclear(pagetable_t pagetable, uint64 va)
{
  ...
  *pte &= ~PTE_U;
    ...
    80000930:	4bf040ef          	jal	800055ee <panic>
...
proc_mapstacks(pagetable_t kpgtbl)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000c94:	15b040ef          	jal	800055ee <panic>
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    80000cbc:	36f040ef          	jal	8000582a <initlock>
  initlock(&wait_lock, "wait_lock");
    ...
    80000cd0:	35b040ef          	jal	8000582a <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000d14:	317040ef          	jal	8000582a <initlock>
      p->state = UNUSED;
...
myproc(void)
{
  ...
  push_off();
    80000d84:	2e7040ef          	jal	8000586a <push_off>
  ...
  pop_off();
    80000d9a:	355040ef          	jal	800058ee <pop_off>
  return p;
}
...
forkret(void)
{
  ...
  release(&p->lock);
    80000dba:	389040ef          	jal	80005942 <release>
  ...
  if (first) {
    ...
    80000dca:	3dd010ef          	jal	800029a6 <fsinit>
    ...
    80000dee:	4b9020ef          	jal	80003aa6 <kexec>
  ...
  ((void (*)(uint64))trampoline_userret)(satp);
    ...
    80000e3e:	7b0040ef          	jal	800055ee <panic>
...
0000000080000e42 <allocpid>:
{
  ...
  acquire(&pid_lock);
    ...
    80000e58:	253040ef          	jal	800058aa <acquire>
  pid = nextpid;
  ...
  release(&pid_lock);
    ...
    80000e6e:	2d5040ef          	jal	80005942 <release>
}
...
0000000080000f9a <allocproc>:
{
  ...
  p->context.sp = p->kstack + PGSIZE;
    ...
    80001028:	11b040ef          	jal	80005942 <release>
    return 0;
    ...
    80001038:	10b040ef          	jal	80005942 <release>
    return 0;
...
0000000080001040 <userinit>:
{
  ...
  p->cwd = namei("/");
    ...
    80001060:	669010ef          	jal	80002ec8 <namei>
  ...
  release(&p->lock);
    ...
    8000106e:	0d5040ef          	jal	80005942 <release>
}
...
00000000800010cc <kfork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    80001154:	7ee040ef          	jal	80005942 <release>
    return -1;
...
000000008000128c <sched>:
{
  ...
  if(!holding(&p->lock))
    800012a0:	5a0040ef          	jal	80005840 <holding>
...
0000000080001346 <yield>:
{
  ...
  acquire(&p->lock);
    80001356:	554040ef          	jal	800058aa <acquire>
  p->state = RUNNABLE;
  ...
  release(&p->lock);
    ...
    80001364:	5de040ef          	jal	80005942 <release>
}
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  acquire(&p->lock);  //DOC: sleeplock1
    8000138a:	520040ef          	jal	800058aa <acquire>
  release(lk);
    8000138e:	854a                	mv	a0,s2
    80001390:	5b2040ef          	jal	80005942 <release>
  ...
  release(&p->lock);
    ...
    800013a6:	59c040ef          	jal	80005942 <release>
  acquire(lk);
    800013aa:	854a                	mv	a0,s2
    800013ac:	4fe040ef          	jal	800058aa <acquire>
}
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800013ea:	558040ef          	jal	80005942 <release>
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001400:	4aa040ef          	jal	800058aa <acquire>
      if(p->state == SLEEPING && p->chan == chan) {
...
000000008000147e <kexit>:
{
  ...
  if(p == initproc)
    ...
    800014b2:	13c040ef          	jal	800055ee <panic>
      fileclose(f);
    800014b6:	7f3010ef          	jal	800034a8 <fileclose>
      p->ofile[fd] = 0;
  ...
  begin_op();
    800014ca:	3d3010ef          	jal	8000309c <begin_op>
  iput(p->cwd);
    800014ce:	1509b503          	ld	a0,336(s3)
    800014d2:	362010ef          	jal	80002834 <iput>
  end_op();
    800014d6:	431010ef          	jal	80003106 <end_op>
  p->cwd = 0;
  ...
  acquire(&wait_lock);
    ...
    800014e8:	3c2040ef          	jal	800058aa <acquire>
  reparent(p);
  ...
  acquire(&p->lock);
    ...
    800014fc:	3ae040ef          	jal	800058aa <acquire>
  p->xstate = status;
...
kkill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80001542:	368040ef          	jal	800058aa <acquire>
    if(p->pid == pid){
    ...
    8000154e:	3f4040ef          	jal	80005942 <release>
  for(p = proc; p < &proc[NPROC]; p++){
  ...
  return -1;
    ...
    8000156c:	3d6040ef          	jal	80005942 <release>
      return 0;
...
setkilled(struct proc *p)
{
  ...
  acquire(&p->lock);
    80001592:	318040ef          	jal	800058aa <acquire>
  p->killed = 1;
    80001596:	4785                	li	a5,1
    80001598:	d49c                	sw	a5,40(s1)
  release(&p->lock);
    8000159a:	8526                	mv	a0,s1
    8000159c:	3a6040ef          	jal	80005942 <release>
}
...
killed(struct proc *p)
{
  ...
  acquire(&p->lock);
    800015b8:	2f2040ef          	jal	800058aa <acquire>
  k = p->killed;
    800015bc:	0284a903          	lw	s2,40(s1)
  release(&p->lock);
    800015c0:	8526                	mv	a0,s1
    800015c2:	380040ef          	jal	80005942 <release>
  return k;
}
...
00000000800015d4 <kwait>:
{
  ...
  acquire(&wait_lock);
    ...
    800015fc:	2ae040ef          	jal	800058aa <acquire>
    havekids = 0;
    ...
    800016c6:	27c040ef          	jal	80005942 <release>
      return -1;
...
procdump(void)
{
  ...
  printf("\n");
    ...
    80001780:	389030ef          	jal	80005308 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800017be:	34b030ef          	jal	80005308 <printf>
    printf("\n");
    800017c2:	8552                	mv	a0,s4
    800017c4:	345030ef          	jal	80005308 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001888:	7a3030ef          	jal	8000582a <initlock>
}
...
trapinithart(void)
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    8000189e:	f7678793          	addi	a5,a5,-138 # 80004810 <kernelvec>
...
clockintr()
{
  ...
  asm volatile("csrw 0x14d, %0" : : "r" (x));
    ...
    8000195a:	751030ef          	jal	800058aa <acquire>
    ticks++;
    ...
    80001972:	7d1030ef          	jal	80005942 <release>
...
devintr()
{
  ...
  if(scause == 0x8000000000000009L){
    ...
    int irq = plic_claim();
    800019a6:	717020ef          	jal	800048bc <plic_claim>
    ...
    800019be:	bff9                	j	8000199c <devintr+0x22>
      uartintr();
    800019c0:	5ff030ef          	jal	800057be <uartintr>
    if(irq)
    800019c4:	a819                	j	800019da <devintr+0x60>
      virtio_disk_intr();
    800019c6:	3bc030ef          	jal	80004d82 <virtio_disk_intr>
    if(irq)
    ...
    800019d6:	133030ef          	jal	80005308 <printf>
      plic_complete(irq);
    800019da:	8526                	mv	a0,s1
    800019dc:	701020ef          	jal	800048dc <plic_complete>
    return 1;
...
00000000800019ee <usertrap>:
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    80001a08:	e0c78793          	addi	a5,a5,-500 # 80004810 <kernelvec>
  ...
  if(r_scause() == 8){
    ...
    80001a52:	0b7030ef          	jal	80005308 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001a66:	0a3030ef          	jal	80005308 <printf>
    setkilled(p);
    ...
    80001a7a:	375030ef          	jal	800055ee <panic>
    if(killed(p))
...
argraw(int n)
{
  ...
  panic("argraw");
    ...
    80001be8:	207030ef          	jal	800055ee <panic>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80001d2c:	5dc030ef          	jal	80005308 <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
...
sys_pause(void)
{
  ...
  acquire(&tickslock);
    ...
    80001e42:	269030ef          	jal	800058aa <acquire>
  ticks0 = ticks;
  ...
  release(&tickslock);
    ...
    80001e94:	2af030ef          	jal	80005942 <release>
  return 0;
    ...
    80001eb2:	291030ef          	jal	80005942 <release>
      return -1;
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80001ef2:	1b9030ef          	jal	800058aa <acquire>
  xticks = ticks;
  ...
  release(&tickslock);
    ...
    80001f06:	23d030ef          	jal	80005942 <release>
  return xticks;
}
...
{  
  ...
  uint swapped = 
        ((val & 0x000000FF) << 24) | 
    80001f30:	0187951b          	slliw	a0,a5,0x18
        ((val & 0x0000FF00) << 8) | 
        ((val & 0x00FF0000) >> 8) | 
        ((val & 0xFF000000) >> 24);
    80001f34:	0187d71b          	srliw	a4,a5,0x18
  uint swapped = 
    80001f38:	8d59                	or	a0,a0,a4
        ((val & 0x0000FF00) << 8) | 
    80001f3a:	0087971b          	slliw	a4,a5,0x8
    80001f3e:	00ff06b7          	lui	a3,0xff0
    80001f42:	8f75                	and	a4,a4,a3
  uint swapped = 
    80001f44:	8d59                	or	a0,a0,a4
        ((val & 0x00FF0000) >> 8) | 
    80001f46:	0087d79b          	srliw	a5,a5,0x8
    80001f4a:	6741                	lui	a4,0x10
    80001f4c:	f0070713          	addi	a4,a4,-256 # ff00 <_entry-0x7fff0100>
    80001f50:	8ff9                	and	a5,a5,a4
  uint swapped = 
    80001f52:	8d5d                	or	a0,a0,a5

  
  return swapped;
    80001f54:	1502                	slli	a0,a0,0x20
    80001f56:	9101                	srli	a0,a0,0x20
    80001f58:	60e2                	ld	ra,24(sp)
    80001f5a:	6442                	ld	s0,16(sp)
    80001f5c:	6105                	addi	sp,sp,32
    80001f5e:	8082                	ret

0000000080001f60 <binit>:
  struct buf head;
} bcache;
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    80001f70:	00005597          	auipc	a1,0x5
    80001f74:	3c058593          	addi	a1,a1,960 # 80007330 <etext+0x330>
    80001f78:	0000e517          	auipc	a0,0xe
    80001f7c:	0c050513          	addi	a0,a0,192 # 80010038 <bcache>
    80001f80:	0ab030ef          	jal	8000582a <initlock>

  // Create linked list of buffers
  bcache.head.prev = &bcache.head;
    80001f84:	00016797          	auipc	a5,0x16
    80001f88:	0b478793          	addi	a5,a5,180 # 80018038 <bcache+0x8000>
    80001f8c:	00016717          	auipc	a4,0x16
    80001f90:	31470713          	addi	a4,a4,788 # 800182a0 <bcache+0x8268>
    80001f94:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80001f98:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80001f9c:	0000e497          	auipc	s1,0xe
    80001fa0:	0b448493          	addi	s1,s1,180 # 80010050 <bcache+0x18>
    b->next = bcache.head.next;
    80001fa4:	893e                	mv	s2,a5
    b->prev = &bcache.head;
    80001fa6:	89ba                	mv	s3,a4
    initsleeplock(&b->lock, "buffer");
    80001fa8:	00005a17          	auipc	s4,0x5
    80001fac:	390a0a13          	addi	s4,s4,912 # 80007338 <etext+0x338>
    b->next = bcache.head.next;
    80001fb0:	2b893783          	ld	a5,696(s2)
    80001fb4:	e8bc                	sd	a5,80(s1)
    b->prev = &bcache.head;
    80001fb6:	0534b423          	sd	s3,72(s1)
    initsleeplock(&b->lock, "buffer");
    80001fba:	85d2                	mv	a1,s4
    80001fbc:	01048513          	addi	a0,s1,16
    80001fc0:	322010ef          	jal	800032e2 <initsleeplock>
    bcache.head.next->prev = b;
    80001fc4:	2b893783          	ld	a5,696(s2)
    80001fc8:	e7a4                	sd	s1,72(a5)
    bcache.head.next = b;
    80001fca:	2a993c23          	sd	s1,696(s2)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80001fce:	45848493          	addi	s1,s1,1112
    80001fd2:	fd349fe3          	bne	s1,s3,80001fb0 <binit+0x50>
  }
}
...
bread(uint dev, uint blockno)
{
    ...
    80001ff6:	89ae                	mv	s3,a1
  acquire(&bcache.lock);
    80001ff8:	0000e517          	auipc	a0,0xe
    80001ffc:	04050513          	addi	a0,a0,64 # 80010038 <bcache>
    80002000:	0ab030ef          	jal	800058aa <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    80002004:	00016497          	auipc	s1,0x16
    80002008:	2ec4b483          	ld	s1,748(s1) # 800182f0 <bcache+0x82b8>
    8000200c:	00016797          	auipc	a5,0x16
    80002010:	29478793          	addi	a5,a5,660 # 800182a0 <bcache+0x8268>
    80002014:	02f48b63          	beq	s1,a5,8000204a <bread+0x64>
    80002018:	873e                	mv	a4,a5
    8000201a:	a021                	j	80002022 <bread+0x3c>
    8000201c:	68a4                	ld	s1,80(s1)
    8000201e:	02e48663          	beq	s1,a4,8000204a <bread+0x64>
    if(b->dev == dev && b->blockno == blockno){
    80002022:	449c                	lw	a5,8(s1)
    80002024:	ff279ce3          	bne	a5,s2,8000201c <bread+0x36>
    80002028:	44dc                	lw	a5,12(s1)
    8000202a:	ff3799e3          	bne	a5,s3,8000201c <bread+0x36>
      b->refcnt++;
    ...
    80002038:	00450513          	addi	a0,a0,4 # 80010038 <bcache>
    8000203c:	107030ef          	jal	80005942 <release>
      acquiresleep(&b->lock);
    80002040:	01048513          	addi	a0,s1,16
    80002044:	2d4010ef          	jal	80003318 <acquiresleep>
      return b;
    80002048:	a889                	j	8000209a <bread+0xb4>
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    8000204a:	00016497          	auipc	s1,0x16
    8000204e:	29e4b483          	ld	s1,670(s1) # 800182e8 <bcache+0x82b0>
    80002052:	00016797          	auipc	a5,0x16
    80002056:	24e78793          	addi	a5,a5,590 # 800182a0 <bcache+0x8268>
    8000205a:	00f48863          	beq	s1,a5,8000206a <bread+0x84>
    8000205e:	873e                	mv	a4,a5
    if(b->refcnt == 0) {
    80002060:	40bc                	lw	a5,64(s1)
    80002062:	cb91                	beqz	a5,80002076 <bread+0x90>
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    80002064:	64a4                	ld	s1,72(s1)
    80002066:	fee49de3          	bne	s1,a4,80002060 <bread+0x7a>
  panic("bget: no buffers");
    8000206a:	00005517          	auipc	a0,0x5
    8000206e:	2d650513          	addi	a0,a0,726 # 80007340 <etext+0x340>
    80002072:	57c030ef          	jal	800055ee <panic>
      b->dev = dev;
    80002076:	0124a423          	sw	s2,8(s1)
      b->blockno = blockno;
    8000207a:	0134a623          	sw	s3,12(s1)
      b->valid = 0;
    8000207e:	0004a023          	sw	zero,0(s1)
      b->refcnt = 1;
    80002082:	4785                	li	a5,1
    80002084:	c0bc                	sw	a5,64(s1)
      release(&bcache.lock);
    80002086:	0000e517          	auipc	a0,0xe
    8000208a:	fb250513          	addi	a0,a0,-78 # 80010038 <bcache>
    8000208e:	0b5030ef          	jal	80005942 <release>
      acquiresleep(&b->lock);
    80002092:	01048513          	addi	a0,s1,16
    80002096:	282010ef          	jal	80003318 <acquiresleep>
  struct buf *b;

  b = bget(dev, blockno);
  if(!b->valid) {
    8000209a:	409c                	lw	a5,0(s1)
    8000209c:	cb89                	beqz	a5,800020ae <bread+0xc8>
    virtio_disk_rw(b, 0);
    b->valid = 1;
  }
  return b;
    ...
    800020b8:	c09c                	sw	a5,0(s1)
  return b;
    800020ba:	b7d5                	j	8000209e <bread+0xb8>

00000000800020bc <bwrite>:
...
bwrite(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    800020c8:	0541                	addi	a0,a0,16
    800020ca:	2cc010ef          	jal	80003396 <holdingsleep>
    800020ce:	c911                	beqz	a0,800020e2 <bwrite+0x26>
    panic("bwrite");
  virtio_disk_rw(b, 1);
    800020d0:	4585                	li	a1,1
    800020d2:	8526                	mv	a0,s1
    800020d4:	29d020ef          	jal	80004b70 <virtio_disk_rw>
}
    ...
    800020e6:	27650513          	addi	a0,a0,630 # 80007358 <etext+0x358>
    800020ea:	504030ef          	jal	800055ee <panic>

00000000800020ee <brelse>:
...
brelse(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    800020fc:	01050913          	addi	s2,a0,16
    80002100:	854a                	mv	a0,s2
    80002102:	294010ef          	jal	80003396 <holdingsleep>
    80002106:	c135                	beqz	a0,8000216a <brelse+0x7c>
    panic("brelse");

  releasesleep(&b->lock);
    80002108:	854a                	mv	a0,s2
    8000210a:	254010ef          	jal	8000335e <releasesleep>

  acquire(&bcache.lock);
    8000210e:	0000e517          	auipc	a0,0xe
    80002112:	f2a50513          	addi	a0,a0,-214 # 80010038 <bcache>
    80002116:	794030ef          	jal	800058aa <acquire>
  b->refcnt--;
    8000211a:	40bc                	lw	a5,64(s1)
    8000211c:	37fd                	addiw	a5,a5,-1
    8000211e:	0007871b          	sext.w	a4,a5
    80002122:	c0bc                	sw	a5,64(s1)
  if (b->refcnt == 0) {
    80002124:	e71d                	bnez	a4,80002152 <brelse+0x64>
    // no one is waiting for it.
    b->next->prev = b->prev;
    80002126:	68b8                	ld	a4,80(s1)
    80002128:	64bc                	ld	a5,72(s1)
    8000212a:	e73c                	sd	a5,72(a4)
    b->prev->next = b->next;
    8000212c:	68b8                	ld	a4,80(s1)
    8000212e:	ebb8                	sd	a4,80(a5)
    b->next = bcache.head.next;
    80002130:	00016797          	auipc	a5,0x16
    80002134:	f0878793          	addi	a5,a5,-248 # 80018038 <bcache+0x8000>
    80002138:	2b87b703          	ld	a4,696(a5)
    8000213c:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    8000213e:	00016717          	auipc	a4,0x16
    80002142:	16270713          	addi	a4,a4,354 # 800182a0 <bcache+0x8268>
    80002146:	e4b8                	sd	a4,72(s1)
    bcache.head.next->prev = b;
    80002148:	2b87b703          	ld	a4,696(a5)
    8000214c:	e724                	sd	s1,72(a4)
    bcache.head.next = b;
    8000214e:	2a97bc23          	sd	s1,696(a5)
  }
  
  release(&bcache.lock);
    80002152:	0000e517          	auipc	a0,0xe
    80002156:	ee650513          	addi	a0,a0,-282 # 80010038 <bcache>
    8000215a:	7e8030ef          	jal	80005942 <release>
}
    ...
    8000216e:	1f650513          	addi	a0,a0,502 # 80007360 <etext+0x360>
    80002172:	47c030ef          	jal	800055ee <panic>

0000000080002176 <bpin>:
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002186:	eb650513          	addi	a0,a0,-330 # 80010038 <bcache>
    8000218a:	720030ef          	jal	800058aa <acquire>
  b->refcnt++;
    8000218e:	40bc                	lw	a5,64(s1)
    80002190:	2785                	addiw	a5,a5,1
    80002192:	c0bc                	sw	a5,64(s1)
  release(&bcache.lock);
    80002194:	0000e517          	auipc	a0,0xe
    80002198:	ea450513          	addi	a0,a0,-348 # 80010038 <bcache>
    8000219c:	7a6030ef          	jal	80005942 <release>
}
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800021ba:	e8250513          	addi	a0,a0,-382 # 80010038 <bcache>
    800021be:	6ec030ef          	jal	800058aa <acquire>
  b->refcnt--;
    800021c2:	40bc                	lw	a5,64(s1)
    800021c4:	37fd                	addiw	a5,a5,-1
    800021c6:	c0bc                	sw	a5,64(s1)
  release(&bcache.lock);
    800021c8:	0000e517          	auipc	a0,0xe
    800021cc:	e7050513          	addi	a0,a0,-400 # 80010038 <bcache>
    800021d0:	772030ef          	jal	80005942 <release>
}
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    800021ec:	00d5d59b          	srliw	a1,a1,0xd
    800021f0:	00016797          	auipc	a5,0x16
    800021f4:	5247a783          	lw	a5,1316(a5) # 80018714 <sb+0x1c>
    800021f8:	9dbd                	addw	a1,a1,a5
    800021fa:	dedff0ef          	jal	80001fe6 <bread>
  bi = b % BPB;
  m = 1 << (bi % 8);
    800021fe:	0074f713          	andi	a4,s1,7
    80002202:	4785                	li	a5,1
    80002204:	00e797bb          	sllw	a5,a5,a4
  if((bp->data[bi/8] & m) == 0)
    80002208:	14ce                	slli	s1,s1,0x33
    8000220a:	90d9                	srli	s1,s1,0x36
    8000220c:	00950733          	add	a4,a0,s1
    80002210:	05874703          	lbu	a4,88(a4)
    80002214:	00e7f6b3          	and	a3,a5,a4
    80002218:	c29d                	beqz	a3,8000223e <bfree+0x60>
    8000221a:	892a                	mv	s2,a0
    panic("freeing free block");
  bp->data[bi/8] &= ~m;
    8000221c:	94aa                	add	s1,s1,a0
    8000221e:	fff7c793          	not	a5,a5
    80002222:	8f7d                	and	a4,a4,a5
    80002224:	04e48c23          	sb	a4,88(s1)
  log_write(bp);
    80002228:	7f9000ef          	jal	80003220 <log_write>
  brelse(bp);
    8000222c:	854a                	mv	a0,s2
    8000222e:	ec1ff0ef          	jal	800020ee <brelse>
}
    ...
    80002242:	12a50513          	addi	a0,a0,298 # 80007368 <etext+0x368>
    80002246:	3a8030ef          	jal	800055ee <panic>

000000008000224a <balloc>:
{
    8000224a:	711d                	addi	sp,sp,-96
    8000224c:	ec86                	sd	ra,88(sp)
    8000224e:	e8a2                	sd	s0,80(sp)
    80002250:	e4a6                	sd	s1,72(sp)
    80002252:	1080                	addi	s0,sp,96
  for(b = 0; b < sb.size; b += BPB){
    80002254:	00016797          	auipc	a5,0x16
    80002258:	4a87a783          	lw	a5,1192(a5) # 800186fc <sb+0x4>
    8000225c:	0e078f63          	beqz	a5,8000235a <balloc+0x110>
    80002260:	e0ca                	sd	s2,64(sp)
    80002262:	fc4e                	sd	s3,56(sp)
    80002264:	f852                	sd	s4,48(sp)
    80002266:	f456                	sd	s5,40(sp)
    80002268:	f05a                	sd	s6,32(sp)
    8000226a:	ec5e                	sd	s7,24(sp)
    8000226c:	e862                	sd	s8,16(sp)
    8000226e:	e466                	sd	s9,8(sp)
    80002270:	8baa                	mv	s7,a0
    80002272:	4a81                	li	s5,0
    bp = bread(dev, BBLOCK(b, sb));
    80002274:	00016b17          	auipc	s6,0x16
    80002278:	484b0b13          	addi	s6,s6,1156 # 800186f8 <sb>
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
    8000227c:	4c01                	li	s8,0
      m = 1 << (bi % 8);
    8000227e:	4985                	li	s3,1
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
    80002280:	6a09                	lui	s4,0x2
  for(b = 0; b < sb.size; b += BPB){
    80002282:	6c89                	lui	s9,0x2
    80002284:	a0b5                	j	800022f0 <balloc+0xa6>
        bp->data[bi/8] |= m;  // Mark block in use.
    80002286:	97ca                	add	a5,a5,s2
    80002288:	8e55                	or	a2,a2,a3
    8000228a:	04c78c23          	sb	a2,88(a5)
        log_write(bp);
    8000228e:	854a                	mv	a0,s2
    80002290:	791000ef          	jal	80003220 <log_write>
        brelse(bp);
    80002294:	854a                	mv	a0,s2
    80002296:	e59ff0ef          	jal	800020ee <brelse>
  bp = bread(dev, bno);
    8000229a:	85a6                	mv	a1,s1
    8000229c:	855e                	mv	a0,s7
    8000229e:	d49ff0ef          	jal	80001fe6 <bread>
    800022a2:	892a                	mv	s2,a0
  memset(bp->data, 0, BSIZE);
    800022a4:	40000613          	li	a2,1024
    800022a8:	4581                	li	a1,0
    800022aa:	05850513          	addi	a0,a0,88
    800022ae:	ea1fd0ef          	jal	8000014e <memset>
  log_write(bp);
    800022b2:	854a                	mv	a0,s2
    800022b4:	76d000ef          	jal	80003220 <log_write>
  brelse(bp);
    800022b8:	854a                	mv	a0,s2
    800022ba:	e35ff0ef          	jal	800020ee <brelse>
}
    800022be:	6906                	ld	s2,64(sp)
    800022c0:	79e2                	ld	s3,56(sp)
    800022c2:	7a42                	ld	s4,48(sp)
    800022c4:	7aa2                	ld	s5,40(sp)
    800022c6:	7b02                	ld	s6,32(sp)
    800022c8:	6be2                	ld	s7,24(sp)
    800022ca:	6c42                	ld	s8,16(sp)
    800022cc:	6ca2                	ld	s9,8(sp)
}
    800022ce:	8526                	mv	a0,s1
    800022d0:	60e6                	ld	ra,88(sp)
    800022d2:	6446                	ld	s0,80(sp)
    800022d4:	64a6                	ld	s1,72(sp)
    800022d6:	6125                	addi	sp,sp,96
    800022d8:	8082                	ret
    brelse(bp);
    800022da:	854a                	mv	a0,s2
    800022dc:	e13ff0ef          	jal	800020ee <brelse>
  for(b = 0; b < sb.size; b += BPB){
    800022e0:	015c87bb          	addw	a5,s9,s5
    800022e4:	00078a9b          	sext.w	s5,a5
    800022e8:	004b2703          	lw	a4,4(s6)
    800022ec:	04eaff63          	bgeu	s5,a4,8000234a <balloc+0x100>
    bp = bread(dev, BBLOCK(b, sb));
    800022f0:	41fad79b          	sraiw	a5,s5,0x1f
    800022f4:	0137d79b          	srliw	a5,a5,0x13
    800022f8:	015787bb          	addw	a5,a5,s5
    800022fc:	40d7d79b          	sraiw	a5,a5,0xd
    80002300:	01cb2583          	lw	a1,28(s6)
    80002304:	9dbd                	addw	a1,a1,a5
    80002306:	855e                	mv	a0,s7
    80002308:	cdfff0ef          	jal	80001fe6 <bread>
    8000230c:	892a                	mv	s2,a0
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
    8000230e:	004b2503          	lw	a0,4(s6)
    80002312:	000a849b          	sext.w	s1,s5
    80002316:	8762                	mv	a4,s8
    80002318:	fca4f1e3          	bgeu	s1,a0,800022da <balloc+0x90>
      m = 1 << (bi % 8);
    8000231c:	00777693          	andi	a3,a4,7
    80002320:	00d996bb          	sllw	a3,s3,a3
      if((bp->data[bi/8] & m) == 0){  // Is block free?
    80002324:	41f7579b          	sraiw	a5,a4,0x1f
    80002328:	01d7d79b          	srliw	a5,a5,0x1d
    8000232c:	9fb9                	addw	a5,a5,a4
    8000232e:	4037d79b          	sraiw	a5,a5,0x3
    80002332:	00f90633          	add	a2,s2,a5
    80002336:	05864603          	lbu	a2,88(a2)
    8000233a:	00c6f5b3          	and	a1,a3,a2
    8000233e:	d5a1                	beqz	a1,80002286 <balloc+0x3c>
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
    80002340:	2705                	addiw	a4,a4,1
    80002342:	2485                	addiw	s1,s1,1
    80002344:	fd471ae3          	bne	a4,s4,80002318 <balloc+0xce>
    80002348:	bf49                	j	800022da <balloc+0x90>
  ...
  printf("balloc: out of blocks\n");
    ...
    8000235e:	02650513          	addi	a0,a0,38 # 80007380 <etext+0x380>
    80002362:	7a7020ef          	jal	80005308 <printf>
  return 0;
    80002366:	4481                	li	s1,0
    80002368:	b79d                	j	800022ce <balloc+0x84>

000000008000236a <bmap>:
...
bmap(struct inode *ip, uint bn)
{
    ...
    80002378:	89aa                	mv	s3,a0
  uint addr, *a;
  struct buf *bp;

  if(bn < NDIRECT){
    8000237a:	47ad                	li	a5,11
    8000237c:	02b7e663          	bltu	a5,a1,800023a8 <bmap+0x3e>
    if((addr = ip->addrs[bn]) == 0){
    80002380:	02059793          	slli	a5,a1,0x20
    80002384:	01e7d593          	srli	a1,a5,0x1e
    80002388:	00b504b3          	add	s1,a0,a1
    8000238c:	0504a903          	lw	s2,80(s1)
    80002390:	06091a63          	bnez	s2,80002404 <bmap+0x9a>
      addr = balloc(ip->dev);
    80002394:	4108                	lw	a0,0(a0)
    80002396:	eb5ff0ef          	jal	8000224a <balloc>
    8000239a:	0005091b          	sext.w	s2,a0
      if(addr == 0)
    8000239e:	06090363          	beqz	s2,80002404 <bmap+0x9a>
        return 0;
      ip->addrs[bn] = addr;
    800023a2:	0524a823          	sw	s2,80(s1)
    800023a6:	a8b9                	j	80002404 <bmap+0x9a>
    }
    return addr;
  }
  bn -= NDIRECT;
    800023a8:	ff45849b          	addiw	s1,a1,-12
    800023ac:	0004871b          	sext.w	a4,s1

  if(bn < NINDIRECT){
    800023b0:	0ff00793          	li	a5,255
    800023b4:	06e7ee63          	bltu	a5,a4,80002430 <bmap+0xc6>
    // Load indirect block, allocating if necessary.
    if((addr = ip->addrs[NDIRECT]) == 0){
    800023b8:	08052903          	lw	s2,128(a0)
    800023bc:	00091d63          	bnez	s2,800023d6 <bmap+0x6c>
      addr = balloc(ip->dev);
    800023c0:	4108                	lw	a0,0(a0)
    800023c2:	e89ff0ef          	jal	8000224a <balloc>
    800023c6:	0005091b          	sext.w	s2,a0
      if(addr == 0)
    800023ca:	02090d63          	beqz	s2,80002404 <bmap+0x9a>
    800023ce:	e052                	sd	s4,0(sp)
        return 0;
      ip->addrs[NDIRECT] = addr;
    800023d0:	0929a023          	sw	s2,128(s3)
    800023d4:	a011                	j	800023d8 <bmap+0x6e>
    800023d6:	e052                	sd	s4,0(sp)
    }
    bp = bread(ip->dev, addr);
    800023d8:	85ca                	mv	a1,s2
    800023da:	0009a503          	lw	a0,0(s3)
    800023de:	c09ff0ef          	jal	80001fe6 <bread>
    800023e2:	8a2a                	mv	s4,a0
    a = (uint*)bp->data;
    800023e4:	05850793          	addi	a5,a0,88
    if((addr = a[bn]) == 0){
    800023e8:	02049713          	slli	a4,s1,0x20
    800023ec:	01e75593          	srli	a1,a4,0x1e
    800023f0:	00b784b3          	add	s1,a5,a1
    800023f4:	0004a903          	lw	s2,0(s1)
    800023f8:	00090e63          	beqz	s2,80002414 <bmap+0xaa>
      if(addr){
        a[bn] = addr;
        log_write(bp);
      }
    ...
    800023fe:	cf1ff0ef          	jal	800020ee <brelse>
    return addr;
  ...
  panic("bmap: out of range");
    ...
    80002412:	8082                	ret
      addr = balloc(ip->dev);
    80002414:	0009a503          	lw	a0,0(s3)
    80002418:	e33ff0ef          	jal	8000224a <balloc>
    8000241c:	0005091b          	sext.w	s2,a0
      if(addr){
    80002420:	fc090ee3          	beqz	s2,800023fc <bmap+0x92>
        a[bn] = addr;
    80002424:	0124a023          	sw	s2,0(s1)
        log_write(bp);
    80002428:	8552                	mv	a0,s4
    8000242a:	5f7000ef          	jal	80003220 <log_write>
    8000242e:	b7f9                	j	800023fc <bmap+0x92>
    80002430:	e052                	sd	s4,0(sp)
  panic("bmap: out of range");
    80002432:	00005517          	auipc	a0,0x5
    80002436:	f6650513          	addi	a0,a0,-154 # 80007398 <etext+0x398>
    8000243a:	1b4030ef          	jal	800055ee <panic>

000000008000243e <iget>:
{
    ...
    80002450:	8a2e                	mv	s4,a1
  acquire(&itable.lock);
    80002452:	00016517          	auipc	a0,0x16
    80002456:	2c650513          	addi	a0,a0,710 # 80018718 <itable>
    8000245a:	450030ef          	jal	800058aa <acquire>
  empty = 0;
    8000245e:	4901                	li	s2,0
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    80002460:	00016497          	auipc	s1,0x16
    80002464:	2d048493          	addi	s1,s1,720 # 80018730 <itable+0x18>
    80002468:	00018697          	auipc	a3,0x18
    8000246c:	d5868693          	addi	a3,a3,-680 # 8001a1c0 <log>
    80002470:	a039                	j	8000247e <iget+0x40>
    if(empty == 0 && ip->ref == 0)    // Remember empty slot.
    80002472:	02090963          	beqz	s2,800024a4 <iget+0x66>
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    80002476:	08848493          	addi	s1,s1,136
    8000247a:	02d48863          	beq	s1,a3,800024aa <iget+0x6c>
    if(ip->ref > 0 && ip->dev == dev && ip->inum == inum){
    8000247e:	449c                	lw	a5,8(s1)
    80002480:	fef059e3          	blez	a5,80002472 <iget+0x34>
    80002484:	4098                	lw	a4,0(s1)
    80002486:	ff3716e3          	bne	a4,s3,80002472 <iget+0x34>
    8000248a:	40d8                	lw	a4,4(s1)
    8000248c:	ff4713e3          	bne	a4,s4,80002472 <iget+0x34>
      ip->ref++;
    80002490:	2785                	addiw	a5,a5,1
    80002492:	c49c                	sw	a5,8(s1)
      release(&itable.lock);
    80002494:	00016517          	auipc	a0,0x16
    80002498:	28450513          	addi	a0,a0,644 # 80018718 <itable>
    8000249c:	4a6030ef          	jal	80005942 <release>
      return ip;
    800024a0:	8926                	mv	s2,s1
    800024a2:	a02d                	j	800024cc <iget+0x8e>
    if(empty == 0 && ip->ref == 0)    // Remember empty slot.
    800024a4:	fbe9                	bnez	a5,80002476 <iget+0x38>
      empty = ip;
    800024a6:	8926                	mv	s2,s1
    800024a8:	b7f9                	j	80002476 <iget+0x38>
  if(empty == 0)
    800024aa:	02090a63          	beqz	s2,800024de <iget+0xa0>
  ip->dev = dev;
    800024ae:	01392023          	sw	s3,0(s2)
  ip->inum = inum;
    800024b2:	01492223          	sw	s4,4(s2)
  ip->ref = 1;
    800024b6:	4785                	li	a5,1
    800024b8:	00f92423          	sw	a5,8(s2)
  ip->valid = 0;
    800024bc:	04092023          	sw	zero,64(s2)
  release(&itable.lock);
    800024c0:	00016517          	auipc	a0,0x16
    800024c4:	25850513          	addi	a0,a0,600 # 80018718 <itable>
    800024c8:	47a030ef          	jal	80005942 <release>
}
    ...
    800024e2:	ed250513          	addi	a0,a0,-302 # 800073b0 <etext+0x3b0>
    800024e6:	108030ef          	jal	800055ee <panic>

00000000800024ea <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    800024fc:	ec858593          	addi	a1,a1,-312 # 800073c0 <etext+0x3c0>
    80002500:	00016517          	auipc	a0,0x16
    80002504:	21850513          	addi	a0,a0,536 # 80018718 <itable>
    80002508:	322030ef          	jal	8000582a <initlock>
  for(i = 0; i < NINODE; i++) {
    8000250c:	00016497          	auipc	s1,0x16
    80002510:	23448493          	addi	s1,s1,564 # 80018740 <itable+0x28>
    80002514:	00018997          	auipc	s3,0x18
    80002518:	cbc98993          	addi	s3,s3,-836 # 8001a1d0 <log+0x10>
    initsleeplock(&itable.inode[i].lock, "inode");
    8000251c:	00005917          	auipc	s2,0x5
    80002520:	eac90913          	addi	s2,s2,-340 # 800073c8 <etext+0x3c8>
    80002524:	85ca                	mv	a1,s2
    80002526:	8526                	mv	a0,s1
    80002528:	5bb000ef          	jal	800032e2 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
    8000252c:	08848493          	addi	s1,s1,136
    80002530:	ff349ae3          	bne	s1,s3,80002524 <iinit+0x3a>
}
...
0000000080002542 <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    8000254a:	00016717          	auipc	a4,0x16
    8000254e:	1ba72703          	lw	a4,442(a4) # 80018704 <sb+0xc>
    80002552:	4785                	li	a5,1
    80002554:	06e7f063          	bgeu	a5,a4,800025b4 <ialloc+0x72>
    ...
    80002562:	e05a                	sd	s6,0(sp)
    80002564:	8aaa                	mv	s5,a0
    80002566:	8b2e                	mv	s6,a1
    80002568:	4905                	li	s2,1
    bp = bread(dev, IBLOCK(inum, sb));
    8000256a:	00016a17          	auipc	s4,0x16
    8000256e:	18ea0a13          	addi	s4,s4,398 # 800186f8 <sb>
    80002572:	00495593          	srli	a1,s2,0x4
    80002576:	018a2783          	lw	a5,24(s4)
    8000257a:	9dbd                	addw	a1,a1,a5
    8000257c:	8556                	mv	a0,s5
    8000257e:	a69ff0ef          	jal	80001fe6 <bread>
    80002582:	84aa                	mv	s1,a0
    dip = (struct dinode*)bp->data + inum%IPB;
    80002584:	05850993          	addi	s3,a0,88
    80002588:	00f97793          	andi	a5,s2,15
    8000258c:	079a                	slli	a5,a5,0x6
    8000258e:	99be                	add	s3,s3,a5
    if(dip->type == 0){  // a free inode
    80002590:	00099783          	lh	a5,0(s3)
    80002594:	cb9d                	beqz	a5,800025ca <ialloc+0x88>
    brelse(bp);
    80002596:	b59ff0ef          	jal	800020ee <brelse>
  for(inum = 1; inum < sb.ninodes; inum++){
    8000259a:	0905                	addi	s2,s2,1
    8000259c:	00ca2703          	lw	a4,12(s4)
    800025a0:	0009079b          	sext.w	a5,s2
    800025a4:	fce7e7e3          	bltu	a5,a4,80002572 <ialloc+0x30>
    800025a8:	74a2                	ld	s1,40(sp)
    800025aa:	7902                	ld	s2,32(sp)
    800025ac:	69e2                	ld	s3,24(sp)
    800025ae:	6a42                	ld	s4,16(sp)
    800025b0:	6aa2                	ld	s5,8(sp)
    800025b2:	6b02                	ld	s6,0(sp)
  printf("ialloc: no inodes\n");
    800025b4:	00005517          	auipc	a0,0x5
    800025b8:	e1c50513          	addi	a0,a0,-484 # 800073d0 <etext+0x3d0>
    800025bc:	54d020ef          	jal	80005308 <printf>
  return 0;
    800025c0:	4501                	li	a0,0
}
    800025c2:	70e2                	ld	ra,56(sp)
    800025c4:	7442                	ld	s0,48(sp)
    800025c6:	6121                	addi	sp,sp,64
    800025c8:	8082                	ret
      memset(dip, 0, sizeof(*dip));
    800025ca:	04000613          	li	a2,64
    800025ce:	4581                	li	a1,0
    800025d0:	854e                	mv	a0,s3
    800025d2:	b7dfd0ef          	jal	8000014e <memset>
      dip->type = type;
    800025d6:	01699023          	sh	s6,0(s3)
      log_write(bp);   // mark it allocated on the disk
    800025da:	8526                	mv	a0,s1
    800025dc:	445000ef          	jal	80003220 <log_write>
      brelse(bp);
    800025e0:	8526                	mv	a0,s1
    800025e2:	b0dff0ef          	jal	800020ee <brelse>
      return iget(dev, inum);
    800025e6:	0009059b          	sext.w	a1,s2
    800025ea:	8556                	mv	a0,s5
    800025ec:	e53ff0ef          	jal	8000243e <iget>
    ...
    800025fa:	6b02                	ld	s6,0(sp)
    800025fc:	b7d9                	j	800025c2 <ialloc+0x80>

00000000800025fe <iupdate>:
{
    800025fe:	1101                	addi	sp,sp,-32
    80002600:	ec06                	sd	ra,24(sp)
    80002602:	e822                	sd	s0,16(sp)
    80002604:	e426                	sd	s1,8(sp)
    80002606:	e04a                	sd	s2,0(sp)
    80002608:	1000                	addi	s0,sp,32
    8000260a:	84aa                	mv	s1,a0
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    8000260c:	415c                	lw	a5,4(a0)
    8000260e:	0047d79b          	srliw	a5,a5,0x4
    80002612:	00016597          	auipc	a1,0x16
    80002616:	0fe5a583          	lw	a1,254(a1) # 80018710 <sb+0x18>
    8000261a:	9dbd                	addw	a1,a1,a5
    8000261c:	4108                	lw	a0,0(a0)
    8000261e:	9c9ff0ef          	jal	80001fe6 <bread>
    80002622:	892a                	mv	s2,a0
  dip = (struct dinode*)bp->data + ip->inum%IPB;
    80002624:	05850793          	addi	a5,a0,88
    80002628:	40d8                	lw	a4,4(s1)
    8000262a:	8b3d                	andi	a4,a4,15
    8000262c:	071a                	slli	a4,a4,0x6
    8000262e:	97ba                	add	a5,a5,a4
  dip->type = ip->type;
    80002630:	04449703          	lh	a4,68(s1)
    80002634:	00e79023          	sh	a4,0(a5)
  dip->major = ip->major;
    80002638:	04649703          	lh	a4,70(s1)
    8000263c:	00e79123          	sh	a4,2(a5)
  dip->minor = ip->minor;
    80002640:	04849703          	lh	a4,72(s1)
    80002644:	00e79223          	sh	a4,4(a5)
  dip->nlink = ip->nlink;
    80002648:	04a49703          	lh	a4,74(s1)
    8000264c:	00e79323          	sh	a4,6(a5)
  dip->size = ip->size;
    80002650:	44f8                	lw	a4,76(s1)
    80002652:	c798                	sw	a4,8(a5)
  memmove(dip->addrs, ip->addrs, sizeof(ip->addrs));
    80002654:	03400613          	li	a2,52
    80002658:	05048593          	addi	a1,s1,80
    8000265c:	00c78513          	addi	a0,a5,12
    80002660:	b4bfd0ef          	jal	800001aa <memmove>
  log_write(bp);
    80002664:	854a                	mv	a0,s2
    80002666:	3bb000ef          	jal	80003220 <log_write>
  brelse(bp);
    8000266a:	854a                	mv	a0,s2
    8000266c:	a83ff0ef          	jal	800020ee <brelse>
}
...
000000008000267c <idup>:
{
  ...
  acquire(&itable.lock);
    80002688:	00016517          	auipc	a0,0x16
    8000268c:	09050513          	addi	a0,a0,144 # 80018718 <itable>
    80002690:	21a030ef          	jal	800058aa <acquire>
  ip->ref++;
    80002694:	449c                	lw	a5,8(s1)
    80002696:	2785                	addiw	a5,a5,1
    80002698:	c49c                	sw	a5,8(s1)
  release(&itable.lock);
    8000269a:	00016517          	auipc	a0,0x16
    8000269e:	07e50513          	addi	a0,a0,126 # 80018718 <itable>
    800026a2:	2a0030ef          	jal	80005942 <release>
}
...
00000000800026b2 <ilock>:
{
  ...
  if(ip == 0 || ip->ref < 1)
    800026bc:	cd19                	beqz	a0,800026da <ilock+0x28>
    800026be:	84aa                	mv	s1,a0
    800026c0:	451c                	lw	a5,8(a0)
    800026c2:	00f05c63          	blez	a5,800026da <ilock+0x28>
  acquiresleep(&ip->lock);
    800026c6:	0541                	addi	a0,a0,16
    800026c8:	451000ef          	jal	80003318 <acquiresleep>
  if(ip->valid == 0){
    800026cc:	40bc                	lw	a5,64(s1)
    800026ce:	cf89                	beqz	a5,800026e8 <ilock+0x36>
}
    ...
    800026d8:	8082                	ret
    800026da:	e04a                	sd	s2,0(sp)
    panic("ilock");
    800026dc:	00005517          	auipc	a0,0x5
    800026e0:	d0c50513          	addi	a0,a0,-756 # 800073e8 <etext+0x3e8>
    800026e4:	70b020ef          	jal	800055ee <panic>
    800026e8:	e04a                	sd	s2,0(sp)
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    800026ea:	40dc                	lw	a5,4(s1)
    800026ec:	0047d79b          	srliw	a5,a5,0x4
    800026f0:	00016597          	auipc	a1,0x16
    800026f4:	0205a583          	lw	a1,32(a1) # 80018710 <sb+0x18>
    800026f8:	9dbd                	addw	a1,a1,a5
    800026fa:	4088                	lw	a0,0(s1)
    800026fc:	8ebff0ef          	jal	80001fe6 <bread>
    80002700:	892a                	mv	s2,a0
    dip = (struct dinode*)bp->data + ip->inum%IPB;
    80002702:	05850593          	addi	a1,a0,88
    80002706:	40dc                	lw	a5,4(s1)
    80002708:	8bbd                	andi	a5,a5,15
    8000270a:	079a                	slli	a5,a5,0x6
    8000270c:	95be                	add	a1,a1,a5
    ip->type = dip->type;
    8000270e:	00059783          	lh	a5,0(a1)
    80002712:	04f49223          	sh	a5,68(s1)
    ip->major = dip->major;
    80002716:	00259783          	lh	a5,2(a1)
    8000271a:	04f49323          	sh	a5,70(s1)
    ip->minor = dip->minor;
    8000271e:	00459783          	lh	a5,4(a1)
    80002722:	04f49423          	sh	a5,72(s1)
    ip->nlink = dip->nlink;
    80002726:	00659783          	lh	a5,6(a1)
    8000272a:	04f49523          	sh	a5,74(s1)
    ip->size = dip->size;
    8000272e:	459c                	lw	a5,8(a1)
    80002730:	c4fc                	sw	a5,76(s1)
    memmove(ip->addrs, dip->addrs, sizeof(ip->addrs));
    80002732:	03400613          	li	a2,52
    80002736:	05b1                	addi	a1,a1,12
    80002738:	05048513          	addi	a0,s1,80
    8000273c:	a6ffd0ef          	jal	800001aa <memmove>
    brelse(bp);
    80002740:	854a                	mv	a0,s2
    80002742:	9adff0ef          	jal	800020ee <brelse>
    ip->valid = 1;
    80002746:	4785                	li	a5,1
    80002748:	c0bc                	sw	a5,64(s1)
    if(ip->type == 0)
    8000274a:	04449783          	lh	a5,68(s1)
    8000274e:	c399                	beqz	a5,80002754 <ilock+0xa2>
    80002750:	6902                	ld	s2,0(sp)
    80002752:	bfbd                	j	800026d0 <ilock+0x1e>
      panic("ilock: no type");
    80002754:	00005517          	auipc	a0,0x5
    80002758:	c9c50513          	addi	a0,a0,-868 # 800073f0 <etext+0x3f0>
    8000275c:	693020ef          	jal	800055ee <panic>

0000000080002760 <iunlock>:
{
  ...
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
    8000276c:	c505                	beqz	a0,80002794 <iunlock+0x34>
    8000276e:	84aa                	mv	s1,a0
    80002770:	01050913          	addi	s2,a0,16
    80002774:	854a                	mv	a0,s2
    80002776:	421000ef          	jal	80003396 <holdingsleep>
    8000277a:	cd09                	beqz	a0,80002794 <iunlock+0x34>
    8000277c:	449c                	lw	a5,8(s1)
    8000277e:	00f05b63          	blez	a5,80002794 <iunlock+0x34>
  releasesleep(&ip->lock);
    80002782:	854a                	mv	a0,s2
    80002784:	3db000ef          	jal	8000335e <releasesleep>
}
    ...
    80002798:	c6c50513          	addi	a0,a0,-916 # 80007400 <etext+0x400>
    8000279c:	653020ef          	jal	800055ee <panic>

00000000800027a0 <itrunc>:
...
itrunc(struct inode *ip)
{
  ...
  for(i = 0; i < NDIRECT; i++){
    800027b0:	05050493          	addi	s1,a0,80
    800027b4:	08050913          	addi	s2,a0,128
    800027b8:	a021                	j	800027c0 <itrunc+0x20>
    800027ba:	0491                	addi	s1,s1,4
    800027bc:	01248b63          	beq	s1,s2,800027d2 <itrunc+0x32>
    if(ip->addrs[i]){
    800027c0:	408c                	lw	a1,0(s1)
    800027c2:	dde5                	beqz	a1,800027ba <itrunc+0x1a>
      bfree(ip->dev, ip->addrs[i]);
    800027c4:	0009a503          	lw	a0,0(s3)
    800027c8:	a17ff0ef          	jal	800021de <bfree>
      ip->addrs[i] = 0;
    800027cc:	0004a023          	sw	zero,0(s1)
    800027d0:	b7ed                	j	800027ba <itrunc+0x1a>
    }
  }

  if(ip->addrs[NDIRECT]){
    800027d2:	0809a583          	lw	a1,128(s3)
    800027d6:	ed89                	bnez	a1,800027f0 <itrunc+0x50>
    brelse(bp);
  ...
  ip->size = 0;
    800027d8:	0409a623          	sw	zero,76(s3)
  iupdate(ip);
    800027dc:	854e                	mv	a0,s3
    800027de:	e21ff0ef          	jal	800025fe <iupdate>
}
    ...
    800027f6:	ff0ff0ef          	jal	80001fe6 <bread>
    800027fa:	8a2a                	mv	s4,a0
    for(j = 0; j < NINDIRECT; j++){
    800027fc:	05850493          	addi	s1,a0,88
    80002800:	45850913          	addi	s2,a0,1112
    80002804:	a021                	j	8000280c <itrunc+0x6c>
    80002806:	0491                	addi	s1,s1,4
    80002808:	01248963          	beq	s1,s2,8000281a <itrunc+0x7a>
      if(a[j])
    8000280c:	408c                	lw	a1,0(s1)
    8000280e:	dde5                	beqz	a1,80002806 <itrunc+0x66>
        bfree(ip->dev, a[j]);
    80002810:	0009a503          	lw	a0,0(s3)
    80002814:	9cbff0ef          	jal	800021de <bfree>
    80002818:	b7fd                	j	80002806 <itrunc+0x66>
    brelse(bp);
    8000281a:	8552                	mv	a0,s4
    8000281c:	8d3ff0ef          	jal	800020ee <brelse>
    bfree(ip->dev, ip->addrs[NDIRECT]);
    80002820:	0809a583          	lw	a1,128(s3)
    80002824:	0009a503          	lw	a0,0(s3)
    80002828:	9b7ff0ef          	jal	800021de <bfree>
    ip->addrs[NDIRECT] = 0;
    8000282c:	0809a023          	sw	zero,128(s3)
    80002830:	6a02                	ld	s4,0(sp)
    80002832:	b75d                	j	800027d8 <itrunc+0x38>

0000000080002834 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80002844:	ed850513          	addi	a0,a0,-296 # 80018718 <itable>
    80002848:	062030ef          	jal	800058aa <acquire>
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    8000284c:	4498                	lw	a4,8(s1)
    8000284e:	4785                	li	a5,1
    80002850:	02f70063          	beq	a4,a5,80002870 <iput+0x3c>
  ip->ref--;
    80002854:	449c                	lw	a5,8(s1)
    80002856:	37fd                	addiw	a5,a5,-1
    80002858:	c49c                	sw	a5,8(s1)
  release(&itable.lock);
    8000285a:	00016517          	auipc	a0,0x16
    8000285e:	ebe50513          	addi	a0,a0,-322 # 80018718 <itable>
    80002862:	0e0030ef          	jal	80005942 <release>
}
    ...
    8000286e:	8082                	ret
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    80002870:	40bc                	lw	a5,64(s1)
    80002872:	d3ed                	beqz	a5,80002854 <iput+0x20>
    80002874:	04a49783          	lh	a5,74(s1)
    80002878:	fff1                	bnez	a5,80002854 <iput+0x20>
    8000287a:	e04a                	sd	s2,0(sp)
    acquiresleep(&ip->lock);
    8000287c:	01048913          	addi	s2,s1,16
    80002880:	854a                	mv	a0,s2
    80002882:	297000ef          	jal	80003318 <acquiresleep>
    release(&itable.lock);
    80002886:	00016517          	auipc	a0,0x16
    8000288a:	e9250513          	addi	a0,a0,-366 # 80018718 <itable>
    8000288e:	0b4030ef          	jal	80005942 <release>
    itrunc(ip);
    80002892:	8526                	mv	a0,s1
    80002894:	f0dff0ef          	jal	800027a0 <itrunc>
    ip->type = 0;
    80002898:	04049223          	sh	zero,68(s1)
    iupdate(ip);
    8000289c:	8526                	mv	a0,s1
    8000289e:	d61ff0ef          	jal	800025fe <iupdate>
    ip->valid = 0;
    800028a2:	0404a023          	sw	zero,64(s1)
    releasesleep(&ip->lock);
    800028a6:	854a                	mv	a0,s2
    800028a8:	2b7000ef          	jal	8000335e <releasesleep>
    acquire(&itable.lock);
    800028ac:	00016517          	auipc	a0,0x16
    800028b0:	e6c50513          	addi	a0,a0,-404 # 80018718 <itable>
    800028b4:	7f7020ef          	jal	800058aa <acquire>
    800028b8:	6902                	ld	s2,0(sp)
    800028ba:	bf69                	j	80002854 <iput+0x20>

00000000800028bc <iunlockput>:
{
  ...
  iunlock(ip);
    800028c8:	e99ff0ef          	jal	80002760 <iunlock>
  iput(ip);
    800028cc:	8526                	mv	a0,s1
    800028ce:	f67ff0ef          	jal	80002834 <iput>
}
...
00000000800028dc <ireclaim>:
  for (int inum = 1; inum < sb.ninodes; inum++) {
    800028dc:	00016717          	auipc	a4,0x16
    800028e0:	e2872703          	lw	a4,-472(a4) # 80018704 <sb+0xc>
    800028e4:	4785                	li	a5,1
    800028e6:	0ae7ff63          	bgeu	a5,a4,800029a4 <ireclaim+0xc8>
{
    800028ea:	7139                	addi	sp,sp,-64
    800028ec:	fc06                	sd	ra,56(sp)
    800028ee:	f822                	sd	s0,48(sp)
    800028f0:	f426                	sd	s1,40(sp)
    800028f2:	f04a                	sd	s2,32(sp)
    800028f4:	ec4e                	sd	s3,24(sp)
    800028f6:	e852                	sd	s4,16(sp)
    800028f8:	e456                	sd	s5,8(sp)
    800028fa:	e05a                	sd	s6,0(sp)
    800028fc:	0080                	addi	s0,sp,64
  for (int inum = 1; inum < sb.ninodes; inum++) {
    800028fe:	4485                	li	s1,1
    struct buf *bp = bread(dev, IBLOCK(inum, sb));
    80002900:	00050a1b          	sext.w	s4,a0
    80002904:	00016a97          	auipc	s5,0x16
    80002908:	df4a8a93          	addi	s5,s5,-524 # 800186f8 <sb>
      printf("ireclaim: orphaned inode %d\n", inum);
    8000290c:	00005b17          	auipc	s6,0x5
    80002910:	afcb0b13          	addi	s6,s6,-1284 # 80007408 <etext+0x408>
    80002914:	a099                	j	8000295a <ireclaim+0x7e>
    80002916:	85ce                	mv	a1,s3
    80002918:	855a                	mv	a0,s6
    8000291a:	1ef020ef          	jal	80005308 <printf>
      ip = iget(dev, inum);
    8000291e:	85ce                	mv	a1,s3
    80002920:	8552                	mv	a0,s4
    80002922:	b1dff0ef          	jal	8000243e <iget>
    80002926:	89aa                	mv	s3,a0
    brelse(bp);
    80002928:	854a                	mv	a0,s2
    8000292a:	fc4ff0ef          	jal	800020ee <brelse>
    if (ip) {
    8000292e:	00098f63          	beqz	s3,8000294c <ireclaim+0x70>
      begin_op();
    80002932:	76a000ef          	jal	8000309c <begin_op>
      ilock(ip);
    80002936:	854e                	mv	a0,s3
    80002938:	d7bff0ef          	jal	800026b2 <ilock>
      iunlock(ip);
    8000293c:	854e                	mv	a0,s3
    8000293e:	e23ff0ef          	jal	80002760 <iunlock>
      iput(ip);
    80002942:	854e                	mv	a0,s3
    80002944:	ef1ff0ef          	jal	80002834 <iput>
      end_op();
    80002948:	7be000ef          	jal	80003106 <end_op>
  for (int inum = 1; inum < sb.ninodes; inum++) {
    8000294c:	0485                	addi	s1,s1,1
    8000294e:	00caa703          	lw	a4,12(s5)
    80002952:	0004879b          	sext.w	a5,s1
    80002956:	02e7fd63          	bgeu	a5,a4,80002990 <ireclaim+0xb4>
    8000295a:	0004899b          	sext.w	s3,s1
    struct buf *bp = bread(dev, IBLOCK(inum, sb));
    8000295e:	0044d593          	srli	a1,s1,0x4
    80002962:	018aa783          	lw	a5,24(s5)
    80002966:	9dbd                	addw	a1,a1,a5
    80002968:	8552                	mv	a0,s4
    8000296a:	e7cff0ef          	jal	80001fe6 <bread>
    8000296e:	892a                	mv	s2,a0
    struct dinode *dip = (struct dinode *)bp->data + inum % IPB;
    80002970:	05850793          	addi	a5,a0,88
    80002974:	00f9f713          	andi	a4,s3,15
    80002978:	071a                	slli	a4,a4,0x6
    8000297a:	97ba                	add	a5,a5,a4
    if (dip->type != 0 && dip->nlink == 0) {  // is an orphaned inode
    8000297c:	00079703          	lh	a4,0(a5)
    80002980:	c701                	beqz	a4,80002988 <ireclaim+0xac>
    80002982:	00679783          	lh	a5,6(a5)
    80002986:	dbc1                	beqz	a5,80002916 <ireclaim+0x3a>
    brelse(bp);
    80002988:	854a                	mv	a0,s2
    8000298a:	f64ff0ef          	jal	800020ee <brelse>
    if (ip) {
    8000298e:	bf7d                	j	8000294c <ireclaim+0x70>
}
...
fsinit(int dev) {
  ...
  bp = bread(dev, 1);
    ...
    800029b8:	e2eff0ef          	jal	80001fe6 <bread>
    800029bc:	892a                	mv	s2,a0
  memmove(sb, bp->data, sizeof(*sb));
    800029be:	00016997          	auipc	s3,0x16
    800029c2:	d3a98993          	addi	s3,s3,-710 # 800186f8 <sb>
    800029c6:	02000613          	li	a2,32
    800029ca:	05850593          	addi	a1,a0,88
    800029ce:	854e                	mv	a0,s3
    800029d0:	fdafd0ef          	jal	800001aa <memmove>
  brelse(bp);
    800029d4:	854a                	mv	a0,s2
    800029d6:	f18ff0ef          	jal	800020ee <brelse>
  if(sb.magic != FSMAGIC)
    800029da:	0009a703          	lw	a4,0(s3)
    800029de:	102037b7          	lui	a5,0x10203
    800029e2:	04078793          	addi	a5,a5,64 # 10203040 <_entry-0x6fdfcfc0>
    800029e6:	02f71363          	bne	a4,a5,80002a0c <fsinit+0x66>
  initlog(dev, &sb);
    800029ea:	00016597          	auipc	a1,0x16
    800029ee:	d0e58593          	addi	a1,a1,-754 # 800186f8 <sb>
    800029f2:	8526                	mv	a0,s1
    800029f4:	62a000ef          	jal	8000301e <initlog>
  ireclaim(dev);
    800029f8:	8526                	mv	a0,s1
    800029fa:	ee3ff0ef          	jal	800028dc <ireclaim>
}
    ...
    80002a10:	a1c50513          	addi	a0,a0,-1508 # 80007428 <etext+0x428>
    80002a14:	3db020ef          	jal	800055ee <panic>

0000000080002a18 <stati>:
...
stati(struct inode *ip, struct stat *st)
{
    ...
    80002a1a:	e422                	sd	s0,8(sp)
    80002a1c:	0800                	addi	s0,sp,16
  st->dev = ip->dev;
    80002a1e:	411c                	lw	a5,0(a0)
    80002a20:	c19c                	sw	a5,0(a1)
  st->ino = ip->inum;
    80002a22:	415c                	lw	a5,4(a0)
    80002a24:	c1dc                	sw	a5,4(a1)
  st->type = ip->type;
    80002a26:	04451783          	lh	a5,68(a0)
    80002a2a:	00f59423          	sh	a5,8(a1)
  st->nlink = ip->nlink;
    80002a2e:	04a51783          	lh	a5,74(a0)
    80002a32:	00f59523          	sh	a5,10(a1)
  st->size = ip->size;
    80002a36:	04c56783          	lwu	a5,76(a0)
    80002a3a:	e99c                	sd	a5,16(a1)
}
    80002a3c:	6422                	ld	s0,8(sp)
    80002a3e:	0141                	addi	sp,sp,16
    80002a40:	8082                	ret

0000000080002a42 <readi>:
readi(struct inode *ip, int user_dst, uint64 dst, uint off, uint n)
{
  ...
  if(off > ip->size || off + n < off)
    80002a42:	457c                	lw	a5,76(a0)
    80002a44:	0ed7eb63          	bltu	a5,a3,80002b3a <readi+0xf8>
{
    80002a48:	7159                	addi	sp,sp,-112
    80002a4a:	f486                	sd	ra,104(sp)
    80002a4c:	f0a2                	sd	s0,96(sp)
    80002a4e:	eca6                	sd	s1,88(sp)
    80002a50:	e0d2                	sd	s4,64(sp)
    80002a52:	fc56                	sd	s5,56(sp)
    80002a54:	f85a                	sd	s6,48(sp)
    80002a56:	f45e                	sd	s7,40(sp)
    80002a58:	1880                	addi	s0,sp,112
    80002a5a:	8b2a                	mv	s6,a0
    80002a5c:	8bae                	mv	s7,a1
    80002a5e:	8a32                	mv	s4,a2
    80002a60:	84b6                	mv	s1,a3
    80002a62:	8aba                	mv	s5,a4
  if(off > ip->size || off + n < off)
    80002a64:	9f35                	addw	a4,a4,a3
    return 0;
    80002a66:	4501                	li	a0,0
  if(off > ip->size || off + n < off)
    80002a68:	0cd76063          	bltu	a4,a3,80002b28 <readi+0xe6>
    80002a6c:	e4ce                	sd	s3,72(sp)
  if(off + n > ip->size)
    80002a6e:	00e7f463          	bgeu	a5,a4,80002a76 <readi+0x34>
    n = ip->size - off;
    80002a72:	40d78abb          	subw	s5,a5,a3

  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    80002a76:	080a8f63          	beqz	s5,80002b14 <readi+0xd2>
    80002a7a:	e8ca                	sd	s2,80(sp)
    80002a7c:	f062                	sd	s8,32(sp)
    80002a7e:	ec66                	sd	s9,24(sp)
    80002a80:	e86a                	sd	s10,16(sp)
    80002a82:	e46e                	sd	s11,8(sp)
    ...
    80002a86:	40000c93          	li	s9,1024
    if(either_copyout(user_dst, dst, bp->data + (off % BSIZE), m) == -1) {
    80002a8a:	5c7d                	li	s8,-1
    80002a8c:	a80d                	j	80002abe <readi+0x7c>
    80002a8e:	020d1d93          	slli	s11,s10,0x20
    80002a92:	020ddd93          	srli	s11,s11,0x20
    80002a96:	05890613          	addi	a2,s2,88
    80002a9a:	86ee                	mv	a3,s11
    80002a9c:	963a                	add	a2,a2,a4
    80002a9e:	85d2                	mv	a1,s4
    80002aa0:	855e                	mv	a0,s7
    80002aa2:	c2dfe0ef          	jal	800016ce <either_copyout>
    80002aa6:	05850763          	beq	a0,s8,80002af4 <readi+0xb2>
      brelse(bp);
      tot = -1;
      break;
    }
    ...
    80002aac:	e42ff0ef          	jal	800020ee <brelse>
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    80002ab0:	013d09bb          	addw	s3,s10,s3
    80002ab4:	009d04bb          	addw	s1,s10,s1
    80002ab8:	9a6e                	add	s4,s4,s11
    80002aba:	0559f763          	bgeu	s3,s5,80002b08 <readi+0xc6>
    uint addr = bmap(ip, off/BSIZE);
    80002abe:	00a4d59b          	srliw	a1,s1,0xa
    80002ac2:	855a                	mv	a0,s6
    80002ac4:	8a7ff0ef          	jal	8000236a <bmap>
    80002ac8:	0005059b          	sext.w	a1,a0
    if(addr == 0)
    80002acc:	c5b1                	beqz	a1,80002b18 <readi+0xd6>
    bp = bread(ip->dev, addr);
    80002ace:	000b2503          	lw	a0,0(s6)
    80002ad2:	d14ff0ef          	jal	80001fe6 <bread>
    80002ad6:	892a                	mv	s2,a0
    m = min(n - tot, BSIZE - off%BSIZE);
    80002ad8:	3ff4f713          	andi	a4,s1,1023
    80002adc:	40ec87bb          	subw	a5,s9,a4
    80002ae0:	413a86bb          	subw	a3,s5,s3
    80002ae4:	8d3e                	mv	s10,a5
    80002ae6:	2781                	sext.w	a5,a5
    80002ae8:	0006861b          	sext.w	a2,a3
    80002aec:	faf671e3          	bgeu	a2,a5,80002a8e <readi+0x4c>
    80002af0:	8d36                	mv	s10,a3
    80002af2:	bf71                	j	80002a8e <readi+0x4c>
      brelse(bp);
    80002af4:	854a                	mv	a0,s2
    80002af6:	df8ff0ef          	jal	800020ee <brelse>
      tot = -1;
    ...
    80002b06:	a831                	j	80002b22 <readi+0xe0>
    ...
    80002b12:	a801                	j	80002b22 <readi+0xe0>
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    80002b14:	89d6                	mv	s3,s5
    80002b16:	a031                	j	80002b22 <readi+0xe0>
  ...
  return tot;
    80002b22:	0009851b          	sext.w	a0,s3
    80002b26:	69a6                	ld	s3,72(sp)
}
    80002b28:	70a6                	ld	ra,104(sp)
    80002b2a:	7406                	ld	s0,96(sp)
    80002b2c:	64e6                	ld	s1,88(sp)
    80002b2e:	6a06                	ld	s4,64(sp)
    80002b30:	7ae2                	ld	s5,56(sp)
    80002b32:	7b42                	ld	s6,48(sp)
    80002b34:	7ba2                	ld	s7,40(sp)
    80002b36:	6165                	addi	sp,sp,112
    80002b38:	8082                	ret
    return 0;
...
writei(struct inode *ip, int user_src, uint64 src, uint off, uint n)
{
  ...
  if(off > ip->size || off + n < off)
    ...
    80002b40:	10d7e063          	bltu	a5,a3,80002c40 <writei+0x102>
{
    80002b44:	7159                	addi	sp,sp,-112
    80002b46:	f486                	sd	ra,104(sp)
    80002b48:	f0a2                	sd	s0,96(sp)
    80002b4a:	e8ca                	sd	s2,80(sp)
    80002b4c:	e0d2                	sd	s4,64(sp)
    80002b4e:	fc56                	sd	s5,56(sp)
    80002b50:	f85a                	sd	s6,48(sp)
    80002b52:	f45e                	sd	s7,40(sp)
    80002b54:	1880                	addi	s0,sp,112
    80002b56:	8aaa                	mv	s5,a0
    80002b58:	8bae                	mv	s7,a1
    80002b5a:	8a32                	mv	s4,a2
    80002b5c:	8936                	mv	s2,a3
    80002b5e:	8b3a                	mv	s6,a4
  if(off > ip->size || off + n < off)
    80002b60:	00e687bb          	addw	a5,a3,a4
    80002b64:	0ed7e063          	bltu	a5,a3,80002c44 <writei+0x106>
    return -1;
  if(off + n > MAXFILE*BSIZE)
    80002b68:	00043737          	lui	a4,0x43
    80002b6c:	0cf76e63          	bltu	a4,a5,80002c48 <writei+0x10a>
    80002b70:	e4ce                	sd	s3,72(sp)
    return -1;

  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    80002b72:	0a0b0f63          	beqz	s6,80002c30 <writei+0xf2>
    ...
    80002b80:	4981                	li	s3,0
    uint addr = bmap(ip, off/BSIZE);
    if(addr == 0)
      break;
    bp = bread(ip->dev, addr);
    m = min(n - tot, BSIZE - off%BSIZE);
    80002b82:	40000c93          	li	s9,1024
    if(either_copyin(bp->data + (off % BSIZE), user_src, src, m) == -1) {
    80002b86:	5c7d                	li	s8,-1
    80002b88:	a825                	j	80002bc0 <writei+0x82>
    80002b8a:	020d1d93          	slli	s11,s10,0x20
    80002b8e:	020ddd93          	srli	s11,s11,0x20
    80002b92:	05848513          	addi	a0,s1,88
    80002b96:	86ee                	mv	a3,s11
    80002b98:	8652                	mv	a2,s4
    80002b9a:	85de                	mv	a1,s7
    80002b9c:	953a                	add	a0,a0,a4
    80002b9e:	b7bfe0ef          	jal	80001718 <either_copyin>
    80002ba2:	05850a63          	beq	a0,s8,80002bf6 <writei+0xb8>
      brelse(bp);
      break;
    }
    log_write(bp);
    80002ba6:	8526                	mv	a0,s1
    80002ba8:	678000ef          	jal	80003220 <log_write>
    brelse(bp);
    80002bac:	8526                	mv	a0,s1
    80002bae:	d40ff0ef          	jal	800020ee <brelse>
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    80002bb2:	013d09bb          	addw	s3,s10,s3
    80002bb6:	012d093b          	addw	s2,s10,s2
    80002bba:	9a6e                	add	s4,s4,s11
    80002bbc:	0569f063          	bgeu	s3,s6,80002bfc <writei+0xbe>
    uint addr = bmap(ip, off/BSIZE);
    80002bc0:	00a9559b          	srliw	a1,s2,0xa
    80002bc4:	8556                	mv	a0,s5
    80002bc6:	fa4ff0ef          	jal	8000236a <bmap>
    80002bca:	0005059b          	sext.w	a1,a0
    if(addr == 0)
    80002bce:	c59d                	beqz	a1,80002bfc <writei+0xbe>
    bp = bread(ip->dev, addr);
    80002bd0:	000aa503          	lw	a0,0(s5)
    80002bd4:	c12ff0ef          	jal	80001fe6 <bread>
    80002bd8:	84aa                	mv	s1,a0
    m = min(n - tot, BSIZE - off%BSIZE);
    80002bda:	3ff97713          	andi	a4,s2,1023
    80002bde:	40ec87bb          	subw	a5,s9,a4
    80002be2:	413b06bb          	subw	a3,s6,s3
    80002be6:	8d3e                	mv	s10,a5
    80002be8:	2781                	sext.w	a5,a5
    80002bea:	0006861b          	sext.w	a2,a3
    80002bee:	f8f67ee3          	bgeu	a2,a5,80002b8a <writei+0x4c>
    80002bf2:	8d36                	mv	s10,a3
    80002bf4:	bf59                	j	80002b8a <writei+0x4c>
      brelse(bp);
    80002bf6:	8526                	mv	a0,s1
    80002bf8:	cf6ff0ef          	jal	800020ee <brelse>
  }

  if(off > ip->size)
    80002bfc:	04caa783          	lw	a5,76(s5)
    80002c00:	0327fa63          	bgeu	a5,s2,80002c34 <writei+0xf6>
    ip->size = off;
    80002c04:	052aa623          	sw	s2,76(s5)
    80002c08:	64e6                	ld	s1,88(sp)
    80002c0a:	7c02                	ld	s8,32(sp)
    80002c0c:	6ce2                	ld	s9,24(sp)
    80002c0e:	6d42                	ld	s10,16(sp)
    80002c10:	6da2                	ld	s11,8(sp)
  ...
  iupdate(ip);
    ...
    80002c14:	9ebff0ef          	jal	800025fe <iupdate>

  return tot;
    80002c18:	0009851b          	sext.w	a0,s3
    80002c1c:	69a6                	ld	s3,72(sp)
}
    80002c1e:	70a6                	ld	ra,104(sp)
    80002c20:	7406                	ld	s0,96(sp)
    80002c22:	6946                	ld	s2,80(sp)
    80002c24:	6a06                	ld	s4,64(sp)
    80002c26:	7ae2                	ld	s5,56(sp)
    80002c28:	7b42                	ld	s6,48(sp)
    80002c2a:	7ba2                	ld	s7,40(sp)
    80002c2c:	6165                	addi	sp,sp,112
    80002c2e:	8082                	ret
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    80002c30:	89da                	mv	s3,s6
    80002c32:	b7c5                	j	80002c12 <writei+0xd4>
    ...
    80002c3e:	bfd1                	j	80002c12 <writei+0xd4>
    return -1;
    ...
    80002c46:	bfe1                	j	80002c1e <writei+0xe0>
    return -1;
    80002c48:	557d                	li	a0,-1
    80002c4a:	bfd1                	j	80002c1e <writei+0xe0>

0000000080002c4c <namecmp>:
...
namecmp(const char *s, const char *t)
{
  ...
  return strncmp(s, t, DIRSIZ);
    80002c54:	4639                	li	a2,14
    80002c56:	dc4fd0ef          	jal	8000021a <strncmp>
}
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
    ...
    80002c70:	0080                	addi	s0,sp,64
  uint off, inum;
  struct dirent de;

  if(dp->type != T_DIR)
    80002c72:	04451703          	lh	a4,68(a0)
    80002c76:	4785                	li	a5,1
    80002c78:	00f71a63          	bne	a4,a5,80002c8c <dirlookup+0x2a>
    80002c7c:	892a                	mv	s2,a0
    80002c7e:	89ae                	mv	s3,a1
    80002c80:	8a32                	mv	s4,a2
    panic("dirlookup not DIR");

  for(off = 0; off < dp->size; off += sizeof(de)){
    80002c82:	457c                	lw	a5,76(a0)
    80002c84:	4481                	li	s1,0
      inum = de.inum;
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    80002c88:	e39d                	bnez	a5,80002cae <dirlookup+0x4c>
    80002c8a:	a095                	j	80002cee <dirlookup+0x8c>
    panic("dirlookup not DIR");
    80002c8c:	00004517          	auipc	a0,0x4
    80002c90:	7b450513          	addi	a0,a0,1972 # 80007440 <etext+0x440>
    80002c94:	15b020ef          	jal	800055ee <panic>
      panic("dirlookup read");
    80002c98:	00004517          	auipc	a0,0x4
    80002c9c:	7c050513          	addi	a0,a0,1984 # 80007458 <etext+0x458>
    80002ca0:	14f020ef          	jal	800055ee <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
    80002ca4:	24c1                	addiw	s1,s1,16
    80002ca6:	04c92783          	lw	a5,76(s2)
    80002caa:	04f4f163          	bgeu	s1,a5,80002cec <dirlookup+0x8a>
    if(readi(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    80002cae:	4741                	li	a4,16
    80002cb0:	86a6                	mv	a3,s1
    80002cb2:	fc040613          	addi	a2,s0,-64
    80002cb6:	4581                	li	a1,0
    80002cb8:	854a                	mv	a0,s2
    80002cba:	d89ff0ef          	jal	80002a42 <readi>
    80002cbe:	47c1                	li	a5,16
    80002cc0:	fcf51ce3          	bne	a0,a5,80002c98 <dirlookup+0x36>
    if(de.inum == 0)
    80002cc4:	fc045783          	lhu	a5,-64(s0)
    80002cc8:	dff1                	beqz	a5,80002ca4 <dirlookup+0x42>
    if(namecmp(name, de.name) == 0){
    80002cca:	fc240593          	addi	a1,s0,-62
    80002cce:	854e                	mv	a0,s3
    80002cd0:	f7dff0ef          	jal	80002c4c <namecmp>
    80002cd4:	f961                	bnez	a0,80002ca4 <dirlookup+0x42>
      if(poff)
    80002cd6:	000a0463          	beqz	s4,80002cde <dirlookup+0x7c>
        *poff = off;
    80002cda:	009a2023          	sw	s1,0(s4)
      return iget(dp->dev, inum);
    80002cde:	fc045583          	lhu	a1,-64(s0)
    80002ce2:	00092503          	lw	a0,0(s2)
    80002ce6:	f58ff0ef          	jal	8000243e <iget>
    80002cea:	a011                	j	80002cee <dirlookup+0x8c>
  return 0;
...
namex(char *path, int nameiparent, char *name)
{
    ...
    80002d1c:	8ab2                	mv	s5,a2
  struct inode *ip, *next;

  if(*path == '/')
    80002d1e:	00054703          	lbu	a4,0(a0)
    80002d22:	02f00793          	li	a5,47
    80002d26:	00f70e63          	beq	a4,a5,80002d42 <namex+0x44>
    ip = iget(ROOTDEV, ROOTINO);
  else
    ip = idup(myproc()->cwd);
    80002d2a:	850fe0ef          	jal	80000d7a <myproc>
    80002d2e:	15053503          	ld	a0,336(a0)
    80002d32:	94bff0ef          	jal	8000267c <idup>
    80002d36:	8a2a                	mv	s4,a0
  while(*path == '/')
    80002d38:	02f00913          	li	s2,47
  if(len >= DIRSIZ)
    80002d3c:	4c35                	li	s8,13

  while((path = skipelem(path, name)) != 0){
    ilock(ip);
    if(ip->type != T_DIR){
    80002d3e:	4b85                	li	s7,1
    80002d40:	a871                	j	80002ddc <namex+0xde>
    ip = iget(ROOTDEV, ROOTINO);
    80002d42:	4585                	li	a1,1
    80002d44:	4505                	li	a0,1
    80002d46:	ef8ff0ef          	jal	8000243e <iget>
    80002d4a:	8a2a                	mv	s4,a0
    80002d4c:	b7f5                	j	80002d38 <namex+0x3a>
      iunlockput(ip);
    80002d4e:	8552                	mv	a0,s4
    80002d50:	b6dff0ef          	jal	800028bc <iunlockput>
      return 0;
    80002d54:	4a01                	li	s4,0
  if(nameiparent){
    iput(ip);
    return 0;
  }
  return ip;
    ...
    80002d58:	60e6                	ld	ra,88(sp)
    80002d5a:	6446                	ld	s0,80(sp)
    80002d5c:	64a6                	ld	s1,72(sp)
    80002d5e:	6906                	ld	s2,64(sp)
    80002d60:	79e2                	ld	s3,56(sp)
    80002d62:	7a42                	ld	s4,48(sp)
    80002d64:	7aa2                	ld	s5,40(sp)
    80002d66:	7b02                	ld	s6,32(sp)
    80002d68:	6be2                	ld	s7,24(sp)
    80002d6a:	6c42                	ld	s8,16(sp)
    80002d6c:	6ca2                	ld	s9,8(sp)
    80002d6e:	6125                	addi	sp,sp,96
    80002d70:	8082                	ret
      iunlock(ip);
    80002d72:	8552                	mv	a0,s4
    80002d74:	9edff0ef          	jal	80002760 <iunlock>
      return ip;
    80002d78:	bff9                	j	80002d56 <namex+0x58>
      iunlockput(ip);
    80002d7a:	8552                	mv	a0,s4
    80002d7c:	b41ff0ef          	jal	800028bc <iunlockput>
      return 0;
    80002d80:	8a4e                	mv	s4,s3
    80002d82:	bfd1                	j	80002d56 <namex+0x58>
  len = path - s;
    80002d84:	40998633          	sub	a2,s3,s1
    80002d88:	00060c9b          	sext.w	s9,a2
  if(len >= DIRSIZ)
    80002d8c:	099c5063          	bge	s8,s9,80002e0c <namex+0x10e>
    memmove(name, s, DIRSIZ);
    80002d90:	4639                	li	a2,14
    80002d92:	85a6                	mv	a1,s1
    80002d94:	8556                	mv	a0,s5
    80002d96:	c14fd0ef          	jal	800001aa <memmove>
    80002d9a:	84ce                	mv	s1,s3
  while(*path == '/')
    80002d9c:	0004c783          	lbu	a5,0(s1)
    80002da0:	01279763          	bne	a5,s2,80002dae <namex+0xb0>
    path++;
    80002da4:	0485                	addi	s1,s1,1
  while(*path == '/')
    80002da6:	0004c783          	lbu	a5,0(s1)
    80002daa:	ff278de3          	beq	a5,s2,80002da4 <namex+0xa6>
    ilock(ip);
    80002dae:	8552                	mv	a0,s4
    80002db0:	903ff0ef          	jal	800026b2 <ilock>
    if(ip->type != T_DIR){
    80002db4:	044a1783          	lh	a5,68(s4)
    80002db8:	f9779be3          	bne	a5,s7,80002d4e <namex+0x50>
    if(nameiparent && *path == '\0'){
    80002dbc:	000b0563          	beqz	s6,80002dc6 <namex+0xc8>
    80002dc0:	0004c783          	lbu	a5,0(s1)
    80002dc4:	d7dd                	beqz	a5,80002d72 <namex+0x74>
    if((next = dirlookup(ip, name, 0)) == 0){
    80002dc6:	4601                	li	a2,0
    80002dc8:	85d6                	mv	a1,s5
    80002dca:	8552                	mv	a0,s4
    80002dcc:	e97ff0ef          	jal	80002c62 <dirlookup>
    80002dd0:	89aa                	mv	s3,a0
    80002dd2:	d545                	beqz	a0,80002d7a <namex+0x7c>
    iunlockput(ip);
    80002dd4:	8552                	mv	a0,s4
    80002dd6:	ae7ff0ef          	jal	800028bc <iunlockput>
    ip = next;
    80002dda:	8a4e                	mv	s4,s3
  while(*path == '/')
    80002ddc:	0004c783          	lbu	a5,0(s1)
    80002de0:	01279763          	bne	a5,s2,80002dee <namex+0xf0>
    path++;
    80002de4:	0485                	addi	s1,s1,1
  while(*path == '/')
    80002de6:	0004c783          	lbu	a5,0(s1)
    80002dea:	ff278de3          	beq	a5,s2,80002de4 <namex+0xe6>
  if(*path == 0)
    80002dee:	cb8d                	beqz	a5,80002e20 <namex+0x122>
  while(*path != '/' && *path != 0)
    80002df0:	0004c783          	lbu	a5,0(s1)
    80002df4:	89a6                	mv	s3,s1
  len = path - s;
    80002df6:	4c81                	li	s9,0
    80002df8:	4601                	li	a2,0
  while(*path != '/' && *path != 0)
    80002dfa:	01278963          	beq	a5,s2,80002e0c <namex+0x10e>
    80002dfe:	d3d9                	beqz	a5,80002d84 <namex+0x86>
    path++;
    80002e00:	0985                	addi	s3,s3,1
  while(*path != '/' && *path != 0)
    80002e02:	0009c783          	lbu	a5,0(s3)
    80002e06:	ff279ce3          	bne	a5,s2,80002dfe <namex+0x100>
    80002e0a:	bfad                	j	80002d84 <namex+0x86>
    memmove(name, s, len);
    80002e0c:	2601                	sext.w	a2,a2
    80002e0e:	85a6                	mv	a1,s1
    80002e10:	8556                	mv	a0,s5
    80002e12:	b98fd0ef          	jal	800001aa <memmove>
    name[len] = 0;
    80002e16:	9cd6                	add	s9,s9,s5
    80002e18:	000c8023          	sb	zero,0(s9) # 2000 <_entry-0x7fffe000>
    80002e1c:	84ce                	mv	s1,s3
    80002e1e:	bfbd                	j	80002d9c <namex+0x9e>
  if(nameiparent){
    80002e20:	f20b0be3          	beqz	s6,80002d56 <namex+0x58>
    iput(ip);
    80002e24:	8552                	mv	a0,s4
    80002e26:	a0fff0ef          	jal	80002834 <iput>
    return 0;
    80002e2a:	4a01                	li	s4,0
    80002e2c:	b72d                	j	80002d56 <namex+0x58>

0000000080002e2e <dirlink>:
{
    80002e2e:	7139                	addi	sp,sp,-64
    80002e30:	fc06                	sd	ra,56(sp)
    80002e32:	f822                	sd	s0,48(sp)
    80002e34:	f04a                	sd	s2,32(sp)
    80002e36:	ec4e                	sd	s3,24(sp)
    80002e38:	e852                	sd	s4,16(sp)
    80002e3a:	0080                	addi	s0,sp,64
    80002e3c:	892a                	mv	s2,a0
    80002e3e:	8a2e                	mv	s4,a1
    80002e40:	89b2                	mv	s3,a2
  if((ip = dirlookup(dp, name, 0)) != 0){
    80002e42:	4601                	li	a2,0
    80002e44:	e1fff0ef          	jal	80002c62 <dirlookup>
    80002e48:	e535                	bnez	a0,80002eb4 <dirlink+0x86>
    80002e4a:	f426                	sd	s1,40(sp)
  for(off = 0; off < dp->size; off += sizeof(de)){
    80002e4c:	04c92483          	lw	s1,76(s2)
    80002e50:	c48d                	beqz	s1,80002e7a <dirlink+0x4c>
    ...
    80002e60:	be3ff0ef          	jal	80002a42 <readi>
    80002e64:	47c1                	li	a5,16
    80002e66:	04f51b63          	bne	a0,a5,80002ebc <dirlink+0x8e>
    if(de.inum == 0)
    80002e6a:	fc045783          	lhu	a5,-64(s0)
    80002e6e:	c791                	beqz	a5,80002e7a <dirlink+0x4c>
  for(off = 0; off < dp->size; off += sizeof(de)){
    80002e70:	24c1                	addiw	s1,s1,16
    80002e72:	04c92783          	lw	a5,76(s2)
    80002e76:	fcf4efe3          	bltu	s1,a5,80002e54 <dirlink+0x26>
  strncpy(de.name, name, DIRSIZ);
    80002e7a:	4639                	li	a2,14
    80002e7c:	85d2                	mv	a1,s4
    80002e7e:	fc240513          	addi	a0,s0,-62
    80002e82:	bcefd0ef          	jal	80000250 <strncpy>
  de.inum = inum;
    80002e86:	fd341023          	sh	s3,-64(s0)
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80002e96:	ca9ff0ef          	jal	80002b3e <writei>
    80002e9a:	1541                	addi	a0,a0,-16
    80002e9c:	00a03533          	snez	a0,a0
    80002ea0:	40a00533          	neg	a0,a0
    ...
    80002eae:	6a42                	ld	s4,16(sp)
    80002eb0:	6121                	addi	sp,sp,64
    80002eb2:	8082                	ret
    iput(ip);
    80002eb4:	981ff0ef          	jal	80002834 <iput>
    return -1;
    80002eb8:	557d                	li	a0,-1
    80002eba:	b7f5                	j	80002ea6 <dirlink+0x78>
      panic("dirlink read");
    80002ebc:	00004517          	auipc	a0,0x4
    80002ec0:	5ac50513          	addi	a0,a0,1452 # 80007468 <etext+0x468>
    80002ec4:	72a020ef          	jal	800055ee <panic>

0000000080002ec8 <namei>:
...
namei(char *path)
{
  ...
  return namex(path, 0, name);
    80002ed0:	fe040613          	addi	a2,s0,-32
    80002ed4:	4581                	li	a1,0
    80002ed6:	e29ff0ef          	jal	80002cfe <namex>
}
...
nameiparent(char *path, char *name)
{
    ...
    80002eea:	862e                	mv	a2,a1
  return namex(path, 1, name);
    80002eec:	4585                	li	a1,1
    80002eee:	e11ff0ef          	jal	80002cfe <namex>
}
...
write_head(void)
{
    ...
    80002f02:	e04a                	sd	s2,0(sp)
    80002f04:	1000                	addi	s0,sp,32
  struct buf *buf = bread(log.dev, log.start);
    80002f06:	00017917          	auipc	s2,0x17
    80002f0a:	2ba90913          	addi	s2,s2,698 # 8001a1c0 <log>
    80002f0e:	01892583          	lw	a1,24(s2)
    80002f12:	02492503          	lw	a0,36(s2)
    80002f16:	8d0ff0ef          	jal	80001fe6 <bread>
    80002f1a:	84aa                	mv	s1,a0
  struct logheader *hb = (struct logheader *) (buf->data);
  int i;
  hb->n = log.lh.n;
    80002f1c:	02892603          	lw	a2,40(s2)
    80002f20:	cd30                	sw	a2,88(a0)
  for (i = 0; i < log.lh.n; i++) {
    80002f22:	00c05f63          	blez	a2,80002f40 <write_head+0x46>
    80002f26:	00017717          	auipc	a4,0x17
    80002f2a:	2c670713          	addi	a4,a4,710 # 8001a1ec <log+0x2c>
    80002f2e:	87aa                	mv	a5,a0
    80002f30:	060a                	slli	a2,a2,0x2
    80002f32:	962a                	add	a2,a2,a0
    hb->block[i] = log.lh.block[i];
    80002f34:	4314                	lw	a3,0(a4)
    80002f36:	cff4                	sw	a3,92(a5)
  for (i = 0; i < log.lh.n; i++) {
    80002f38:	0711                	addi	a4,a4,4
    80002f3a:	0791                	addi	a5,a5,4
    80002f3c:	fec79ce3          	bne	a5,a2,80002f34 <write_head+0x3a>
  }
  bwrite(buf);
    80002f40:	8526                	mv	a0,s1
    80002f42:	97aff0ef          	jal	800020bc <bwrite>
  brelse(buf);
    80002f46:	8526                	mv	a0,s1
    80002f48:	9a6ff0ef          	jal	800020ee <brelse>
}
...
0000000080002f58 <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    80002f58:	00017797          	auipc	a5,0x17
    80002f5c:	2907a783          	lw	a5,656(a5) # 8001a1e8 <log+0x28>
    80002f60:	0af05e63          	blez	a5,8000301c <install_trans+0xc4>
{
    ...
    80002f74:	e85a                	sd	s6,16(sp)
    80002f76:	e45e                	sd	s7,8(sp)
    80002f78:	0880                	addi	s0,sp,80
    80002f7a:	8b2a                	mv	s6,a0
    80002f7c:	00017a97          	auipc	s5,0x17
    80002f80:	270a8a93          	addi	s5,s5,624 # 8001a1ec <log+0x2c>
  for (tail = 0; tail < log.lh.n; tail++) {
    80002f84:	4981                	li	s3,0
      printf("recovering tail %d dst %d\n", tail, log.lh.block[tail]);
    80002f86:	00004b97          	auipc	s7,0x4
    80002f8a:	4f2b8b93          	addi	s7,s7,1266 # 80007478 <etext+0x478>
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80002f8e:	00017a17          	auipc	s4,0x17
    80002f92:	232a0a13          	addi	s4,s4,562 # 8001a1c0 <log>
    80002f96:	a025                	j	80002fbe <install_trans+0x66>
      printf("recovering tail %d dst %d\n", tail, log.lh.block[tail]);
    80002f98:	000aa603          	lw	a2,0(s5)
    80002f9c:	85ce                	mv	a1,s3
    80002f9e:	855e                	mv	a0,s7
    80002fa0:	368020ef          	jal	80005308 <printf>
    80002fa4:	a839                	j	80002fc2 <install_trans+0x6a>
    brelse(lbuf);
    80002fa6:	854a                	mv	a0,s2
    80002fa8:	946ff0ef          	jal	800020ee <brelse>
    brelse(dbuf);
    80002fac:	8526                	mv	a0,s1
    80002fae:	940ff0ef          	jal	800020ee <brelse>
  for (tail = 0; tail < log.lh.n; tail++) {
    80002fb2:	2985                	addiw	s3,s3,1
    80002fb4:	0a91                	addi	s5,s5,4
    80002fb6:	028a2783          	lw	a5,40(s4)
    80002fba:	04f9d663          	bge	s3,a5,80003006 <install_trans+0xae>
    if(recovering) {
    80002fbe:	fc0b1de3          	bnez	s6,80002f98 <install_trans+0x40>
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80002fc2:	018a2583          	lw	a1,24(s4)
    80002fc6:	013585bb          	addw	a1,a1,s3
    80002fca:	2585                	addiw	a1,a1,1
    80002fcc:	024a2503          	lw	a0,36(s4)
    80002fd0:	816ff0ef          	jal	80001fe6 <bread>
    80002fd4:	892a                	mv	s2,a0
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
    80002fd6:	000aa583          	lw	a1,0(s5)
    80002fda:	024a2503          	lw	a0,36(s4)
    80002fde:	808ff0ef          	jal	80001fe6 <bread>
    80002fe2:	84aa                	mv	s1,a0
    memmove(dbuf->data, lbuf->data, BSIZE);  // copy block to dst
    80002fe4:	40000613          	li	a2,1024
    80002fe8:	05890593          	addi	a1,s2,88
    80002fec:	05850513          	addi	a0,a0,88
    80002ff0:	9bafd0ef          	jal	800001aa <memmove>
    bwrite(dbuf);  // write dst to disk
    80002ff4:	8526                	mv	a0,s1
    80002ff6:	8c6ff0ef          	jal	800020bc <bwrite>
    if(recovering == 0)
    80002ffa:	fa0b16e3          	bnez	s6,80002fa6 <install_trans+0x4e>
      bunpin(dbuf);
    80002ffe:	8526                	mv	a0,s1
    80003000:	9aaff0ef          	jal	800021aa <bunpin>
    80003004:	b74d                	j	80002fa6 <install_trans+0x4e>
}
    80003006:	60a6                	ld	ra,72(sp)
    80003008:	6406                	ld	s0,64(sp)
    8000300a:	74e2                	ld	s1,56(sp)
    8000300c:	7942                	ld	s2,48(sp)
    8000300e:	79a2                	ld	s3,40(sp)
    80003010:	7a02                	ld	s4,32(sp)
    80003012:	6ae2                	ld	s5,24(sp)
    80003014:	6b42                	ld	s6,16(sp)
    80003016:	6ba2                	ld	s7,8(sp)
    80003018:	6161                	addi	sp,sp,80
    8000301a:	8082                	ret
    8000301c:	8082                	ret

000000008000301e <initlog>:
{
  ...
  initlock(&log.lock, "log");
    80003030:	00017497          	auipc	s1,0x17
    80003034:	19048493          	addi	s1,s1,400 # 8001a1c0 <log>
    80003038:	00004597          	auipc	a1,0x4
    8000303c:	46058593          	addi	a1,a1,1120 # 80007498 <etext+0x498>
    80003040:	8526                	mv	a0,s1
    80003042:	7e8020ef          	jal	8000582a <initlock>
  log.start = sb->logstart;
    80003046:	0149a583          	lw	a1,20(s3)
    8000304a:	cc8c                	sw	a1,24(s1)
  log.dev = dev;
    8000304c:	0324a223          	sw	s2,36(s1)
  struct buf *buf = bread(log.dev, log.start);
    80003050:	854a                	mv	a0,s2
    80003052:	f95fe0ef          	jal	80001fe6 <bread>
  log.lh.n = lh->n;
    80003056:	4d30                	lw	a2,88(a0)
    80003058:	d490                	sw	a2,40(s1)
  for (i = 0; i < log.lh.n; i++) {
    8000305a:	00c05f63          	blez	a2,80003078 <initlog+0x5a>
    8000305e:	87aa                	mv	a5,a0
    80003060:	00017717          	auipc	a4,0x17
    80003064:	18c70713          	addi	a4,a4,396 # 8001a1ec <log+0x2c>
    80003068:	060a                	slli	a2,a2,0x2
    8000306a:	962a                	add	a2,a2,a0
    log.lh.block[i] = lh->block[i];
    8000306c:	4ff4                	lw	a3,92(a5)
    8000306e:	c314                	sw	a3,0(a4)
  for (i = 0; i < log.lh.n; i++) {
    80003070:	0791                	addi	a5,a5,4
    80003072:	0711                	addi	a4,a4,4
    80003074:	fec79ce3          	bne	a5,a2,8000306c <initlog+0x4e>
  brelse(buf);
    80003078:	876ff0ef          	jal	800020ee <brelse>
...
recover_from_log(void)
{
  ...
  install_trans(1); // if committed, copy from log to disk
    ...
    8000307e:	edbff0ef          	jal	80002f58 <install_trans>
  log.lh.n = 0;
    80003082:	00017797          	auipc	a5,0x17
    80003086:	1607a323          	sw	zero,358(a5) # 8001a1e8 <log+0x28>
  write_head(); // clear the log
    8000308a:	e71ff0ef          	jal	80002efa <write_head>
}
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    800030a8:	00017517          	auipc	a0,0x17
    800030ac:	11850513          	addi	a0,a0,280 # 8001a1c0 <log>
    800030b0:	7fa020ef          	jal	800058aa <acquire>
  while(1){
    if(log.committing){
    800030b4:	00017497          	auipc	s1,0x17
    800030b8:	10c48493          	addi	s1,s1,268 # 8001a1c0 <log>
      sleep(&log, &log.lock);
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGBLOCKS){
    800030bc:	4979                	li	s2,30
    800030be:	a029                	j	800030c8 <begin_op+0x2c>
      sleep(&log, &log.lock);
    800030c0:	85a6                	mv	a1,s1
    800030c2:	8526                	mv	a0,s1
    800030c4:	aaefe0ef          	jal	80001372 <sleep>
    if(log.committing){
    800030c8:	509c                	lw	a5,32(s1)
    800030ca:	fbfd                	bnez	a5,800030c0 <begin_op+0x24>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGBLOCKS){
    800030cc:	4cd8                	lw	a4,28(s1)
    800030ce:	2705                	addiw	a4,a4,1
    800030d0:	0027179b          	slliw	a5,a4,0x2
    800030d4:	9fb9                	addw	a5,a5,a4
    800030d6:	0017979b          	slliw	a5,a5,0x1
    800030da:	5494                	lw	a3,40(s1)
    800030dc:	9fb5                	addw	a5,a5,a3
    800030de:	00f95763          	bge	s2,a5,800030ec <begin_op+0x50>
      // this op might exhaust log space; wait for commit.
      sleep(&log, &log.lock);
    800030e2:	85a6                	mv	a1,s1
    800030e4:	8526                	mv	a0,s1
    800030e6:	a8cfe0ef          	jal	80001372 <sleep>
    800030ea:	bff9                	j	800030c8 <begin_op+0x2c>
    } else {
      log.outstanding += 1;
    800030ec:	00017517          	auipc	a0,0x17
    800030f0:	0d450513          	addi	a0,a0,212 # 8001a1c0 <log>
    800030f4:	cd58                	sw	a4,28(a0)
      release(&log.lock);
    800030f6:	04d020ef          	jal	80005942 <release>
      break;
    }
  }
}
...
end_op(void)
{
  ...
  acquire(&log.lock);
    80003112:	00017497          	auipc	s1,0x17
    80003116:	0ae48493          	addi	s1,s1,174 # 8001a1c0 <log>
    8000311a:	8526                	mv	a0,s1
    8000311c:	78e020ef          	jal	800058aa <acquire>
  log.outstanding -= 1;
    80003120:	4cdc                	lw	a5,28(s1)
    80003122:	37fd                	addiw	a5,a5,-1
    80003124:	0007891b          	sext.w	s2,a5
    80003128:	ccdc                	sw	a5,28(s1)
  if(log.committing)
    8000312a:	509c                	lw	a5,32(s1)
    8000312c:	ef9d                	bnez	a5,8000316a <end_op+0x64>
    panic("log.committing");
  if(log.outstanding == 0){
    8000312e:	04091763          	bnez	s2,8000317c <end_op+0x76>
    do_commit = 1;
    log.committing = 1;
    80003132:	00017497          	auipc	s1,0x17
    80003136:	08e48493          	addi	s1,s1,142 # 8001a1c0 <log>
  ...
  release(&log.lock);
    ...
    80003140:	003020ef          	jal	80005942 <release>
}
...
{
  if (log.lh.n > 0) {
    80003144:	549c                	lw	a5,40(s1)
    80003146:	04f04b63          	bgtz	a5,8000319c <end_op+0x96>
    acquire(&log.lock);
    8000314a:	00017497          	auipc	s1,0x17
    8000314e:	07648493          	addi	s1,s1,118 # 8001a1c0 <log>
    80003152:	8526                	mv	a0,s1
    80003154:	756020ef          	jal	800058aa <acquire>
    log.committing = 0;
    80003158:	0204a023          	sw	zero,32(s1)
    wakeup(&log);
    8000315c:	8526                	mv	a0,s1
    8000315e:	a60fe0ef          	jal	800013be <wakeup>
    release(&log.lock);
    80003162:	8526                	mv	a0,s1
    80003164:	7de020ef          	jal	80005942 <release>
}
    80003168:	a025                	j	80003190 <end_op+0x8a>
    8000316a:	ec4e                	sd	s3,24(sp)
    8000316c:	e852                	sd	s4,16(sp)
    8000316e:	e456                	sd	s5,8(sp)
    panic("log.committing");
    80003170:	00004517          	auipc	a0,0x4
    80003174:	33050513          	addi	a0,a0,816 # 800074a0 <etext+0x4a0>
    80003178:	476020ef          	jal	800055ee <panic>
    wakeup(&log);
    8000317c:	00017497          	auipc	s1,0x17
    80003180:	04448493          	addi	s1,s1,68 # 8001a1c0 <log>
    80003184:	8526                	mv	a0,s1
    80003186:	a38fe0ef          	jal	800013be <wakeup>
  release(&log.lock);
    8000318a:	8526                	mv	a0,s1
    8000318c:	7b6020ef          	jal	80005942 <release>
}
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    800031a2:	00017a97          	auipc	s5,0x17
    800031a6:	04aa8a93          	addi	s5,s5,74 # 8001a1ec <log+0x2c>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    800031aa:	00017a17          	auipc	s4,0x17
    800031ae:	016a0a13          	addi	s4,s4,22 # 8001a1c0 <log>
    800031b2:	018a2583          	lw	a1,24(s4)
    800031b6:	012585bb          	addw	a1,a1,s2
    800031ba:	2585                	addiw	a1,a1,1
    800031bc:	024a2503          	lw	a0,36(s4)
    800031c0:	e27fe0ef          	jal	80001fe6 <bread>
    800031c4:	84aa                	mv	s1,a0
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
    800031c6:	000aa583          	lw	a1,0(s5)
    800031ca:	024a2503          	lw	a0,36(s4)
    800031ce:	e19fe0ef          	jal	80001fe6 <bread>
    800031d2:	89aa                	mv	s3,a0
    memmove(to->data, from->data, BSIZE);
    800031d4:	40000613          	li	a2,1024
    800031d8:	05850593          	addi	a1,a0,88
    800031dc:	05848513          	addi	a0,s1,88
    800031e0:	fcbfc0ef          	jal	800001aa <memmove>
    bwrite(to);  // write the log
    800031e4:	8526                	mv	a0,s1
    800031e6:	ed7fe0ef          	jal	800020bc <bwrite>
    brelse(from);
    800031ea:	854e                	mv	a0,s3
    800031ec:	f03fe0ef          	jal	800020ee <brelse>
    brelse(to);
    800031f0:	8526                	mv	a0,s1
    800031f2:	efdfe0ef          	jal	800020ee <brelse>
  for (tail = 0; tail < log.lh.n; tail++) {
    800031f6:	2905                	addiw	s2,s2,1
    800031f8:	0a91                	addi	s5,s5,4
    800031fa:	028a2783          	lw	a5,40(s4)
    800031fe:	faf94ae3          	blt	s2,a5,800031b2 <end_op+0xac>
    write_log();     // Write modified blocks from cache to log
    write_head();    // Write header to disk -- the real commit
    80003202:	cf9ff0ef          	jal	80002efa <write_head>
    install_trans(0); // Now install writes to home locations
    80003206:	4501                	li	a0,0
    80003208:	d51ff0ef          	jal	80002f58 <install_trans>
    log.lh.n = 0;
    8000320c:	00017797          	auipc	a5,0x17
    80003210:	fc07ae23          	sw	zero,-36(a5) # 8001a1e8 <log+0x28>
    write_head();    // Erase the transaction from the log
    80003214:	ce7ff0ef          	jal	80002efa <write_head>
    80003218:	69e2                	ld	s3,24(sp)
    8000321a:	6a42                	ld	s4,16(sp)
    8000321c:	6aa2                	ld	s5,8(sp)
    8000321e:	b735                	j	8000314a <end_op+0x44>

0000000080003220 <log_write>:
//   modify bp->data[]
//   log_write(bp)
//   brelse(bp)
void
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    8000322e:	00017917          	auipc	s2,0x17
    80003232:	f9290913          	addi	s2,s2,-110 # 8001a1c0 <log>
    80003236:	854a                	mv	a0,s2
    80003238:	672020ef          	jal	800058aa <acquire>
  if (log.lh.n >= LOGBLOCKS)
    8000323c:	02892603          	lw	a2,40(s2)
    80003240:	47f5                	li	a5,29
    80003242:	04c7cc63          	blt	a5,a2,8000329a <log_write+0x7a>
    panic("too big a transaction");
  if (log.outstanding < 1)
    80003246:	00017797          	auipc	a5,0x17
    8000324a:	f967a783          	lw	a5,-106(a5) # 8001a1dc <log+0x1c>
    8000324e:	04f05c63          	blez	a5,800032a6 <log_write+0x86>
    panic("log_write outside of trans");

  for (i = 0; i < log.lh.n; i++) {
    80003252:	4781                	li	a5,0
    80003254:	04c05f63          	blez	a2,800032b2 <log_write+0x92>
    if (log.lh.block[i] == b->blockno)   // log absorption
    80003258:	44cc                	lw	a1,12(s1)
    8000325a:	00017717          	auipc	a4,0x17
    8000325e:	f9270713          	addi	a4,a4,-110 # 8001a1ec <log+0x2c>
  for (i = 0; i < log.lh.n; i++) {
    80003262:	4781                	li	a5,0
    if (log.lh.block[i] == b->blockno)   // log absorption
    80003264:	4314                	lw	a3,0(a4)
    80003266:	04b68663          	beq	a3,a1,800032b2 <log_write+0x92>
  for (i = 0; i < log.lh.n; i++) {
    8000326a:	2785                	addiw	a5,a5,1
    8000326c:	0711                	addi	a4,a4,4
    8000326e:	fef61be3          	bne	a2,a5,80003264 <log_write+0x44>
      break;
  }
  log.lh.block[i] = b->blockno;
    80003272:	0621                	addi	a2,a2,8
    80003274:	060a                	slli	a2,a2,0x2
    80003276:	00017797          	auipc	a5,0x17
    8000327a:	f4a78793          	addi	a5,a5,-182 # 8001a1c0 <log>
    8000327e:	97b2                	add	a5,a5,a2
    80003280:	44d8                	lw	a4,12(s1)
    80003282:	c7d8                	sw	a4,12(a5)
  if (i == log.lh.n) {  // Add new block to log?
    bpin(b);
    80003284:	8526                	mv	a0,s1
    80003286:	ef1fe0ef          	jal	80002176 <bpin>
    log.lh.n++;
    8000328a:	00017717          	auipc	a4,0x17
    8000328e:	f3670713          	addi	a4,a4,-202 # 8001a1c0 <log>
    80003292:	571c                	lw	a5,40(a4)
    80003294:	2785                	addiw	a5,a5,1
    80003296:	d71c                	sw	a5,40(a4)
    80003298:	a80d                	j	800032ca <log_write+0xaa>
    panic("too big a transaction");
    8000329a:	00004517          	auipc	a0,0x4
    8000329e:	21650513          	addi	a0,a0,534 # 800074b0 <etext+0x4b0>
    800032a2:	34c020ef          	jal	800055ee <panic>
    panic("log_write outside of trans");
    800032a6:	00004517          	auipc	a0,0x4
    800032aa:	22250513          	addi	a0,a0,546 # 800074c8 <etext+0x4c8>
    800032ae:	340020ef          	jal	800055ee <panic>
  log.lh.block[i] = b->blockno;
    800032b2:	00878693          	addi	a3,a5,8
    800032b6:	068a                	slli	a3,a3,0x2
    800032b8:	00017717          	auipc	a4,0x17
    800032bc:	f0870713          	addi	a4,a4,-248 # 8001a1c0 <log>
    800032c0:	9736                	add	a4,a4,a3
    800032c2:	44d4                	lw	a3,12(s1)
    800032c4:	c754                	sw	a3,12(a4)
  if (i == log.lh.n) {  // Add new block to log?
    800032c6:	faf60fe3          	beq	a2,a5,80003284 <log_write+0x64>
  }
  release(&log.lock);
    800032ca:	00017517          	auipc	a0,0x17
    800032ce:	ef650513          	addi	a0,a0,-266 # 8001a1c0 <log>
    800032d2:	670020ef          	jal	80005942 <release>
}
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    800032f6:	1f658593          	addi	a1,a1,502 # 800074e8 <etext+0x4e8>
    800032fa:	0521                	addi	a0,a0,8
    800032fc:	52e020ef          	jal	8000582a <initlock>
  lk->name = name;
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    8000332c:	57e020ef          	jal	800058aa <acquire>
  while (lk->locked) {
    ...
    80003338:	83afe0ef          	jal	80001372 <sleep>
  while (lk->locked) {
  ...
  lk->pid = myproc()->pid;
    80003344:	a37fd0ef          	jal	80000d7a <myproc>
    80003348:	591c                	lw	a5,48(a0)
    8000334a:	d49c                	sw	a5,40(s1)
  release(&lk->lk);
    8000334c:	854a                	mv	a0,s2
    8000334e:	5f4020ef          	jal	80005942 <release>
}
...
releasesleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003372:	538020ef          	jal	800058aa <acquire>
  lk->locked = 0;
  ...
  wakeup(lk);
    ...
    80003380:	83efe0ef          	jal	800013be <wakeup>
  release(&lk->lk);
    80003384:	854a                	mv	a0,s2
    80003386:	5bc020ef          	jal	80005942 <release>
}
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    800033aa:	500020ef          	jal	800058aa <acquire>
  ...
  release(&lk->lk);
    ...
    800033b6:	58c020ef          	jal	80005942 <release>
  return r;
}
  ...
  r = lk->locked && (lk->pid == myproc()->pid);
    ...
    800033ce:	9adfd0ef          	jal	80000d7a <myproc>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    800033ec:	11058593          	addi	a1,a1,272 # 800074f8 <etext+0x4f8>
    800033f0:	00017517          	auipc	a0,0x17
    800033f4:	f1850513          	addi	a0,a0,-232 # 8001a308 <ftable>
    800033f8:	432020ef          	jal	8000582a <initlock>
}
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    80003412:	efa50513          	addi	a0,a0,-262 # 8001a308 <ftable>
    80003416:	494020ef          	jal	800058aa <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    8000341a:	00017497          	auipc	s1,0x17
    8000341e:	f0648493          	addi	s1,s1,-250 # 8001a320 <ftable+0x18>
    80003422:	00018717          	auipc	a4,0x18
    80003426:	e9e70713          	addi	a4,a4,-354 # 8001b2c0 <disk>
    if(f->ref == 0){
  ...
  release(&ftable.lock);
    ...
    8000343a:	ed250513          	addi	a0,a0,-302 # 8001a308 <ftable>
    8000343e:	504020ef          	jal	80005942 <release>
  return 0;
    ...
    80003448:	c0dc                	sw	a5,4(s1)
      release(&ftable.lock);
    8000344a:	00017517          	auipc	a0,0x17
    8000344e:	ebe50513          	addi	a0,a0,-322 # 8001a308 <ftable>
    80003452:	4f0020ef          	jal	80005942 <release>
}
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003472:	e9a50513          	addi	a0,a0,-358 # 8001a308 <ftable>
    80003476:	434020ef          	jal	800058aa <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    80003488:	e8450513          	addi	a0,a0,-380 # 8001a308 <ftable>
    8000348c:	4b6020ef          	jal	80005942 <release>
  return f;
}
    ...
    800034a4:	14a020ef          	jal	800055ee <panic>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800034b8:	e5450513          	addi	a0,a0,-428 # 8001a308 <ftable>
    800034bc:	3ee020ef          	jal	800058aa <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    800034f6:	e1650513          	addi	a0,a0,-490 # 8001a308 <ftable>
    800034fa:	448020ef          	jal	80005942 <release>
  ...
  if(ff.type == FD_PIPE){
    ...
    80003522:	fea50513          	addi	a0,a0,-22 # 80007508 <etext+0x508>
    80003526:	0c8020ef          	jal	800055ee <panic>
    release(&ftable.lock);
    8000352a:	00017517          	auipc	a0,0x17
    8000352e:	dde50513          	addi	a0,a0,-546 # 8001a308 <ftable>
    80003532:	410020ef          	jal	80005942 <release>
    begin_op();
    iput(ff.ip);
    end_op();
  }
    ...
    begin_op();
    80003552:	b4bff0ef          	jal	8000309c <begin_op>
    iput(ff.ip);
    80003556:	854e                	mv	a0,s3
    80003558:	adcff0ef          	jal	80002834 <iput>
    end_op();
    8000355c:	babff0ef          	jal	80003106 <end_op>
...
filestat(struct file *f, uint64 addr)
{
  ...
  struct proc *p = myproc();
    8000357a:	801fd0ef          	jal	80000d7a <myproc>
  struct stat st;
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    800035f8:	8baff0ef          	jal	800026b2 <ilock>
    ...
    80003606:	c3cff0ef          	jal	80002a42 <readi>
    ...
    80003618:	948ff0ef          	jal	80002760 <iunlock>
  ...
  return r;
    ...
    8000364c:	00017717          	auipc	a4,0x17
    80003650:	c1c70713          	addi	a4,a4,-996 # 8001a268 <devsw>
    ...
    8000366a:	eb250513          	addi	a0,a0,-334 # 80007518 <etext+0x518>
    8000366e:	781010ef          	jal	800055ee <panic>
    return -1;
    ...
    8000368a:	10078b63          	beqz	a5,800037a0 <filewrite+0x11a>
{
  ...
  if(f->type == FD_PIPE){
    ...
    800036ee:	00017717          	auipc	a4,0x17
    800036f2:	b7a70713          	addi	a4,a4,-1158 # 8001a268 <devsw>
    ...
    80003702:	00048a9b          	sext.w	s5,s1
      ...
      begin_op();
    80003706:	997ff0ef          	jal	8000309c <begin_op>
      ilock(f->ip);
    8000370a:	01893503          	ld	a0,24(s2)
    8000370e:	fa5fe0ef          	jal	800026b2 <ilock>
    ...
    80003722:	c1cff0ef          	jal	80002b3e <writei>
    ...
    8000373a:	826ff0ef          	jal	80002760 <iunlock>
      end_op();
    8000373e:	9c9ff0ef          	jal	80003106 <end_op>
  ...
  return ret;
    ...
    80003798:	d9450513          	addi	a0,a0,-620 # 80007528 <etext+0x528>
    8000379c:	653010ef          	jal	800055ee <panic>
    return -1;
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    800037fe:	d3e58593          	addi	a1,a1,-706 # 80007538 <etext+0x538>
    80003802:	028020ef          	jal	8000582a <initlock>
  (*f0)->type = FD_PIPE;
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    8000388a:	020020ef          	jal	800058aa <acquire>
  if(writable){
    ...
    8000389a:	b25fd0ef          	jal	800013be <wakeup>
  } else {
    pi->readopen = 0;
    wakeup(&pi->nwrite);
  }
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    800038a6:	09c020ef          	jal	80005942 <release>
    kfree((char*)pi);
    ...
    800038c4:	afbfd0ef          	jal	800013be <wakeup>
    800038c8:	bfd9                	j	8000389e <pipeclose+0x24>
    release(&pi->lock);
    800038ca:	8526                	mv	a0,s1
    800038cc:	076020ef          	jal	80005942 <release>
}
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  struct proc *pr = myproc();
    800038ea:	c90fd0ef          	jal	80000d7a <myproc>
    800038ee:	89aa                	mv	s3,a0

  acquire(&pi->lock);
    800038f0:	8526                	mv	a0,s1
    800038f2:	7b9010ef          	jal	800058aa <acquire>
  while(i < n){
  ...
  int i = 0;
    ...
    80003910:	032020ef          	jal	80005942 <release>
      return -1;
  ...
  return i;
    ...
    80003932:	a8dfd0ef          	jal	800013be <wakeup>
      sleep(&pi->nwrite, &pi->lock);
    80003936:	85a6                	mv	a1,s1
    80003938:	855e                	mv	a0,s7
    8000393a:	a39fd0ef          	jal	80001372 <sleep>
  while(i < n){
    ...
    8000394a:	c61fd0ef          	jal	800015aa <killed>
    ...
    8000396e:	a04fd0ef          	jal	80000b72 <copyin>
  ...
  wakeup(&pi->nread);
    ...
    8000399e:	a21fd0ef          	jal	800013be <wakeup>
  release(&pi->lock);
    800039a2:	8526                	mv	a0,s1
    800039a4:	79f010ef          	jal	80005942 <release>
  return i;
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  int i;
  struct proc *pr = myproc();
    800039ce:	bacfd0ef          	jal	80000d7a <myproc>
    800039d2:	8a2a                	mv	s4,a0
  char ch;

  acquire(&pi->lock);
    800039d4:	8526                	mv	a0,s1
    800039d6:	6d5010ef          	jal	800058aa <acquire>
  ...
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    ...
    80003a16:	72d010ef          	jal	80005942 <release>
      return -1;
  ...
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    ...
    80003a56:	838fd0ef          	jal	80000a8e <copyout>
  ...
  wakeup(&pi->nwrite);  //DOC: piperead-wakeup
    ...
    80003a6c:	953fd0ef          	jal	800013be <wakeup>
  release(&pi->lock);
    80003a70:	8526                	mv	a0,s1
    80003a72:	6d1010ef          	jal	80005942 <release>
...
kexec(char *path, char **argv)
{
  ...
  struct proc *p = myproc();
    80003ac2:	ab8fd0ef          	jal	80000d7a <myproc>
    80003ac6:	84aa                	mv	s1,a0

  begin_op();
    80003ac8:	dd4ff0ef          	jal	8000309c <begin_op>

  // Open the executable file.
  if((ip = namei(path)) == 0){
    80003acc:	854a                	mv	a0,s2
    80003ace:	bfaff0ef          	jal	80002ec8 <namei>
    80003ad2:	c931                	beqz	a0,80003b26 <kexec+0x80>
  ...
  ilock(ip);
    80003ad8:	bdbfe0ef          	jal	800026b2 <ilock>
  ...
  if(readi(ip, 0, (uint64)&elf, 0, sizeof(elf)) != sizeof(elf))
    ...
    80003aea:	f59fe0ef          	jal	80002a42 <readi>
    80003aee:	04000793          	li	a5,64
    80003af2:	00f51a63          	bne	a0,a5,80003b06 <kexec+0x60>
    goto bad;
  ...
  if(elf.magic != ELF_MAGIC)
    ...
    80003b02:	02f70663          	beq	a4,a5,80003b2e <kexec+0x88>
 ...
 bad:
  ...
  if(ip){
    ...
    80003b08:	db5fe0ef          	jal	800028bc <iunlockput>
    end_op();
    80003b0c:	dfaff0ef          	jal	80003106 <end_op>
  }
  return -1;
    ...
    80003b24:	8082                	ret
    end_op();
    80003b26:	de0ff0ef          	jal	80003106 <end_op>
    return -1;
    80003b2a:	557d                	li	a0,-1
    80003b2c:	b7e5                	j	80003b14 <kexec+0x6e>
    80003b2e:	ebda                	sd	s6,464(sp)
  if((pagetable = proc_pagetable(p)) == 0)
    80003b30:	8526                	mv	a0,s1
    80003b32:	b4efd0ef          	jal	80000e80 <proc_pagetable>
    80003b36:	8b2a                	mv	s6,a0
    80003b38:	2c050b63          	beqz	a0,80003e0e <kexec+0x368>
  ...
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    ...
    80003b50:	12078963          	beqz	a5,80003c82 <kexec+0x1dc>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80003b66:	a085                	j	80003bc6 <kexec+0x120>
      panic("loadseg: address should exist");
    80003b68:	00004517          	auipc	a0,0x4
    80003b6c:	9d850513          	addi	a0,a0,-1576 # 80007540 <etext+0x540>
    80003b70:	27f010ef          	jal	800055ee <panic>
    if(sz - i < PGSIZE)
    ...
    80003b80:	ec3fe0ef          	jal	80002a42 <readi>
    80003b84:	2501                	sext.w	a0,a0
    80003b86:	24a49a63          	bne	s1,a0,80003dda <kexec+0x334>
  for(i = 0; i < sz; i += PGSIZE){
    80003b8a:	012a893b          	addw	s2,s5,s2
    80003b8e:	03397363          	bgeu	s2,s3,80003bb4 <kexec+0x10e>
    pa = walkaddr(pagetable, va + i);
    ...
    if(pa == 0)
    80003ba2:	d179                	beqz	a0,80003b68 <kexec+0xc2>
    if(sz - i < PGSIZE)
    80003ba4:	412984bb          	subw	s1,s3,s2
    80003ba8:	0004879b          	sext.w	a5,s1
    80003bac:	fcfcf4e3          	bgeu	s9,a5,80003b74 <kexec+0xce>
    80003bb0:	84d6                	mv	s1,s5
    80003bb2:	b7c9                	j	80003b74 <kexec+0xce>
    sz = sz1;
    80003bb4:	e0843903          	ld	s2,-504(s0)
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    80003bb8:	2d85                	addiw	s11,s11,1
    80003bba:	038d0d1b          	addiw	s10,s10,56 # 1038 <_entry-0x7fffefc8>
    80003bbe:	e8845783          	lhu	a5,-376(s0)
    80003bc2:	08fdd063          	bge	s11,a5,80003c42 <kexec+0x19c>
    ...
    80003bd6:	e6dfe0ef          	jal	80002a42 <readi>
    80003bda:	03800793          	li	a5,56
    80003bde:	1cf51663          	bne	a0,a5,80003daa <kexec+0x304>
    if(ph.type != ELF_PROG_LOAD)
    80003be2:	e1842783          	lw	a5,-488(s0)
    80003be6:	4705                	li	a4,1
    80003be8:	fce798e3          	bne	a5,a4,80003bb8 <kexec+0x112>
    if(ph.memsz < ph.filesz)
    80003bec:	e4043483          	ld	s1,-448(s0)
    80003bf0:	e3843783          	ld	a5,-456(s0)
    80003bf4:	1af4ef63          	bltu	s1,a5,80003db2 <kexec+0x30c>
    if(ph.vaddr + ph.memsz < ph.vaddr)
    80003bf8:	e2843783          	ld	a5,-472(s0)
    80003bfc:	94be                	add	s1,s1,a5
    80003bfe:	1af4ee63          	bltu	s1,a5,80003dba <kexec+0x314>
    if(ph.vaddr % PGSIZE != 0)
    80003c02:	df043703          	ld	a4,-528(s0)
    80003c06:	8ff9                	and	a5,a5,a4
    80003c08:	1a079d63          	bnez	a5,80003dc2 <kexec+0x31c>
    ...
    80003c1c:	b19fc0ef          	jal	80000734 <uvmalloc>
    80003c20:	e0a43423          	sd	a0,-504(s0)
    80003c24:	1a050363          	beqz	a0,80003dca <kexec+0x324>
    if(loadseg(pagetable, ph.vaddr, ip, ph.off, ph.filesz) < 0)
    80003c28:	e2843b83          	ld	s7,-472(s0)
    80003c2c:	e2042c03          	lw	s8,-480(s0)
    80003c30:	e3842983          	lw	s3,-456(s0)
  for(i = 0; i < sz; i += PGSIZE){
    80003c34:	00098463          	beqz	s3,80003c3c <kexec+0x196>
    80003c38:	4901                	li	s2,0
    80003c3a:	bfa1                	j	80003b92 <kexec+0xec>
    sz = sz1;
    80003c3c:	e0843903          	ld	s2,-504(s0)
    80003c40:	bfa5                	j	80003bb8 <kexec+0x112>
    80003c42:	7dba                	ld	s11,424(sp)
  iunlockput(ip);
    80003c44:	8552                	mv	a0,s4
    80003c46:	c77fe0ef          	jal	800028bc <iunlockput>
  end_op();
    80003c4a:	cbcff0ef          	jal	80003106 <end_op>
  p = myproc();
    80003c4e:	92cfd0ef          	jal	80000d7a <myproc>
  ...
  for(argc = 0; argv[argc]; argc++) {
    ...
    80003c9a:	cd39                	beqz	a0,80003cf8 <kexec+0x252>
    ...
    if(sp < stackbase)
    80003cb6:	11796e63          	bltu	s2,s7,80003dd2 <kexec+0x32c>
    ...
    80003cd2:	dbdfc0ef          	jal	80000a8e <copyout>
    80003cd6:	10054063          	bltz	a0,80003dd6 <kexec+0x330>
    ustack[argc] = sp;
  ...
  for(argc = 0; argv[argc]; argc++) {
    ...
    80003cec:	c909                	beqz	a0,80003cfe <kexec+0x258>
    if(argc >= MAXARG)
    80003cee:	09a1                	addi	s3,s3,8
    80003cf0:	fb899be3          	bne	s3,s8,80003ca6 <kexec+0x200>
  ip = 0;
    80003cf4:	4a01                	li	s4,0
    80003cf6:	a0dd                	j	80003ddc <kexec+0x336>
  sp = sz;
  ...
  ustack[argc] = 0;
    ...
    80003d02:	f9078793          	addi	a5,a5,-112 # ffffffffffffef90 <end+0xffffffff7ffdbab8>
  ...
  if(sp < stackbase)
    80003d1e:	f5796ee3          	bltu	s2,s7,80003c7a <kexec+0x1d4>
  if(copyout(pagetable, sp, (char *)ustack, (argc+1)*sizeof(uint64)) < 0)
    80003d22:	e9040613          	addi	a2,s0,-368
    80003d26:	85ca                	mv	a1,s2
    80003d28:	855a                	mv	a0,s6
    80003d2a:	d65fc0ef          	jal	80000a8e <copyout>
    80003d2e:	0e054263          	bltz	a0,80003e12 <kexec+0x36c>
  p->trapframe->a1 = sp;
  ...
  for(last=s=path; *s; s++)
    ...
    80003d42:	cf11                	beqz	a4,80003d5e <kexec+0x2b8>
    80003d44:	0785                	addi	a5,a5,1
    if(*s == '/')
    80003d46:	02f00693          	li	a3,47
    80003d4a:	a039                	j	80003d58 <kexec+0x2b2>
      last = s+1;
    80003d4c:	def43c23          	sd	a5,-520(s0)
  for(last=s=path; *s; s++)
    80003d50:	0785                	addi	a5,a5,1
    80003d52:	fff7c703          	lbu	a4,-1(a5)
    80003d56:	c701                	beqz	a4,80003d5e <kexec+0x2b8>
    if(*s == '/')
    80003d58:	fed71ce3          	bne	a4,a3,80003d50 <kexec+0x2aa>
    80003d5c:	bfc5                	j	80003d4c <kexec+0x2a6>
  ...
  proc_freepagetable(oldpagetable, oldsz);
    ...
    80003d90:	974fd0ef          	jal	80000f04 <proc_freepagetable>
  ...
  if(ip){
    ...
    80003dfc:	bb21                	j	80003b14 <kexec+0x6e>
    ...
    80003e0c:	b9ed                	j	80003b06 <kexec+0x60>
    80003e0e:	6b5e                	ld	s6,464(sp)
    80003e10:	b9dd                	j	80003b06 <kexec+0x60>
  sz = sz1;
    80003e12:	e0843983          	ld	s3,-504(s0)
    80003e16:	b595                	j	80003c7a <kexec+0x1d4>
...
fdalloc(struct file *f)
{
  ...
  int fd;
  struct proc *p = myproc();
    80003e7c:	efffc0ef          	jal	80000d7a <myproc>
...
create(char *path, short type, short major, short minor)
{
  ...
  return 0;
    ...
    80003f20:	99dfe0ef          	jal	800028bc <iunlockput>
    return 0;
  ...
  if((ip = ialloc(dp->dev, type)) == 0){
    ...
    80003f2e:	e14fe0ef          	jal	80002542 <ialloc>
    80003f32:	8a2a                	mv	s4,a0
    80003f34:	cd15                	beqz	a0,80003f70 <create+0xc2>
  ilock(ip);
    80003f36:	f7cfe0ef          	jal	800026b2 <ilock>
  ip->major = major;
  ...
  iupdate(ip);
    ...
    80003f4a:	eb4fe0ef          	jal	800025fe <iupdate>
  ...
  if(dirlink(dp, name, ip->inum) < 0)
    ...
    80003f5c:	ed3fe0ef          	jal	80002e2e <dirlink>
    80003f60:	06054563          	bltz	a0,80003fca <create+0x11c>
  iunlockput(dp);
    80003f64:	8526                	mv	a0,s1
    80003f66:	957fe0ef          	jal	800028bc <iunlockput>
  return ip;
    ...
    80003f72:	94bfe0ef          	jal	800028bc <iunlockput>
    return 0;
    ...
    80003f84:	5e058593          	addi	a1,a1,1504 # 80007560 <etext+0x560>
    80003f88:	8552                	mv	a0,s4
    80003f8a:	ea5fe0ef          	jal	80002e2e <dirlink>
    ...
    80003f9e:	e91fe0ef          	jal	80002e2e <dirlink>
  ...
  if(dirlink(dp, name, ip->inum) < 0)
    ...
    80003fb0:	e7ffe0ef          	jal	80002e2e <dirlink>
    ...
    80003fc4:	e3afe0ef          	jal	800025fe <iupdate>
    80003fc8:	bf71                	j	80003f64 <create+0xb6>
  ip->nlink = 0;
    80003fca:	040a1523          	sh	zero,74(s4)
  iupdate(ip);
    80003fce:	8552                	mv	a0,s4
    80003fd0:	e2efe0ef          	jal	800025fe <iupdate>
  iunlockput(ip);
    80003fd4:	8552                	mv	a0,s4
    80003fd6:	8e7fe0ef          	jal	800028bc <iunlockput>
  iunlockput(dp);
    80003fda:	8526                	mv	a0,s1
    80003fdc:	8e1fe0ef          	jal	800028bc <iunlockput>
  return 0;
...
0000000080004034 <sys_read>:
{
  ...
  argaddr(1, &p);
    ...
    80004042:	c51fd0ef          	jal	80001c92 <argaddr>
  argint(2, &n);
    80004046:	fe440593          	addi	a1,s0,-28
    8000404a:	4509                	li	a0,2
    8000404c:	c2bfd0ef          	jal	80001c76 <argint>
  if(argfd(0, 0, &f) < 0)
...
000000008000407c <sys_write>:
{
  ...
  argaddr(1, &p);
    ...
    8000408a:	c09fd0ef          	jal	80001c92 <argaddr>
  argint(2, &n);
    8000408e:	fe440593          	addi	a1,s0,-28
    80004092:	4509                	li	a0,2
    80004094:	be3fd0ef          	jal	80001c76 <argint>
  if(argfd(0, 0, &f) < 0)
...
00000000800040c4 <sys_close>:
{
  ...
  myproc()->ofile[fd] = 0;
    800040e0:	c9bfc0ef          	jal	80000d7a <myproc>
...
0000000080004106 <sys_fstat>:
{
  ...
  argaddr(1, &st);
    ...
    80004114:	b7ffd0ef          	jal	80001c92 <argaddr>
  if(argfd(0, 0, &f) < 0)
...
0000000080004140 <sys_link>:
{
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    80004152:	b5dfd0ef          	jal	80001cae <argstr>
    return -1;
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    80004166:	b49fd0ef          	jal	80001cae <argstr>
    return -1;
  ...
  begin_op();
    80004172:	f2bfe0ef          	jal	8000309c <begin_op>
  if((ip = namei(old)) == 0){
    80004176:	ed040513          	addi	a0,s0,-304
    8000417a:	d4ffe0ef          	jal	80002ec8 <namei>
    8000417e:	84aa                	mv	s1,a0
    80004180:	c53d                	beqz	a0,800041ee <sys_link+0xae>
  ilock(ip);
    80004182:	d30fe0ef          	jal	800026b2 <ilock>
  if(ip->type == T_DIR){
  ...
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
    ...
    800041ce:	c61fe0ef          	jal	80002e2e <dirlink>
    800041d2:	02054b63          	bltz	a0,80004208 <sys_link+0xc8>
  iunlockput(dp);
    800041d6:	854a                	mv	a0,s2
    800041d8:	ee4fe0ef          	jal	800028bc <iunlockput>
  iput(ip);
    800041dc:	8526                	mv	a0,s1
    800041de:	e56fe0ef          	jal	80002834 <iput>
  end_op();
    800041e2:	f25fe0ef          	jal	80003106 <end_op>
  return 0;
    ...
    end_op();
    800041ee:	f19fe0ef          	jal	80003106 <end_op>
    return -1;
    ...
    800041fa:	ec2fe0ef          	jal	800028bc <iunlockput>
    end_op();
    800041fe:	f09fe0ef          	jal	80003106 <end_op>
    return -1;
    ...
    8000420a:	eb2fe0ef          	jal	800028bc <iunlockput>
  ilock(ip);
    8000420e:	8526                	mv	a0,s1
    80004210:	ca2fe0ef          	jal	800026b2 <ilock>
  ip->nlink--;
  ...
  iupdate(ip);
    ...
    80004220:	bdefe0ef          	jal	800025fe <iupdate>
  iunlockput(ip);
    80004224:	8526                	mv	a0,s1
    80004226:	e96fe0ef          	jal	800028bc <iunlockput>
  end_op();
    8000422a:	eddfe0ef          	jal	80003106 <end_op>
  return -1;
...
000000008000423e <sys_unlink>:
{
  ...
  if((ip = dirlookup(dp, name, &off)) == 0)
    ...
    800042a6:	9bdfe0ef          	jal	80002c62 <dirlookup>
    800042aa:	892a                	mv	s2,a0
    800042ac:	0e050863          	beqz	a0,8000439c <sys_unlink+0x15e>
  ilock(ip);
    800042b0:	c02fe0ef          	jal	800026b2 <ilock>
  if(ip->nlink < 1)
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    800042e0:	85ffe0ef          	jal	80002b3e <writei>
  ...
  iunlockput(dp);
    ...
    800042f6:	dc6fe0ef          	jal	800028bc <iunlockput>
  ip->nlink--;
  ...
  iupdate(ip);
    ...
    80004306:	af8fe0ef          	jal	800025fe <iupdate>
  iunlockput(ip);
    8000430a:	854a                	mv	a0,s2
    8000430c:	db0fe0ef          	jal	800028bc <iunlockput>
  end_op();
    80004310:	df7fe0ef          	jal	80003106 <end_op>
  return 0;
    ...
    end_op();
    8000431c:	debfe0ef          	jal	80003106 <end_op>
    return -1;
    ...
    8000432c:	24850513          	addi	a0,a0,584 # 80007570 <etext+0x570>
    80004330:	2be010ef          	jal	800055ee <panic>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    80004352:	ef0fe0ef          	jal	80002a42 <readi>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    80004374:	21850513          	addi	a0,a0,536 # 80007588 <etext+0x588>
    80004378:	276010ef          	jal	800055ee <panic>
    8000437c:	e5ce                	sd	s3,200(sp)
    panic("unlink: writei");
    8000437e:	00003517          	auipc	a0,0x3
    80004382:	22250513          	addi	a0,a0,546 # 800075a0 <etext+0x5a0>
    80004386:	268010ef          	jal	800055ee <panic>
    dp->nlink--;
    ...
    80004396:	a68fe0ef          	jal	800025fe <iupdate>
    8000439a:	bfa9                	j	800042f4 <sys_unlink+0xb6>
    8000439c:	694e                	ld	s2,208(sp)
  iunlockput(dp);
    8000439e:	8526                	mv	a0,s1
    800043a0:	d1cfe0ef          	jal	800028bc <iunlockput>
  end_op();
    800043a4:	d63fe0ef          	jal	80003106 <end_op>
  return -1;
    ...
    800043ba:	d02fe0ef          	jal	800028bc <iunlockput>
    goto bad;
...
sys_open(void)
{
  ...
  begin_op();
    800043ee:	caffe0ef          	jal	8000309c <begin_op>
  ...
  iunlock(ip);
    ...
    8000447c:	ae4fe0ef          	jal	80002760 <iunlock>
  end_op();
    80004480:	c87fe0ef          	jal	80003106 <end_op>
  ...
  return fd;
    ...
    80004492:	8082                	ret
      end_op();
    80004494:	c73fe0ef          	jal	80003106 <end_op>
      return -1;
    ...
    800044a2:	a27fe0ef          	jal	80002ec8 <namei>
    800044a6:	84aa                	mv	s1,a0
    800044a8:	c11d                	beqz	a0,800044ce <sys_open+0x10a>
    ilock(ip);
    800044aa:	a08fe0ef          	jal	800026b2 <ilock>
    ...
    800044c0:	bfcfe0ef          	jal	800028bc <iunlockput>
      end_op();
    800044c4:	c43fe0ef          	jal	80003106 <end_op>
      return -1;
    800044c8:	557d                	li	a0,-1
    800044ca:	74aa                	ld	s1,168(sp)
    800044cc:	b7c1                	j	8000448c <sys_open+0xc8>
      end_op();
    800044ce:	c39fe0ef          	jal	80003106 <end_op>
      return -1;
    ...
    800044da:	be2fe0ef          	jal	800028bc <iunlockput>
    end_op();
    800044de:	c29fe0ef          	jal	80003106 <end_op>
    return -1;
    ...
    800044f2:	bcafe0ef          	jal	800028bc <iunlockput>
    end_op();
    800044f6:	c11fe0ef          	jal	80003106 <end_op>
    return -1;
    ...
    80004512:	a8efe0ef          	jal	800027a0 <itrunc>
...
sys_mkdir(void)
{
  ...
  iunlockput(ip);
    80004546:	b76fe0ef          	jal	800028bc <iunlockput>
  end_op();
    8000454a:	bbdfe0ef          	jal	80003106 <end_op>
  return 0;
    ...
    80004556:	8082                	ret
    end_op();
    80004558:	baffe0ef          	jal	80003106 <end_op>
    return -1;
...
sys_mknod(void)
{
  ...
  iunlockput(ip);
    800045a6:	b16fe0ef          	jal	800028bc <iunlockput>
  end_op();
    800045aa:	b5dfe0ef          	jal	80003106 <end_op>
  return 0;
    ...
    800045b6:	8082                	ret
    end_op();
    800045b8:	b4ffe0ef          	jal	80003106 <end_op>
    return -1;
...
sys_chdir(void)
{
  ...
  ilock(ip);
    800045f4:	8befe0ef          	jal	800026b2 <ilock>
  if(ip->type != T_DIR){
  ...
  iunlock(ip);
    ...
    80004604:	95cfe0ef          	jal	80002760 <iunlock>
  iput(p->cwd);
    80004608:	15093503          	ld	a0,336(s2)
    8000460c:	a28fe0ef          	jal	80002834 <iput>
  end_op();
    80004610:	af7fe0ef          	jal	80003106 <end_op>
  p->cwd = ip;
  ...
  return 0;
    ...
    end_op();
    80004628:	adffe0ef          	jal	80003106 <end_op>
    return -1;
    8000462c:	557d                	li	a0,-1
    8000462e:	b7fd                	j	8000461c <sys_chdir+0x5c>
    iunlockput(ip);
    80004630:	8526                	mv	a0,s1
    80004632:	a8afe0ef          	jal	800028bc <iunlockput>
    end_op();
    80004636:	ad1fe0ef          	jal	80003106 <end_op>
    return -1;
...
sys_exec(void)
{
  ...
  memset(argv, 0, sizeof(argv));
    ...
    80004698:	d54fd0ef          	jal	80001bec <fetchaddr>
    ...
    800046b8:	d7efd0ef          	jal	80001c36 <fetchstr>
 ...
 bad:
  ...
  int ret = kexec(path, argv);
    ...
    800046fe:	ba8ff0ef          	jal	80003aa6 <kexec>
...
sys_pipe(void)
{
  ...
  int fd0, fd1;
  struct proc *p = myproc();
    8000473e:	e3cfc0ef          	jal	80000d7a <myproc>
    80004742:	84aa                	mv	s1,a0

  argaddr(0, &fdarray);
    80004744:	fd840593          	addi	a1,s0,-40
    80004748:	4501                	li	a0,0
    8000474a:	d48fd0ef          	jal	80001c92 <argaddr>
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    80004790:	afefc0ef          	jal	80000a8e <copyout>
    ...
    800047a6:	ae8fc0ef          	jal	80000a8e <copyout>
    p->ofile[fd1] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
...
kernelvec:
    ...
    80004812:	e006                	sd	ra,0(sp)
        # sd sp, 8(sp)
        sd gp, 16(sp)
    80004814:	e80e                	sd	gp,16(sp)
        sd tp, 24(sp)
    80004816:	ec12                	sd	tp,24(sp)
        sd t0, 32(sp)
    80004818:	f016                	sd	t0,32(sp)
        sd t1, 40(sp)
    8000481a:	f41a                	sd	t1,40(sp)
        sd t2, 48(sp)
    8000481c:	f81e                	sd	t2,48(sp)
        sd a0, 72(sp)
    8000481e:	e4aa                	sd	a0,72(sp)
        sd a1, 80(sp)
    80004820:	e8ae                	sd	a1,80(sp)
        sd a2, 88(sp)
    80004822:	ecb2                	sd	a2,88(sp)
        sd a3, 96(sp)
    80004824:	f0b6                	sd	a3,96(sp)
        sd a4, 104(sp)
    80004826:	f4ba                	sd	a4,104(sp)
        sd a5, 112(sp)
    80004828:	f8be                	sd	a5,112(sp)
        sd a6, 120(sp)
    8000482a:	fcc2                	sd	a6,120(sp)
        sd a7, 128(sp)
    8000482c:	e146                	sd	a7,128(sp)
        sd t3, 216(sp)
    8000482e:	edf2                	sd	t3,216(sp)
        sd t4, 224(sp)
    80004830:	f1f6                	sd	t4,224(sp)
        sd t5, 232(sp)
    80004832:	f5fa                	sd	t5,232(sp)
        sd t6, 240(sp)
    80004834:	f9fe                	sd	t6,240(sp)

        # call the C trap handler in trap.c
        call kerneltrap
    80004836:	ac6fd0ef          	jal	80001afc <kerneltrap>

        # restore registers.
        ld ra, 0(sp)
    8000483a:	6082                	ld	ra,0(sp)
        # ld sp, 8(sp)
        ld gp, 16(sp)
    8000483c:	61c2                	ld	gp,16(sp)
        # not tp (contains hartid), in case we moved CPUs
        ld t0, 32(sp)
    8000483e:	7282                	ld	t0,32(sp)
        ld t1, 40(sp)
    80004840:	7322                	ld	t1,40(sp)
        ld t2, 48(sp)
    80004842:	73c2                	ld	t2,48(sp)
        ld a0, 72(sp)
    80004844:	6526                	ld	a0,72(sp)
        ld a1, 80(sp)
    80004846:	65c6                	ld	a1,80(sp)
        ld a2, 88(sp)
    80004848:	6666                	ld	a2,88(sp)
        ld a3, 96(sp)
    8000484a:	7686                	ld	a3,96(sp)
        ld a4, 104(sp)
    8000484c:	7726                	ld	a4,104(sp)
        ld a5, 112(sp)
    8000484e:	77c6                	ld	a5,112(sp)
        ld a6, 120(sp)
    80004850:	7866                	ld	a6,120(sp)
        ld a7, 128(sp)
    80004852:	688a                	ld	a7,128(sp)
        ld t3, 216(sp)
    80004854:	6e6e                	ld	t3,216(sp)
        ld t4, 224(sp)
    80004856:	7e8e                	ld	t4,224(sp)
        ld t5, 232(sp)
    80004858:	7f2e                	ld	t5,232(sp)
        ld t6, 240(sp)
    8000485a:	7fce                	ld	t6,240(sp)

        addi sp, sp, 256
    8000485c:	6111                	addi	sp,sp,256

        # return to whatever we were doing in the kernel.
        sret
    8000485e:	10200073          	sret
	...
...
plicinithart(void)
{
  ...
  int hart = cpuid();
    80004890:	cbefc0ef          	jal	80000d4e <cpuid>
...
plic_claim(void)
{
  ...
  int hart = cpuid();
    800048c4:	c8afc0ef          	jal	80000d4e <cpuid>
...
plic_complete(int irq)
{
  ...
  int hart = cpuid();
    800048e8:	c66fc0ef          	jal	80000d4e <cpuid>
...
free_desc(int i)
{
  ...
  if(i >= NUM)
    ...
    panic("free_desc 1");
  if(disk.free[i])
    80004910:	00017797          	auipc	a5,0x17
    80004914:	9b078793          	addi	a5,a5,-1616 # 8001b2c0 <disk>
  ...
  disk.desc[i].addr = 0;
    ...
    80004924:	00017797          	auipc	a5,0x17
    80004928:	99c78793          	addi	a5,a5,-1636 # 8001b2c0 <disk>
  ...
  wakeup(&disk.free[0]);
    ...
    80004950:	98c50513          	addi	a0,a0,-1652 # 8001b2d8 <disk+0x18>
    80004954:	a6bfc0ef          	jal	800013be <wakeup>
}
    ...
    80004964:	c5050513          	addi	a0,a0,-944 # 800075b0 <etext+0x5b0>
    80004968:	487000ef          	jal	800055ee <panic>
    panic("free_desc 2");
    8000496c:	00003517          	auipc	a0,0x3
    80004970:	c5450513          	addi	a0,a0,-940 # 800075c0 <etext+0x5c0>
    80004974:	47b000ef          	jal	800055ee <panic>
...
0000000080004978 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80004988:	c4c58593          	addi	a1,a1,-948 # 800075d0 <etext+0x5d0>
    8000498c:	00017517          	auipc	a0,0x17
    80004990:	a5c50513          	addi	a0,a0,-1444 # 8001b3e8 <disk+0x128>
    80004994:	697000ef          	jal	8000582a <initlock>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    800049f8:	75f70713          	addi	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47fdb287>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    80004a4a:	00017497          	auipc	s1,0x17
    80004a4e:	87648493          	addi	s1,s1,-1930 # 8001b2c0 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    80004a68:	00017717          	auipc	a4,0x17
    80004a6c:	86073703          	ld	a4,-1952(a4) # 8001b2c8 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    80004a80:	00017497          	auipc	s1,0x17
    80004a84:	84048493          	addi	s1,s1,-1984 # 8001b2c0 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80004ba0:	84c50513          	addi	a0,a0,-1972 # 8001b3e8 <disk+0x128>
    80004ba4:	507000ef          	jal	800058aa <acquire>
  for(int i = 0; i < 3; i++){
    80004ba8:	4981                	li	s3,0
  for(int i = 0; i < NUM; i++){
    80004baa:	44a1                	li	s1,8
      disk.free[i] = 0;
    80004bac:	00016b17          	auipc	s6,0x16
    80004bb0:	714b0b13          	addi	s6,s6,1812 # 8001b2c0 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    80004bb6:	00017c17          	auipc	s8,0x17
    80004bba:	832c0c13          	addi	s8,s8,-1998 # 8001b3e8 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80004bdc:	6e870713          	addi	a4,a4,1768 # 8001b2c0 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80004c10:	00016517          	auipc	a0,0x16
    80004c14:	6c850513          	addi	a0,a0,1736 # 8001b2d8 <disk+0x18>
    80004c18:	f5afc0ef          	jal	80001372 <sleep>
  for(int i = 0; i < 3; i++){
  ...
  if(write)
    80004c2c:	00016797          	auipc	a5,0x16
    80004c30:	69478793          	addi	a5,a5,1684 # 8001b2c0 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    80004d06:	6e690913          	addi	s2,s2,1766 # 8001b3e8 <disk+0x128>
  while(b->disk == 1) {
    ...
    80004d14:	e5efc0ef          	jal	80001372 <sleep>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    80004d2a:	00016797          	auipc	a5,0x16
    80004d2e:	59678793          	addi	a5,a5,1430 # 8001b2c0 <disk>
    80004d32:	97ba                	add	a5,a5,a4
    80004d34:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    80004d38:	00016997          	auipc	s3,0x16
    80004d3c:	58898993          	addi	s3,s3,1416 # 8001b2c0 <disk>
  ...
  release(&disk.vdisk_lock);
    80004d5c:	00016517          	auipc	a0,0x16
    80004d60:	68c50513          	addi	a0,a0,1676 # 8001b3e8 <disk+0x128>
    80004d64:	3df000ef          	jal	80005942 <release>
}
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80004d90:	53448493          	addi	s1,s1,1332 # 8001b2c0 <disk>
    80004d94:	00016517          	auipc	a0,0x16
    80004d98:	65450513          	addi	a0,a0,1620 # 8001b3e8 <disk+0x128>
    80004d9c:	30f000ef          	jal	800058aa <acquire>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  while(disk.used_idx != disk.used->idx){
    ...
    wakeup(b);
    80004dec:	dd2fc0ef          	jal	800013be <wakeup>
  ...
  release(&disk.vdisk_lock);
    80004e08:	00016517          	auipc	a0,0x16
    80004e0c:	5e050513          	addi	a0,a0,1504 # 8001b3e8 <disk+0x128>
    80004e10:	333000ef          	jal	80005942 <release>
}
    ...
    80004e22:	87a50513          	addi	a0,a0,-1926 # 80007698 <etext+0x698>
    80004e26:	7c8000ef          	jal	800055ee <panic>
...
0000000080004e6e <start>:
{
  ...
  x &= ~MSTATUS_MPP_MASK;
    ...
    80004e7c:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffdb327>
  ...
  w_sie(r_sie() | SIE_SEIE | SIE_STIE);
    80004eb0:	2207e793          	ori	a5,a5,544
...
{
    80004ede:	7119                	addi	sp,sp,-128
    80004ee0:	fc86                	sd	ra,120(sp)
    80004ee2:	f8a2                	sd	s0,112(sp)
    80004ee4:	f4a6                	sd	s1,104(sp)
    80004ee6:	0100                	addi	s0,sp,128
  char buf[32];
  int i = 0;

  while(i < n){
    80004ee8:	06c05a63          	blez	a2,80004f5c <consolewrite+0x7e>
    80004eec:	f0ca                	sd	s2,96(sp)
    80004eee:	ecce                	sd	s3,88(sp)
    80004ef0:	e8d2                	sd	s4,80(sp)
    80004ef2:	e4d6                	sd	s5,72(sp)
    80004ef4:	e0da                	sd	s6,64(sp)
    80004ef6:	fc5e                	sd	s7,56(sp)
    80004ef8:	f862                	sd	s8,48(sp)
    80004efa:	f466                	sd	s9,40(sp)
    80004efc:	8aaa                	mv	s5,a0
    80004efe:	8b2e                	mv	s6,a1
    80004f00:	8a32                	mv	s4,a2
  int i = 0;
    80004f02:	4481                	li	s1,0
    int nn = sizeof(buf);
    if(nn > n - i)
    80004f04:	02000c13          	li	s8,32
    80004f08:	02000c93          	li	s9,32
      nn = n - i;
    if(either_copyin(buf, user_src, src+i, nn) == -1)
    80004f0c:	5bfd                	li	s7,-1
    80004f0e:	a035                	j	80004f3a <consolewrite+0x5c>
    if(nn > n - i)
    80004f10:	0009099b          	sext.w	s3,s2
    if(either_copyin(buf, user_src, src+i, nn) == -1)
    80004f14:	86ce                	mv	a3,s3
    80004f16:	01648633          	add	a2,s1,s6
    80004f1a:	85d6                	mv	a1,s5
    80004f1c:	f8040513          	addi	a0,s0,-128
    80004f20:	ff8fc0ef          	jal	80001718 <either_copyin>
    80004f24:	03750e63          	beq	a0,s7,80004f60 <consolewrite+0x82>
      break;
    uartwrite(buf, nn);
    80004f28:	85ce                	mv	a1,s3
    80004f2a:	f8040513          	addi	a0,s0,-128
    80004f2e:	778000ef          	jal	800056a6 <uartwrite>
    i += nn;
    80004f32:	009904bb          	addw	s1,s2,s1
  while(i < n){
    80004f36:	0144da63          	bge	s1,s4,80004f4a <consolewrite+0x6c>
    if(nn > n - i)
    80004f3a:	409a093b          	subw	s2,s4,s1
    80004f3e:	0009079b          	sext.w	a5,s2
    80004f42:	fcfc57e3          	bge	s8,a5,80004f10 <consolewrite+0x32>
    80004f46:	8966                	mv	s2,s9
    80004f48:	b7e1                	j	80004f10 <consolewrite+0x32>
    80004f4a:	7906                	ld	s2,96(sp)
    80004f4c:	69e6                	ld	s3,88(sp)
    80004f4e:	6a46                	ld	s4,80(sp)
    80004f50:	6aa6                	ld	s5,72(sp)
    80004f52:	6b06                	ld	s6,64(sp)
    80004f54:	7be2                	ld	s7,56(sp)
    80004f56:	7c42                	ld	s8,48(sp)
    80004f58:	7ca2                	ld	s9,40(sp)
    80004f5a:	a819                	j	80004f70 <consolewrite+0x92>
  int i = 0;
    80004f5c:	4481                	li	s1,0
    80004f5e:	a809                	j	80004f70 <consolewrite+0x92>
    80004f60:	7906                	ld	s2,96(sp)
    80004f62:	69e6                	ld	s3,88(sp)
    80004f64:	6a46                	ld	s4,80(sp)
    80004f66:	6aa6                	ld	s5,72(sp)
    80004f68:	6b06                	ld	s6,64(sp)
    80004f6a:	7be2                	ld	s7,56(sp)
    80004f6c:	7c42                	ld	s8,48(sp)
    80004f6e:	7ca2                	ld	s9,40(sp)
  }

  return i;
}
    80004f70:	8526                	mv	a0,s1
    80004f72:	70e6                	ld	ra,120(sp)
    80004f74:	7446                	ld	s0,112(sp)
    80004f76:	74a6                	ld	s1,104(sp)
    80004f78:	6109                	addi	sp,sp,128
    80004f7a:	8082                	ret

0000000080004f7c <consoleread>:
...
{
    80004f7c:	711d                	addi	sp,sp,-96
    80004f7e:	ec86                	sd	ra,88(sp)
    80004f80:	e8a2                	sd	s0,80(sp)
    80004f82:	e4a6                	sd	s1,72(sp)
    80004f84:	e0ca                	sd	s2,64(sp)
    80004f86:	fc4e                	sd	s3,56(sp)
    80004f88:	f852                	sd	s4,48(sp)
    80004f8a:	f456                	sd	s5,40(sp)
    80004f8c:	f05a                	sd	s6,32(sp)
    80004f8e:	1080                	addi	s0,sp,96
    80004f90:	8aaa                	mv	s5,a0
    80004f92:	8a2e                	mv	s4,a1
    80004f94:	89b2                	mv	s3,a2
  uint target;
  int c;
  char cbuf;

  target = n;
    80004f96:	00060b1b          	sext.w	s6,a2
  acquire(&cons.lock);
    80004f9a:	0001e517          	auipc	a0,0x1e
    80004f9e:	46650513          	addi	a0,a0,1126 # 80023400 <cons>
    80004fa2:	109000ef          	jal	800058aa <acquire>
  while(n > 0){
    // wait until interrupt handler has put some
    // input into cons.buffer.
    while(cons.r == cons.w){
    80004fa6:	0001e497          	auipc	s1,0x1e
    80004faa:	45a48493          	addi	s1,s1,1114 # 80023400 <cons>
      if(killed(myproc())){
        release(&cons.lock);
        return -1;
      }
      sleep(&cons.r, &cons.lock);
    80004fae:	0001e917          	auipc	s2,0x1e
    80004fb2:	4ea90913          	addi	s2,s2,1258 # 80023498 <cons+0x98>
  while(n > 0){
    80004fb6:	0b305d63          	blez	s3,80005070 <consoleread+0xf4>
    while(cons.r == cons.w){
    80004fba:	0984a783          	lw	a5,152(s1)
    80004fbe:	09c4a703          	lw	a4,156(s1)
    80004fc2:	0af71263          	bne	a4,a5,80005066 <consoleread+0xea>
      if(killed(myproc())){
    80004fc6:	db5fb0ef          	jal	80000d7a <myproc>
    80004fca:	de0fc0ef          	jal	800015aa <killed>
    80004fce:	e12d                	bnez	a0,80005030 <consoleread+0xb4>
      sleep(&cons.r, &cons.lock);
    80004fd0:	85a6                	mv	a1,s1
    80004fd2:	854a                	mv	a0,s2
    80004fd4:	b9efc0ef          	jal	80001372 <sleep>
    while(cons.r == cons.w){
    80004fd8:	0984a783          	lw	a5,152(s1)
    80004fdc:	09c4a703          	lw	a4,156(s1)
    80004fe0:	fef703e3          	beq	a4,a5,80004fc6 <consoleread+0x4a>
    80004fe4:	ec5e                	sd	s7,24(sp)
    }

    c = cons.buf[cons.r++ % INPUT_BUF_SIZE];
    80004fe6:	0001e717          	auipc	a4,0x1e
    80004fea:	41a70713          	addi	a4,a4,1050 # 80023400 <cons>
    80004fee:	0017869b          	addiw	a3,a5,1
    80004ff2:	08d72c23          	sw	a3,152(a4)
    80004ff6:	07f7f693          	andi	a3,a5,127
    80004ffa:	9736                	add	a4,a4,a3
    80004ffc:	01874703          	lbu	a4,24(a4)
    80005000:	00070b9b          	sext.w	s7,a4

    if(c == C('D')){  // end-of-file
    80005004:	4691                	li	a3,4
    80005006:	04db8663          	beq	s7,a3,80005052 <consoleread+0xd6>
      }
      break;
    }
    ...
    cbuf = c;
    8000500a:	fae407a3          	sb	a4,-81(s0)
    if(either_copyout(user_dst, dst, &cbuf, 1) == -1)
    8000500e:	4685                	li	a3,1
    80005010:	faf40613          	addi	a2,s0,-81
    80005014:	85d2                	mv	a1,s4
    80005016:	8556                	mv	a0,s5
    80005018:	eb6fc0ef          	jal	800016ce <either_copyout>
    8000501c:	57fd                	li	a5,-1
    8000501e:	04f50863          	beq	a0,a5,8000506e <consoleread+0xf2>
      break;

    dst++;
    80005022:	0a05                	addi	s4,s4,1
    --n;
    80005024:	39fd                	addiw	s3,s3,-1

    if(c == '\n'){
    80005026:	47a9                	li	a5,10
    80005028:	04fb8d63          	beq	s7,a5,80005082 <consoleread+0x106>
    8000502c:	6be2                	ld	s7,24(sp)
    8000502e:	b761                	j	80004fb6 <consoleread+0x3a>
        release(&cons.lock);
    80005030:	0001e517          	auipc	a0,0x1e
    80005034:	3d050513          	addi	a0,a0,976 # 80023400 <cons>
    80005038:	10b000ef          	jal	80005942 <release>
        return -1;
  ...
  return target - n;
    ...
    80005050:	8082                	ret
      if(n < target){
    80005052:	0009871b          	sext.w	a4,s3
    80005056:	01677a63          	bgeu	a4,s6,8000506a <consoleread+0xee>
        cons.r--;
    8000505a:	0001e717          	auipc	a4,0x1e
    8000505e:	42f72f23          	sw	a5,1086(a4) # 80023498 <cons+0x98>
    80005062:	6be2                	ld	s7,24(sp)
    80005064:	a031                	j	80005070 <consoleread+0xf4>
    80005066:	ec5e                	sd	s7,24(sp)
    80005068:	bfbd                	j	80004fe6 <consoleread+0x6a>
    8000506a:	6be2                	ld	s7,24(sp)
    8000506c:	a011                	j	80005070 <consoleread+0xf4>
    8000506e:	6be2                	ld	s7,24(sp)
  release(&cons.lock);
    80005070:	0001e517          	auipc	a0,0x1e
    80005074:	39050513          	addi	a0,a0,912 # 80023400 <cons>
    80005078:	0cb000ef          	jal	80005942 <release>
  return target - n;
    8000507c:	413b053b          	subw	a0,s6,s3
    80005080:	bf7d                	j	8000503e <consoleread+0xc2>
    80005082:	6be2                	ld	s7,24(sp)
    80005084:	b7f5                	j	80005070 <consoleread+0xf4>

0000000080005086 <consputc>:
{
  ...
  if(c == BACKSPACE){
    8000508e:	10000793          	li	a5,256
    80005092:	00f50863          	beq	a0,a5,800050a2 <consputc+0x1c>
    uartputc_sync(c);
    80005096:	6a4000ef          	jal	8000573a <uartputc_sync>
}
    ...
    800050a2:	4521                	li	a0,8
    800050a4:	696000ef          	jal	8000573a <uartputc_sync>
    800050a8:	02000513          	li	a0,32
    800050ac:	68e000ef          	jal	8000573a <uartputc_sync>
    800050b0:	4521                	li	a0,8
    800050b2:	688000ef          	jal	8000573a <uartputc_sync>
    800050b6:	b7d5                	j	8000509a <consputc+0x14>

00000000800050b8 <consoleintr>:
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    800050c4:	0001e517          	auipc	a0,0x1e
    800050c8:	33c50513          	addi	a0,a0,828 # 80023400 <cons>
    800050cc:	7de000ef          	jal	800058aa <acquire>

  switch(c){
    800050d0:	47d5                	li	a5,21
    800050d2:	08f48f63          	beq	s1,a5,80005170 <consoleintr+0xb8>
    800050d6:	0297c563          	blt	a5,s1,80005100 <consoleintr+0x48>
    800050da:	47a1                	li	a5,8
    800050dc:	0ef48463          	beq	s1,a5,800051c4 <consoleintr+0x10c>
    800050e0:	47c1                	li	a5,16
    800050e2:	10f49563          	bne	s1,a5,800051ec <consoleintr+0x134>
  case C('P'):  // Print process list.
    procdump();
    800050e6:	e7cfc0ef          	jal	80001762 <procdump>
      }
    }
    break;
  }
  ...
  release(&cons.lock);
    ...
    800050ee:	31650513          	addi	a0,a0,790 # 80023400 <cons>
    800050f2:	051000ef          	jal	80005942 <release>
}
    ...
    800050fe:	8082                	ret
  switch(c){
    80005100:	07f00793          	li	a5,127
    80005104:	0cf48063          	beq	s1,a5,800051c4 <consoleintr+0x10c>
    if(c != 0 && cons.e-cons.r < INPUT_BUF_SIZE){
    80005108:	0001e717          	auipc	a4,0x1e
    8000510c:	2f870713          	addi	a4,a4,760 # 80023400 <cons>
    80005110:	0a072783          	lw	a5,160(a4)
    80005114:	09872703          	lw	a4,152(a4)
    80005118:	9f99                	subw	a5,a5,a4
    8000511a:	07f00713          	li	a4,127
    8000511e:	fcf766e3          	bltu	a4,a5,800050ea <consoleintr+0x32>
      c = (c == '\r') ? '\n' : c;
    80005122:	47b5                	li	a5,13
    80005124:	0cf48763          	beq	s1,a5,800051f2 <consoleintr+0x13a>
      consputc(c);
    80005128:	8526                	mv	a0,s1
    8000512a:	f5dff0ef          	jal	80005086 <consputc>
      cons.buf[cons.e++ % INPUT_BUF_SIZE] = c;
    8000512e:	0001e797          	auipc	a5,0x1e
    80005132:	2d278793          	addi	a5,a5,722 # 80023400 <cons>
    80005136:	0a07a683          	lw	a3,160(a5)
    8000513a:	0016871b          	addiw	a4,a3,1
    8000513e:	0007061b          	sext.w	a2,a4
    80005142:	0ae7a023          	sw	a4,160(a5)
    80005146:	07f6f693          	andi	a3,a3,127
    8000514a:	97b6                	add	a5,a5,a3
    8000514c:	00978c23          	sb	s1,24(a5)
      if(c == '\n' || c == C('D') || cons.e-cons.r == INPUT_BUF_SIZE){
    80005150:	47a9                	li	a5,10
    80005152:	0cf48563          	beq	s1,a5,8000521c <consoleintr+0x164>
    80005156:	4791                	li	a5,4
    80005158:	0cf48263          	beq	s1,a5,8000521c <consoleintr+0x164>
    8000515c:	0001e797          	auipc	a5,0x1e
    80005160:	33c7a783          	lw	a5,828(a5) # 80023498 <cons+0x98>
    80005164:	9f1d                	subw	a4,a4,a5
    80005166:	08000793          	li	a5,128
    8000516a:	f8f710e3          	bne	a4,a5,800050ea <consoleintr+0x32>
    8000516e:	a07d                	j	8000521c <consoleintr+0x164>
    80005170:	e04a                	sd	s2,0(sp)
    while(cons.e != cons.w &&
    80005172:	0001e717          	auipc	a4,0x1e
    80005176:	28e70713          	addi	a4,a4,654 # 80023400 <cons>
    8000517a:	0a072783          	lw	a5,160(a4)
    8000517e:	09c72703          	lw	a4,156(a4)
          cons.buf[(cons.e-1) % INPUT_BUF_SIZE] != '\n'){
    80005182:	0001e497          	auipc	s1,0x1e
    80005186:	27e48493          	addi	s1,s1,638 # 80023400 <cons>
    while(cons.e != cons.w &&
    8000518a:	4929                	li	s2,10
    8000518c:	02f70863          	beq	a4,a5,800051bc <consoleintr+0x104>
          cons.buf[(cons.e-1) % INPUT_BUF_SIZE] != '\n'){
    80005190:	37fd                	addiw	a5,a5,-1
    80005192:	07f7f713          	andi	a4,a5,127
    80005196:	9726                	add	a4,a4,s1
    while(cons.e != cons.w &&
    80005198:	01874703          	lbu	a4,24(a4)
    8000519c:	03270263          	beq	a4,s2,800051c0 <consoleintr+0x108>
      cons.e--;
    800051a0:	0af4a023          	sw	a5,160(s1)
      consputc(BACKSPACE);
    800051a4:	10000513          	li	a0,256
    800051a8:	edfff0ef          	jal	80005086 <consputc>
    while(cons.e != cons.w &&
    800051ac:	0a04a783          	lw	a5,160(s1)
    800051b0:	09c4a703          	lw	a4,156(s1)
    800051b4:	fcf71ee3          	bne	a4,a5,80005190 <consoleintr+0xd8>
    800051b8:	6902                	ld	s2,0(sp)
    800051ba:	bf05                	j	800050ea <consoleintr+0x32>
    800051bc:	6902                	ld	s2,0(sp)
    800051be:	b735                	j	800050ea <consoleintr+0x32>
    800051c0:	6902                	ld	s2,0(sp)
    800051c2:	b725                	j	800050ea <consoleintr+0x32>
    if(cons.e != cons.w){
    800051c4:	0001e717          	auipc	a4,0x1e
    800051c8:	23c70713          	addi	a4,a4,572 # 80023400 <cons>
    800051cc:	0a072783          	lw	a5,160(a4)
    800051d0:	09c72703          	lw	a4,156(a4)
    800051d4:	f0f70be3          	beq	a4,a5,800050ea <consoleintr+0x32>
      cons.e--;
    800051d8:	37fd                	addiw	a5,a5,-1
    800051da:	0001e717          	auipc	a4,0x1e
    800051de:	2cf72323          	sw	a5,710(a4) # 800234a0 <cons+0xa0>
      consputc(BACKSPACE);
    800051e2:	10000513          	li	a0,256
    800051e6:	ea1ff0ef          	jal	80005086 <consputc>
    800051ea:	b701                	j	800050ea <consoleintr+0x32>
    if(c != 0 && cons.e-cons.r < INPUT_BUF_SIZE){
    800051ec:	ee048fe3          	beqz	s1,800050ea <consoleintr+0x32>
    800051f0:	bf21                	j	80005108 <consoleintr+0x50>
      consputc(c);
    800051f2:	4529                	li	a0,10
    800051f4:	e93ff0ef          	jal	80005086 <consputc>
      cons.buf[cons.e++ % INPUT_BUF_SIZE] = c;
    800051f8:	0001e797          	auipc	a5,0x1e
    800051fc:	20878793          	addi	a5,a5,520 # 80023400 <cons>
    80005200:	0a07a703          	lw	a4,160(a5)
    80005204:	0017069b          	addiw	a3,a4,1
    80005208:	0006861b          	sext.w	a2,a3
    ...
    80005220:	28c7a023          	sw	a2,640(a5) # 8002349c <cons+0x9c>
        wakeup(&cons.r);
    80005224:	0001e517          	auipc	a0,0x1e
    80005228:	27450513          	addi	a0,a0,628 # 80023498 <cons+0x98>
    8000522c:	992fc0ef          	jal	800013be <wakeup>
    80005230:	bd6d                	j	800050ea <consoleintr+0x32>
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    80005246:	1be50513          	addi	a0,a0,446 # 80023400 <cons>
    8000524a:	5e0000ef          	jal	8000582a <initlock>

  uartinit();
    8000524e:	400000ef          	jal	8000564e <uartinit>

  // connect read and write system calls
  // to consoleread and consolewrite.
  devsw[CONSOLE].read = consoleread;
    80005252:	00015797          	auipc	a5,0x15
    80005256:	01678793          	addi	a5,a5,22 # 8001a268 <devsw>
    8000525a:	00000717          	auipc	a4,0x0
    8000525e:	d2270713          	addi	a4,a4,-734 # 80004f7c <consoleread>
    80005262:	eb98                	sd	a4,16(a5)
  devsw[CONSOLE].write = consolewrite;
    80005264:	00000717          	auipc	a4,0x0
    80005268:	c7a70713          	addi	a4,a4,-902 # 80004ede <consolewrite>
...
printint(long long xx, int base, int sign)
{
    ...
    8000527c:	0080                	addi	s0,sp,64
  char buf[20];
  int i;
  unsigned long long x;

  if(sign && (sign = (xx < 0)))
    8000527e:	c219                	beqz	a2,80005284 <printint+0xe>
    80005280:	08054063          	bltz	a0,80005300 <printint+0x8a>
    x = -xx;
  else
    x = xx;
    80005284:	4881                	li	a7,0
    80005286:	fc840693          	addi	a3,s0,-56

  i = 0;
    8000528a:	4781                	li	a5,0
  do {
    buf[i++] = digits[x % base];
    8000528c:	00002617          	auipc	a2,0x2
    80005290:	58460613          	addi	a2,a2,1412 # 80007810 <digits>
    80005294:	883e                	mv	a6,a5
    80005296:	2785                	addiw	a5,a5,1
    80005298:	02b57733          	remu	a4,a0,a1
    8000529c:	9732                	add	a4,a4,a2
    8000529e:	00074703          	lbu	a4,0(a4)
    800052a2:	00e68023          	sb	a4,0(a3)
  } while((x /= base) != 0);
    800052a6:	872a                	mv	a4,a0
    800052a8:	02b55533          	divu	a0,a0,a1
    800052ac:	0685                	addi	a3,a3,1
    800052ae:	feb773e3          	bgeu	a4,a1,80005294 <printint+0x1e>

  if(sign)
    800052b2:	00088a63          	beqz	a7,800052c6 <printint+0x50>
    buf[i++] = '-';
    800052b6:	1781                	addi	a5,a5,-32
    800052b8:	97a2                	add	a5,a5,s0
    800052ba:	02d00713          	li	a4,45
    800052be:	fee78423          	sb	a4,-24(a5)
    800052c2:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
    800052c6:	02f05963          	blez	a5,800052f8 <printint+0x82>
    800052ca:	f426                	sd	s1,40(sp)
    800052cc:	f04a                	sd	s2,32(sp)
    800052ce:	fc840713          	addi	a4,s0,-56
    800052d2:	00f704b3          	add	s1,a4,a5
    800052d6:	fff70913          	addi	s2,a4,-1
    800052da:	993e                	add	s2,s2,a5
    800052dc:	37fd                	addiw	a5,a5,-1
    800052de:	1782                	slli	a5,a5,0x20
    800052e0:	9381                	srli	a5,a5,0x20
    800052e2:	40f90933          	sub	s2,s2,a5
    consputc(buf[i]);
    800052e6:	fff4c503          	lbu	a0,-1(s1)
    800052ea:	d9dff0ef          	jal	80005086 <consputc>
  while(--i >= 0)
    800052ee:	14fd                	addi	s1,s1,-1
    800052f0:	ff249be3          	bne	s1,s2,800052e6 <printint+0x70>
    800052f4:	74a2                	ld	s1,40(sp)
    800052f6:	7902                	ld	s2,32(sp)
}
    800052f8:	70e2                	ld	ra,56(sp)
    800052fa:	7442                	ld	s0,48(sp)
    800052fc:	6121                	addi	sp,sp,64
    800052fe:	8082                	ret
    x = -xx;
    80005300:	40a00533          	neg	a0,a0
  if(sign && (sign = (xx < 0)))
    80005304:	4885                	li	a7,1
    x = -xx;
    80005306:	b741                	j	80005286 <printint+0x10>

0000000080005308 <printf>:
}
...
printf(char *fmt, ...)
{
    80005308:	7131                	addi	sp,sp,-192
    8000530a:	fc86                	sd	ra,120(sp)
    8000530c:	f8a2                	sd	s0,112(sp)
    8000530e:	e8d2                	sd	s4,80(sp)
    80005310:	0100                	addi	s0,sp,128
    80005312:	8a2a                	mv	s4,a0
    80005314:	e40c                	sd	a1,8(s0)
    80005316:	e810                	sd	a2,16(s0)
    80005318:	ec14                	sd	a3,24(s0)
    8000531a:	f018                	sd	a4,32(s0)
    8000531c:	f41c                	sd	a5,40(s0)
    8000531e:	03043823          	sd	a6,48(s0)
    80005322:	03143c23          	sd	a7,56(s0)
  va_list ap;
  int i, cx, c0, c1, c2;
  char *s;

  if(panicking == 0)
    80005326:	00005797          	auipc	a5,0x5
    8000532a:	e9a7a783          	lw	a5,-358(a5) # 8000a1c0 <panicking>
    8000532e:	c3a1                	beqz	a5,8000536e <printf+0x66>
    acquire(&pr.lock);

  va_start(ap, fmt);
    80005330:	00840793          	addi	a5,s0,8
    80005334:	f8f43423          	sd	a5,-120(s0)
  for(i = 0; (cx = fmt[i] & 0xff) != 0; i++){
    80005338:	000a4503          	lbu	a0,0(s4)
    8000533c:	28050763          	beqz	a0,800055ca <printf+0x2c2>
    80005340:	f4a6                	sd	s1,104(sp)
    80005342:	f0ca                	sd	s2,96(sp)
    80005344:	ecce                	sd	s3,88(sp)
    80005346:	e4d6                	sd	s5,72(sp)
    80005348:	e0da                	sd	s6,64(sp)
    8000534a:	f862                	sd	s8,48(sp)
    8000534c:	f466                	sd	s9,40(sp)
    8000534e:	f06a                	sd	s10,32(sp)
    80005350:	ec6e                	sd	s11,24(sp)
    80005352:	4981                	li	s3,0
    if(cx != '%'){
    80005354:	02500a93          	li	s5,37
    i++;
    c0 = fmt[i+0] & 0xff;
    c1 = c2 = 0;
    ...
    if(c0 == 'd'){
    80005358:	06400b13          	li	s6,100
      printint(va_arg(ap, int), 10, 1);
    } else if(c0 == 'l' && c1 == 'd'){
    8000535c:	06c00c13          	li	s8,108
    ...
    80005368:	07000d93          	li	s11,112
    8000536c:	a01d                	j	80005392 <printf+0x8a>
    acquire(&pr.lock);
    8000536e:	0001e517          	auipc	a0,0x1e
    80005372:	13a50513          	addi	a0,a0,314 # 800234a8 <pr>
    80005376:	534000ef          	jal	800058aa <acquire>
    8000537a:	bf5d                	j	80005330 <printf+0x28>
      consputc(cx);
    8000537c:	d0bff0ef          	jal	80005086 <consputc>
      continue;
    80005380:	84ce                	mv	s1,s3
  for(i = 0; (cx = fmt[i] & 0xff) != 0; i++){
    80005382:	0014899b          	addiw	s3,s1,1
    80005386:	013a07b3          	add	a5,s4,s3
    8000538a:	0007c503          	lbu	a0,0(a5)
    8000538e:	20050b63          	beqz	a0,800055a4 <printf+0x29c>
    if(cx != '%'){
    80005392:	ff5515e3          	bne	a0,s5,8000537c <printf+0x74>
    i++;
    80005396:	0019849b          	addiw	s1,s3,1
    c0 = fmt[i+0] & 0xff;
    8000539a:	009a07b3          	add	a5,s4,s1
    8000539e:	0007c903          	lbu	s2,0(a5)
    if(c0) c1 = fmt[i+1] & 0xff;
    800053a2:	20090b63          	beqz	s2,800055b8 <printf+0x2b0>
    800053a6:	0017c783          	lbu	a5,1(a5)
    c1 = c2 = 0;
    800053aa:	86be                	mv	a3,a5
    if(c1) c2 = fmt[i+2] & 0xff;
    800053ac:	c789                	beqz	a5,800053b6 <printf+0xae>
    800053ae:	009a0733          	add	a4,s4,s1
    800053b2:	00274683          	lbu	a3,2(a4)
    if(c0 == 'd'){
    800053b6:	03690963          	beq	s2,s6,800053e8 <printf+0xe0>
    } else if(c0 == 'l' && c1 == 'd'){
    800053ba:	05890363          	beq	s2,s8,80005400 <printf+0xf8>
    } else if(c0 == 'u'){
    800053be:	0d990663          	beq	s2,s9,8000548a <printf+0x182>
    } else if(c0 == 'x'){
    800053c2:	11a90d63          	beq	s2,s10,800054dc <printf+0x1d4>
    } else if(c0 == 'p'){
    800053c6:	15b90663          	beq	s2,s11,80005512 <printf+0x20a>
      printptr(va_arg(ap, uint64));
    } else if(c0 == 'c'){
    800053ca:	06300793          	li	a5,99
    800053ce:	18f90563          	beq	s2,a5,80005558 <printf+0x250>
      consputc(va_arg(ap, uint));
    } else if(c0 == 's'){
    800053d2:	07300793          	li	a5,115
    800053d6:	18f90b63          	beq	s2,a5,8000556c <printf+0x264>
      if((s = va_arg(ap, char*)) == 0)
        s = "(null)";
      for(; *s; s++)
        consputc(*s);
    } else if(c0 == '%'){
    800053da:	03591b63          	bne	s2,s5,80005410 <printf+0x108>
      consputc('%');
    800053de:	02500513          	li	a0,37
    800053e2:	ca5ff0ef          	jal	80005086 <consputc>
    800053e6:	bf71                	j	80005382 <printf+0x7a>
      printint(va_arg(ap, int), 10, 1);
    800053e8:	f8843783          	ld	a5,-120(s0)
    800053ec:	00878713          	addi	a4,a5,8
    800053f0:	f8e43423          	sd	a4,-120(s0)
    800053f4:	4605                	li	a2,1
    800053f6:	45a9                	li	a1,10
    800053f8:	4388                	lw	a0,0(a5)
    800053fa:	e7dff0ef          	jal	80005276 <printint>
    800053fe:	b751                	j	80005382 <printf+0x7a>
    } else if(c0 == 'l' && c1 == 'd'){
    80005400:	01678f63          	beq	a5,s6,8000541e <printf+0x116>
    } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    80005404:	03878b63          	beq	a5,s8,8000543a <printf+0x132>
    } else if(c0 == 'l' && c1 == 'u'){
    80005408:	09978e63          	beq	a5,s9,800054a4 <printf+0x19c>
    } else if(c0 == 'l' && c1 == 'x'){
    8000540c:	0fa78563          	beq	a5,s10,800054f6 <printf+0x1ee>
    } else if(c0 == 0){
      break;
    } else {
    ...
    80005412:	c75ff0ef          	jal	80005086 <consputc>
      consputc(c0);
    80005416:	854a                	mv	a0,s2
    80005418:	c6fff0ef          	jal	80005086 <consputc>
    8000541c:	b79d                	j	80005382 <printf+0x7a>
      printint(va_arg(ap, uint64), 10, 1);
    8000541e:	f8843783          	ld	a5,-120(s0)
    80005422:	00878713          	addi	a4,a5,8
    80005426:	f8e43423          	sd	a4,-120(s0)
    8000542a:	4605                	li	a2,1
    8000542c:	45a9                	li	a1,10
    8000542e:	6388                	ld	a0,0(a5)
    80005430:	e47ff0ef          	jal	80005276 <printint>
      i += 1;
    80005434:	0029849b          	addiw	s1,s3,2
    80005438:	b7a9                	j	80005382 <printf+0x7a>
    } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    8000543a:	06400793          	li	a5,100
    8000543e:	02f68863          	beq	a3,a5,8000546e <printf+0x166>
    } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    80005442:	07500793          	li	a5,117
    80005446:	06f68d63          	beq	a3,a5,800054c0 <printf+0x1b8>
    } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    8000544a:	07800793          	li	a5,120
    8000544e:	fcf691e3          	bne	a3,a5,80005410 <printf+0x108>
      printint(va_arg(ap, uint64), 16, 0);
    80005452:	f8843783          	ld	a5,-120(s0)
    80005456:	00878713          	addi	a4,a5,8
    8000545a:	f8e43423          	sd	a4,-120(s0)
    8000545e:	4601                	li	a2,0
    80005460:	45c1                	li	a1,16
    80005462:	6388                	ld	a0,0(a5)
    80005464:	e13ff0ef          	jal	80005276 <printint>
      i += 2;
    80005468:	0039849b          	addiw	s1,s3,3
    8000546c:	bf19                	j	80005382 <printf+0x7a>
      printint(va_arg(ap, uint64), 10, 1);
    ...
    80005480:	df7ff0ef          	jal	80005276 <printint>
      i += 2;
    80005484:	0039849b          	addiw	s1,s3,3
    80005488:	bded                	j	80005382 <printf+0x7a>
      printint(va_arg(ap, uint32), 10, 0);
    8000548a:	f8843783          	ld	a5,-120(s0)
    8000548e:	00878713          	addi	a4,a5,8
    80005492:	f8e43423          	sd	a4,-120(s0)
    80005496:	4601                	li	a2,0
    80005498:	45a9                	li	a1,10
    8000549a:	0007e503          	lwu	a0,0(a5)
    8000549e:	dd9ff0ef          	jal	80005276 <printint>
    800054a2:	b5c5                	j	80005382 <printf+0x7a>
      printint(va_arg(ap, uint64), 10, 0);
    800054a4:	f8843783          	ld	a5,-120(s0)
    800054a8:	00878713          	addi	a4,a5,8
    800054ac:	f8e43423          	sd	a4,-120(s0)
    800054b0:	4601                	li	a2,0
    800054b2:	45a9                	li	a1,10
    800054b4:	6388                	ld	a0,0(a5)
    800054b6:	dc1ff0ef          	jal	80005276 <printint>
      i += 1;
    800054ba:	0029849b          	addiw	s1,s3,2
    800054be:	b5d1                	j	80005382 <printf+0x7a>
      printint(va_arg(ap, uint64), 10, 0);
    800054c0:	f8843783          	ld	a5,-120(s0)
    800054c4:	00878713          	addi	a4,a5,8
    800054c8:	f8e43423          	sd	a4,-120(s0)
    800054cc:	4601                	li	a2,0
    800054ce:	45a9                	li	a1,10
    800054d0:	6388                	ld	a0,0(a5)
    800054d2:	da5ff0ef          	jal	80005276 <printint>
      i += 2;
    800054d6:	0039849b          	addiw	s1,s3,3
    800054da:	b565                	j	80005382 <printf+0x7a>
      printint(va_arg(ap, uint32), 16, 0);
    800054dc:	f8843783          	ld	a5,-120(s0)
    800054e0:	00878713          	addi	a4,a5,8
    800054e4:	f8e43423          	sd	a4,-120(s0)
    800054e8:	4601                	li	a2,0
    800054ea:	45c1                	li	a1,16
    800054ec:	0007e503          	lwu	a0,0(a5)
    800054f0:	d87ff0ef          	jal	80005276 <printint>
    800054f4:	b579                	j	80005382 <printf+0x7a>
      printint(va_arg(ap, uint64), 16, 0);
    800054f6:	f8843783          	ld	a5,-120(s0)
    800054fa:	00878713          	addi	a4,a5,8
    800054fe:	f8e43423          	sd	a4,-120(s0)
    80005502:	4601                	li	a2,0
    80005504:	45c1                	li	a1,16
    80005506:	6388                	ld	a0,0(a5)
    80005508:	d6fff0ef          	jal	80005276 <printint>
      i += 1;
    8000550c:	0029849b          	addiw	s1,s3,2
    80005510:	bd8d                	j	80005382 <printf+0x7a>
    80005512:	fc5e                	sd	s7,56(sp)
      printptr(va_arg(ap, uint64));
    80005514:	f8843783          	ld	a5,-120(s0)
    80005518:	00878713          	addi	a4,a5,8
    8000551c:	f8e43423          	sd	a4,-120(s0)
    80005520:	0007b983          	ld	s3,0(a5)
  consputc('0');
    80005524:	03000513          	li	a0,48
    80005528:	b5fff0ef          	jal	80005086 <consputc>
  consputc('x');
    8000552c:	07800513          	li	a0,120
    80005530:	b57ff0ef          	jal	80005086 <consputc>
    80005534:	4941                	li	s2,16
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80005536:	00002b97          	auipc	s7,0x2
    8000553a:	2dab8b93          	addi	s7,s7,730 # 80007810 <digits>
    8000553e:	03c9d793          	srli	a5,s3,0x3c
    80005542:	97de                	add	a5,a5,s7
    80005544:	0007c503          	lbu	a0,0(a5)
    80005548:	b3fff0ef          	jal	80005086 <consputc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    8000554c:	0992                	slli	s3,s3,0x4
    8000554e:	397d                	addiw	s2,s2,-1
    80005550:	fe0917e3          	bnez	s2,8000553e <printf+0x236>
    80005554:	7be2                	ld	s7,56(sp)
    80005556:	b535                	j	80005382 <printf+0x7a>
      consputc(va_arg(ap, uint));
    80005558:	f8843783          	ld	a5,-120(s0)
    8000555c:	00878713          	addi	a4,a5,8
    80005560:	f8e43423          	sd	a4,-120(s0)
    80005564:	4388                	lw	a0,0(a5)
    80005566:	b21ff0ef          	jal	80005086 <consputc>
    8000556a:	bd21                	j	80005382 <printf+0x7a>
      if((s = va_arg(ap, char*)) == 0)
    8000556c:	f8843783          	ld	a5,-120(s0)
    80005570:	00878713          	addi	a4,a5,8
    80005574:	f8e43423          	sd	a4,-120(s0)
    80005578:	0007b903          	ld	s2,0(a5)
    8000557c:	00090d63          	beqz	s2,80005596 <printf+0x28e>
      for(; *s; s++)
    80005580:	00094503          	lbu	a0,0(s2)
    80005584:	de050fe3          	beqz	a0,80005382 <printf+0x7a>
        consputc(*s);
    80005588:	affff0ef          	jal	80005086 <consputc>
      for(; *s; s++)
    8000558c:	0905                	addi	s2,s2,1
    8000558e:	00094503          	lbu	a0,0(s2)
    80005592:	f97d                	bnez	a0,80005588 <printf+0x280>
    80005594:	b3fd                	j	80005382 <printf+0x7a>
        s = "(null)";
    80005596:	00002917          	auipc	s2,0x2
    8000559a:	12290913          	addi	s2,s2,290 # 800076b8 <etext+0x6b8>
      for(; *s; s++)
    8000559e:	02800513          	li	a0,40
    800055a2:	b7dd                	j	80005588 <printf+0x280>
    800055a4:	74a6                	ld	s1,104(sp)
    800055a6:	7906                	ld	s2,96(sp)
    800055a8:	69e6                	ld	s3,88(sp)
    800055aa:	6aa6                	ld	s5,72(sp)
    800055ac:	6b06                	ld	s6,64(sp)
    800055ae:	7c42                	ld	s8,48(sp)
    800055b0:	7ca2                	ld	s9,40(sp)
    800055b2:	7d02                	ld	s10,32(sp)
    800055b4:	6de2                	ld	s11,24(sp)
    800055b6:	a811                	j	800055ca <printf+0x2c2>
    800055b8:	74a6                	ld	s1,104(sp)
    800055ba:	7906                	ld	s2,96(sp)
    800055bc:	69e6                	ld	s3,88(sp)
    800055be:	6aa6                	ld	s5,72(sp)
    800055c0:	6b06                	ld	s6,64(sp)
    800055c2:	7c42                	ld	s8,48(sp)
    800055c4:	7ca2                	ld	s9,40(sp)
    800055c6:	7d02                	ld	s10,32(sp)
    800055c8:	6de2                	ld	s11,24(sp)
    }
  ...
  if(panicking == 0)
    800055ca:	00005797          	auipc	a5,0x5
    800055ce:	bf67a783          	lw	a5,-1034(a5) # 8000a1c0 <panicking>
    800055d2:	c799                	beqz	a5,800055e0 <printf+0x2d8>
    release(&pr.lock);

  return 0;
}
    800055d4:	4501                	li	a0,0
    800055d6:	70e6                	ld	ra,120(sp)
    800055d8:	7446                	ld	s0,112(sp)
    800055da:	6a46                	ld	s4,80(sp)
    800055dc:	6129                	addi	sp,sp,192
    800055de:	8082                	ret
    release(&pr.lock);
    800055e0:	0001e517          	auipc	a0,0x1e
    800055e4:	ec850513          	addi	a0,a0,-312 # 800234a8 <pr>
    800055e8:	35a000ef          	jal	80005942 <release>
  return 0;
    800055ec:	b7e5                	j	800055d4 <printf+0x2cc>

00000000800055ee <panic>:
...
panic(char *s)
{
    ...
    800055f6:	e04a                	sd	s2,0(sp)
    800055f8:	1000                	addi	s0,sp,32
    800055fa:	84aa                	mv	s1,a0
  panicking = 1;
    800055fc:	4905                	li	s2,1
    800055fe:	00005797          	auipc	a5,0x5
    80005602:	bd27a123          	sw	s2,-1086(a5) # 8000a1c0 <panicking>
  printf("panic: ");
    80005606:	00002517          	auipc	a0,0x2
    8000560a:	0ba50513          	addi	a0,a0,186 # 800076c0 <etext+0x6c0>
    8000560e:	cfbff0ef          	jal	80005308 <printf>
  printf("%s\n", s);
    80005612:	85a6                	mv	a1,s1
    80005614:	00002517          	auipc	a0,0x2
    80005618:	0b450513          	addi	a0,a0,180 # 800076c8 <etext+0x6c8>
    8000561c:	cedff0ef          	jal	80005308 <printf>
  panicked = 1; // freeze uart output from other CPUs
    80005620:	00005797          	auipc	a5,0x5
    80005624:	b927ae23          	sw	s2,-1124(a5) # 8000a1bc <panicked>
  for(;;)
    80005628:	a001                	j	80005628 <panic+0x3a>

000000008000562a <printfinit>:
    ;
}
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    80005632:	00002597          	auipc	a1,0x2
    80005636:	09e58593          	addi	a1,a1,158 # 800076d0 <etext+0x6d0>
    8000563a:	0001e517          	auipc	a0,0x1e
    8000563e:	e6e50513          	addi	a0,a0,-402 # 800234a8 <pr>
    80005642:	1e8000ef          	jal	8000582a <initlock>
}
...
uartinit(void)
{
    ...
    80005650:	e406                	sd	ra,8(sp)
    80005652:	e022                	sd	s0,0(sp)
    80005654:	0800                	addi	s0,sp,16
  // disable interrupts.
  WriteReg(IER, 0x00);
    80005656:	100007b7          	lui	a5,0x10000
    8000565a:	000780a3          	sb	zero,1(a5) # 10000001 <_entry-0x6fffffff>

  // special mode to set baud rate.
  WriteReg(LCR, LCR_BAUD_LATCH);
    8000565e:	10000737          	lui	a4,0x10000
    80005662:	f8000693          	li	a3,-128
    80005666:	00d701a3          	sb	a3,3(a4) # 10000003 <_entry-0x6ffffffd>

  // LSB for baud rate of 38.4K.
  WriteReg(0, 0x03);
    8000566a:	468d                	li	a3,3
    8000566c:	10000637          	lui	a2,0x10000
    80005670:	00d60023          	sb	a3,0(a2) # 10000000 <_entry-0x70000000>

  // MSB for baud rate of 38.4K.
  WriteReg(1, 0x00);
    80005674:	000780a3          	sb	zero,1(a5)

  // leave set-baud mode,
  // and set word length to 8 bits, no parity.
  WriteReg(LCR, LCR_EIGHT_BITS);
    80005678:	00d701a3          	sb	a3,3(a4)

  // reset and enable FIFOs.
  WriteReg(FCR, FCR_FIFO_ENABLE | FCR_FIFO_CLEAR);
    8000567c:	10000737          	lui	a4,0x10000
    80005680:	461d                	li	a2,7
    80005682:	00c70123          	sb	a2,2(a4) # 10000002 <_entry-0x6ffffffe>

  // enable transmit and receive interrupts.
  WriteReg(IER, IER_TX_ENABLE | IER_RX_ENABLE);
    80005686:	00d780a3          	sb	a3,1(a5)

  initlock(&tx_lock, "uart");
    8000568a:	00002597          	auipc	a1,0x2
    8000568e:	04e58593          	addi	a1,a1,78 # 800076d8 <etext+0x6d8>
    80005692:	0001e517          	auipc	a0,0x1e
    80005696:	e2e50513          	addi	a0,a0,-466 # 800234c0 <tx_lock>
    8000569a:	190000ef          	jal	8000582a <initlock>
}
...
uartwrite(char buf[], int n)
{
    ...
    800056ae:	ec56                	sd	s5,24(sp)
    800056b0:	0880                	addi	s0,sp,80
    800056b2:	8aaa                	mv	s5,a0
    800056b4:	84ae                	mv	s1,a1
  acquire(&tx_lock);
    800056b6:	0001e517          	auipc	a0,0x1e
    800056ba:	e0a50513          	addi	a0,a0,-502 # 800234c0 <tx_lock>
    800056be:	1ec000ef          	jal	800058aa <acquire>

  int i = 0;
  while(i < n){ 
    800056c2:	06905063          	blez	s1,80005722 <uartwrite+0x7c>
    800056c6:	f84a                	sd	s2,48(sp)
    800056c8:	f44e                	sd	s3,40(sp)
    800056ca:	f052                	sd	s4,32(sp)
    800056cc:	e85a                	sd	s6,16(sp)
    800056ce:	e45e                	sd	s7,8(sp)
    800056d0:	8a56                	mv	s4,s5
    800056d2:	9aa6                	add	s5,s5,s1
    while(tx_busy != 0){
    800056d4:	00005497          	auipc	s1,0x5
    800056d8:	af448493          	addi	s1,s1,-1292 # 8000a1c8 <tx_busy>
      // wait for a UART transmit-complete interrupt
      // to set tx_busy to 0.
      sleep(&tx_chan, &tx_lock);
    800056dc:	0001e997          	auipc	s3,0x1e
    800056e0:	de498993          	addi	s3,s3,-540 # 800234c0 <tx_lock>
    800056e4:	00005917          	auipc	s2,0x5
    800056e8:	ae090913          	addi	s2,s2,-1312 # 8000a1c4 <tx_chan>
    }   
      
    WriteReg(THR, buf[i]);
    800056ec:	10000bb7          	lui	s7,0x10000
    i += 1;
    tx_busy = 1;
    800056f0:	4b05                	li	s6,1
    800056f2:	a005                	j	80005712 <uartwrite+0x6c>
      sleep(&tx_chan, &tx_lock);
    800056f4:	85ce                	mv	a1,s3
    800056f6:	854a                	mv	a0,s2
    800056f8:	c7bfb0ef          	jal	80001372 <sleep>
    while(tx_busy != 0){
    800056fc:	409c                	lw	a5,0(s1)
    800056fe:	fbfd                	bnez	a5,800056f4 <uartwrite+0x4e>
    WriteReg(THR, buf[i]);
    80005700:	000a4783          	lbu	a5,0(s4)
    80005704:	00fb8023          	sb	a5,0(s7) # 10000000 <_entry-0x70000000>
    tx_busy = 1;
    80005708:	0164a023          	sw	s6,0(s1)
  while(i < n){ 
    8000570c:	0a05                	addi	s4,s4,1
    8000570e:	015a0563          	beq	s4,s5,80005718 <uartwrite+0x72>
    while(tx_busy != 0){
    80005712:	409c                	lw	a5,0(s1)
    80005714:	f3e5                	bnez	a5,800056f4 <uartwrite+0x4e>
    80005716:	b7ed                	j	80005700 <uartwrite+0x5a>
    80005718:	7942                	ld	s2,48(sp)
    8000571a:	79a2                	ld	s3,40(sp)
    8000571c:	7a02                	ld	s4,32(sp)
    8000571e:	6b42                	ld	s6,16(sp)
    80005720:	6ba2                	ld	s7,8(sp)
  }

  release(&tx_lock);
    80005722:	0001e517          	auipc	a0,0x1e
    80005726:	d9e50513          	addi	a0,a0,-610 # 800234c0 <tx_lock>
    8000572a:	218000ef          	jal	80005942 <release>
}
...
000000008000573a <uartputc_sync>:
...
uartputc_sync(int c)
{
  ...
  if(panicking == 0)
    ...
    8000574a:	a7a7a783          	lw	a5,-1414(a5) # 8000a1c0 <panicking>
    8000574e:	cf95                	beqz	a5,8000578a <uartputc_sync+0x50>
    push_off();

  if(panicked){
    80005750:	00005797          	auipc	a5,0x5
    80005754:	a6c7a783          	lw	a5,-1428(a5) # 8000a1bc <panicked>
    80005758:	ef85                	bnez	a5,80005790 <uartputc_sync+0x56>
    for(;;)
      ;
  }
  ...
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    ...
    8000575e:	0715                	addi	a4,a4,5 # 10000005 <_entry-0x6ffffffb>
    80005760:	00074783          	lbu	a5,0(a4)
    80005764:	0207f793          	andi	a5,a5,32
    80005768:	dfe5                	beqz	a5,80005760 <uartputc_sync+0x26>
    ;
  WriteReg(THR, c);
    8000576a:	0ff4f513          	zext.b	a0,s1
    8000576e:	100007b7          	lui	a5,0x10000
    80005772:	00a78023          	sb	a0,0(a5) # 10000000 <_entry-0x70000000>

  if(panicking == 0)
    80005776:	00005797          	auipc	a5,0x5
    8000577a:	a4a7a783          	lw	a5,-1462(a5) # 8000a1c0 <panicking>
    8000577e:	cb91                	beqz	a5,80005792 <uartputc_sync+0x58>
    pop_off();
}
    ...
    80005788:	8082                	ret
    push_off();
    8000578a:	0e0000ef          	jal	8000586a <push_off>
    8000578e:	b7c9                	j	80005750 <uartputc_sync+0x16>
    for(;;)
    80005790:	a001                	j	80005790 <uartputc_sync+0x56>
    pop_off();
    80005792:	15c000ef          	jal	800058ee <pop_off>
}
    80005796:	b7ed                	j	80005780 <uartputc_sync+0x46>

0000000080005798 <uartgetc>:
...
uartgetc(void)
{
  ...
  if(ReadReg(LSR) & LSR_RX_READY){
    ...
    800057a8:	8b85                	andi	a5,a5,1
    800057aa:	cb81                	beqz	a5,800057ba <uartgetc+0x22>
    // input data is ready.
    return ReadReg(RHR);
    800057ac:	100007b7          	lui	a5,0x10000
    800057b0:	0007c503          	lbu	a0,0(a5) # 10000000 <_entry-0x70000000>
  } else {
    return -1;
  }
}
    800057b4:	6422                	ld	s0,8(sp)
    800057b6:	0141                	addi	sp,sp,16
    800057b8:	8082                	ret
    return -1;
    800057ba:	557d                	li	a0,-1
    800057bc:	bfe5                	j	800057b4 <uartgetc+0x1c>

00000000800057be <uartintr>:
...
uartintr(void)
{
  ...
  ReadReg(ISR); // acknowledge the interrupt
    800057c8:	100007b7          	lui	a5,0x10000
    800057cc:	0789                	addi	a5,a5,2 # 10000002 <_entry-0x6ffffffe>
    800057ce:	0007c783          	lbu	a5,0(a5)

  acquire(&tx_lock);
    800057d2:	0001e517          	auipc	a0,0x1e
    800057d6:	cee50513          	addi	a0,a0,-786 # 800234c0 <tx_lock>
    800057da:	0d0000ef          	jal	800058aa <acquire>
  if(ReadReg(LSR) & LSR_TX_IDLE){
    800057de:	100007b7          	lui	a5,0x10000
    800057e2:	0795                	addi	a5,a5,5 # 10000005 <_entry-0x6ffffffb>
    800057e4:	0007c783          	lbu	a5,0(a5)
    800057e8:	0207f793          	andi	a5,a5,32
    800057ec:	eb89                	bnez	a5,800057fe <uartintr+0x40>
    // UART finished transmitting; wake up sending thread.
    tx_busy = 0;
    wakeup(&tx_chan);
  }
  release(&tx_lock);
    800057ee:	0001e517          	auipc	a0,0x1e
    800057f2:	cd250513          	addi	a0,a0,-814 # 800234c0 <tx_lock>
    800057f6:	14c000ef          	jal	80005942 <release>
  ...
  while(1){
    ...
    800057fc:	a831                	j	80005818 <uartintr+0x5a>
    tx_busy = 0;
    800057fe:	00005797          	auipc	a5,0x5
    80005802:	9c07a523          	sw	zero,-1590(a5) # 8000a1c8 <tx_busy>
    wakeup(&tx_chan);
    80005806:	00005517          	auipc	a0,0x5
    8000580a:	9be50513          	addi	a0,a0,-1602 # 8000a1c4 <tx_chan>
    8000580e:	bb1fb0ef          	jal	800013be <wakeup>
    80005812:	bff1                	j	800057ee <uartintr+0x30>
      break;
    consoleintr(c);
    80005814:	8a5ff0ef          	jal	800050b8 <consoleintr>
    int c = uartgetc();
    80005818:	f81ff0ef          	jal	80005798 <uartgetc>
    if(c == -1)
    8000581c:	fe951ce3          	bne	a0,s1,80005814 <uartintr+0x56>
  }
}
...
initlock(struct spinlock *lk, char *name)
{
  ...
  lk->name = name;
    80005830:	e50c                	sd	a1,8(a0)
  lk->locked = 0;
    80005832:	00052023          	sw	zero,0(a0)
  lk->cpu = 0;
    80005836:	00053823          	sd	zero,16(a0)
}
    8000583a:	6422                	ld	s0,8(sp)
    8000583c:	0141                	addi	sp,sp,16
    8000583e:	8082                	ret

0000000080005840 <holding>:
...
holding(struct spinlock *lk)
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    80005840:	411c                	lw	a5,0(a0)
    80005842:	e399                	bnez	a5,80005848 <holding+0x8>
    ...
    80005846:	8082                	ret
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    80005852:	6904                	ld	s1,16(a0)
    80005854:	d0afb0ef          	jal	80000d5e <mycpu>
    80005858:	40a48533          	sub	a0,s1,a0
    8000585c:	00153513          	seqz	a0,a0
}
...
push_off(void)
{
  ...
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80005874:	100024f3          	csrr	s1,sstatus
    80005878:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() & ~SSTATUS_SIE);
    8000587c:	9bf5                	andi	a5,a5,-3
  asm volatile("csrw sstatus, %0" : : "r" (x));
    8000587e:	10079073          	csrw	sstatus,a5
  ...
  if(mycpu()->noff == 0)
    80005882:	cdcfb0ef          	jal	80000d5e <mycpu>
    80005886:	5d3c                	lw	a5,120(a0)
    80005888:	cb99                	beqz	a5,8000589e <push_off+0x34>
    mycpu()->intena = old;
  mycpu()->noff += 1;
    8000588a:	cd4fb0ef          	jal	80000d5e <mycpu>
    8000588e:	5d3c                	lw	a5,120(a0)
    80005890:	2785                	addiw	a5,a5,1
    80005892:	dd3c                	sw	a5,120(a0)
}
    ...
    8000589c:	8082                	ret
    mycpu()->intena = old;
    8000589e:	cc0fb0ef          	jal	80000d5e <mycpu>
  return (x & SSTATUS_SIE) != 0;
    800058a2:	8085                	srli	s1,s1,0x1
    800058a4:	8885                	andi	s1,s1,1
    800058a6:	dd64                	sw	s1,124(a0)
    800058a8:	b7cd                	j	8000588a <push_off+0x20>

00000000800058aa <acquire>:
{
  ...
  push_off(); // disable interrupts to avoid deadlock.
    800058b6:	fb5ff0ef          	jal	8000586a <push_off>
  if(holding(lk))
    800058ba:	8526                	mv	a0,s1
    800058bc:	f85ff0ef          	jal	80005840 <holding>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0)
    800058c0:	4705                	li	a4,1
  if(holding(lk))
    800058c2:	e105                	bnez	a0,800058e2 <acquire+0x38>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0)
    800058c4:	87ba                	mv	a5,a4
    800058c6:	0cf4a7af          	amoswap.w.aq	a5,a5,(s1)
    800058ca:	2781                	sext.w	a5,a5
    800058cc:	ffe5                	bnez	a5,800058c4 <acquire+0x1a>
  __sync_synchronize();
    800058ce:	0330000f          	fence	rw,rw
  lk->cpu = mycpu();
    800058d2:	c8cfb0ef          	jal	80000d5e <mycpu>
    800058d6:	e888                	sd	a0,16(s1)
}
    ...
    800058e0:	8082                	ret
    panic("acquire");
    800058e2:	00002517          	auipc	a0,0x2
    800058e6:	dfe50513          	addi	a0,a0,-514 # 800076e0 <etext+0x6e0>
    800058ea:	d05ff0ef          	jal	800055ee <panic>

00000000800058ee <pop_off>:
...
pop_off(void)
{
  ...
  struct cpu *c = mycpu();
    800058f6:	c68fb0ef          	jal	80000d5e <mycpu>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    800058fa:	100027f3          	csrr	a5,sstatus
  return (x & SSTATUS_SIE) != 0;
    800058fe:	8b89                	andi	a5,a5,2
  if(intr_get())
    80005900:	e78d                	bnez	a5,8000592a <pop_off+0x3c>
    panic("pop_off - interruptible");
  if(c->noff < 1)
    80005902:	5d3c                	lw	a5,120(a0)
    80005904:	02f05963          	blez	a5,80005936 <pop_off+0x48>
    panic("pop_off");
  c->noff -= 1;
    80005908:	37fd                	addiw	a5,a5,-1
    8000590a:	0007871b          	sext.w	a4,a5
    8000590e:	dd3c                	sw	a5,120(a0)
  if(c->noff == 0 && c->intena)
    80005910:	eb09                	bnez	a4,80005922 <pop_off+0x34>
    80005912:	5d7c                	lw	a5,124(a0)
    80005914:	c799                	beqz	a5,80005922 <pop_off+0x34>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80005916:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() | SSTATUS_SIE);
    8000591a:	0027e793          	ori	a5,a5,2
  asm volatile("csrw sstatus, %0" : : "r" (x));
    8000591e:	10079073          	csrw	sstatus,a5
    intr_on();
}
    ...
    80005928:	8082                	ret
    panic("pop_off - interruptible");
    8000592a:	00002517          	auipc	a0,0x2
    8000592e:	dbe50513          	addi	a0,a0,-578 # 800076e8 <etext+0x6e8>
    80005932:	cbdff0ef          	jal	800055ee <panic>
    panic("pop_off");
    80005936:	00002517          	auipc	a0,0x2
    8000593a:	dca50513          	addi	a0,a0,-566 # 80007700 <etext+0x700>
    8000593e:	cb1ff0ef          	jal	800055ee <panic>

0000000080005942 <release>:
{
  ...
  if(!holding(lk))
    8000594e:	ef3ff0ef          	jal	80005840 <holding>
    80005952:	c105                	beqz	a0,80005972 <release+0x30>
  lk->cpu = 0;
    80005954:	0004b823          	sd	zero,16(s1)
  __sync_synchronize();
    80005958:	0330000f          	fence	rw,rw
  __sync_lock_release(&lk->locked);
    8000595c:	0310000f          	fence	rw,w
    80005960:	0004a023          	sw	zero,0(s1)
  pop_off();
    80005964:	f8bff0ef          	jal	800058ee <pop_off>
}
    ...
    80005976:	d9650513          	addi	a0,a0,-618 # 80007708 <etext+0x708>
    8000597a:	c75ff0ef          	jal	800055ee <panic>
	...
