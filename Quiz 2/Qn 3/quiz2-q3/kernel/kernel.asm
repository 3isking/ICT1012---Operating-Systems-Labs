...
kfree(void *pa)
{
  ...
  if(((uint64)pa % PGSIZE) != 0 || (char*)pa < end || (uint64)pa >= PHYSTOP)
    ...
    80000034:	65078793          	addi	a5,a5,1616 # 80024680 <end>
  ...
  acquire(&kmem.lock);
    ...
    80000054:	1c090913          	addi	s2,s2,448 # 8000b210 <kmem>
...
00000000800000de <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    800000f2:	12250513          	addi	a0,a0,290 # 8000b210 <kmem>
  ...
  freerange(end, (void*)PHYSTOP);
    ...
    80000106:	57e50513          	addi	a0,a0,1406 # 80024680 <end>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80000128:	0ec48493          	addi	s1,s1,236 # 8000b210 <kmem>
  ...
  if(r)
    ...
    80000140:	0d450513          	addi	a0,a0,212 # 8000b210 <kmem>
  ...
  release(&kmem.lock);
    ...
    8000016c:	0a850513          	addi	a0,a0,168 # 8000b210 <kmem>
    ...
    800001e6:	00c587b3          	add	a5,a1,a2
{
    ...
    800001ee:	0705                	addi	a4,a4,1 # fffffffffffff001 <end+0xffffffff7ffda981>
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    8000032c:	eb870713          	addi	a4,a4,-328 # 8000b1e0 <started>
  if(cpuid() == 0){
  ...
  scheduler();        
    ...
    80000428:	daf72e23          	sw	a5,-580(a4) # 8000b1e0 <started>
...
sfence_vma()
{
  ...
  w_satp(MAKE_SATP(kernel_pagetable));
    ...
    8000043c:	db07b783          	ld	a5,-592(a5) # 8000b1e8 <kernel_pagetable>
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  for(int level = 2; level > 0; level--) {
    800004b6:	3a5d                	addiw	s4,s4,-9 # ffffffffffffeff7 <end+0xffffffff7ffda977>
...
0000000080000708 <kvminit>:
{
  ...
  kernel_pagetable = kvmmake();
    ...
    8000071c:	aca7b823          	sd	a0,-1328(a5) # 8000b1e8 <kernel_pagetable>
}
...
proc_mapstacks(pagetable_t kpgtbl)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000d8e:	8d648493          	addi	s1,s1,-1834 # 8000b660 <proc>
    char *pa = kalloc();
    if(pa == 0)
      panic("kalloc");
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000dba:	2aaa8a93          	addi	s5,s5,682 # 80011060 <tickslock>
    char *pa = kalloc();
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    80000e38:	3fc50513          	addi	a0,a0,1020 # 8000b230 <pid_lock>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000e94:	1d0a0a13          	addi	s4,s4,464 # 80011060 <tickslock>
      initlock(&p->lock, "proc");
...
mycpu(void)
{
  ...
  return c;
    ...
    80000efa:	36a50513          	addi	a0,a0,874 # 8000b260 <cpus>
...
myproc(void)
{
  ...
  struct proc *p = c->proc;
    ...
    80000f22:	31270713          	addi	a4,a4,786 # 8000b230 <pid_lock>
...
forkret(void)
{
  ...
  if (first) {
    ...
    80000f5a:	21a7a783          	lw	a5,538(a5) # 8000b170 <first.1>
  ...
  usertrapret();
    ...
    80000f7e:	1e07ab23          	sw	zero,502(a5) # 8000b170 <first.1>
    __sync_synchronize();
...
0000000080000f88 <allocpid>:
{
  ...
  acquire(&pid_lock);
    ...
    80000f98:	29c90913          	addi	s2,s2,668 # 8000b230 <pid_lock>
  ...
  pid = nextpid;
    ...
    80000faa:	1ce78793          	addi	a5,a5,462 # 8000b174 <nextpid>
...
0000000080001114 <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001124:	54048493          	addi	s1,s1,1344 # 8000b660 <proc>
    80001128:	00010917          	auipc	s2,0x10
    8000112c:	f3890913          	addi	s2,s2,-200 # 80011060 <tickslock>
    acquire(&p->lock);
...
00000000800011e2 <userinit>:
{
  ...
  initproc = p;
    ...
    800011fa:	fea7bd23          	sd	a0,-6(a5) # 8000b1f0 <initproc>
  uvmfirst(p->pagetable, initcode, sizeof(initcode));
    800011fe:	03400613          	li	a2,52
    80001202:	0000a597          	auipc	a1,0xa
    80001206:	f7e58593          	addi	a1,a1,-130 # 8000b180 <initcode>
...
00000000800012c0 <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  acquire(&wait_lock);
    ...
    800013b4:	e9848493          	addi	s1,s1,-360 # 8000b248 <wait_lock>
...
0000000080001402 <scheduler>:
{
  ...
  c->proc = 0;
    ...
    80001422:	e1270713          	addi	a4,a4,-494 # 8000b230 <pid_lock>
    80001426:	9756                	add	a4,a4,s5
    80001428:	02073823          	sd	zero,48(a4)
        swtch(&c->context, &p->context);
    8000142c:	0000a717          	auipc	a4,0xa
    80001430:	e3c70713          	addi	a4,a4,-452 # 8000b268 <cpus+0x8>
    ...
    80001440:	df4a0a13          	addi	s4,s4,-524 # 8000b230 <pid_lock>
    80001444:	9a3e                	add	s4,s4,a5
    for(p = proc; p < &proc[NPROC]; p++) {
    80001446:	00010917          	auipc	s2,0x10
    8000144a:	c1a90913          	addi	s2,s2,-998 # 80011060 <tickslock>
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    8000145e:	20648493          	addi	s1,s1,518 # 8000b660 <proc>
...
00000000800014a2 <sched>:
{
  ...
  if(mycpu()->noff != 1)
    ...
    800014ce:	d6670713          	addi	a4,a4,-666 # 8000b230 <pid_lock>
  ...
  intena = mycpu()->intena;
    ...
    800014f4:	d4090913          	addi	s2,s2,-704 # 8000b230 <pid_lock>
  ...
  swtch(&p->context, &mycpu()->context);
    ...
    8000150c:	d6058593          	addi	a1,a1,-672 # 8000b268 <cpus+0x8>
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001630:	03448493          	addi	s1,s1,52 # 8000b660 <proc>
    if(p != myproc()){
      acquire(&p->lock);
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000163c:	a2890913          	addi	s2,s2,-1496 # 80011060 <tickslock>
...
000000008000168e <reparent>:
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    ...
    800016a4:	fc048493          	addi	s1,s1,-64 # 8000b660 <proc>
      pp->parent = initproc;
    800016a8:	0000aa17          	auipc	s4,0xa
    800016ac:	b48a0a13          	addi	s4,s4,-1208 # 8000b1f0 <initproc>
  for(pp = proc; pp < &proc[NPROC]; pp++){
    800016b0:	00010997          	auipc	s3,0x10
    800016b4:	9b098993          	addi	s3,s3,-1616 # 80011060 <tickslock>
...
00000000800016e8 <exit>:
{
  ...
  if(p == initproc)
    ...
    80001708:	aec7b783          	ld	a5,-1300(a5) # 8000b1f0 <initproc>
  ...
  acquire(&wait_lock);
    ...
    80001764:	ae848493          	addi	s1,s1,-1304 # 8000b248 <wait_lock>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800017d2:	e9248493          	addi	s1,s1,-366 # 8000b660 <proc>
    800017d6:	00010997          	auipc	s3,0x10
    800017da:	88a98993          	addi	s3,s3,-1910 # 80011060 <tickslock>
    acquire(&p->lock);
...
000000008000188e <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    800018b6:	99650513          	addi	a0,a0,-1642 # 8000b248 <wait_lock>
    ...
    800018cc:	79898993          	addi	s3,s3,1944 # 80011060 <tickslock>
    sleep(p, &wait_lock);  //DOC: wait-sleep
    800018d0:	0000ac17          	auipc	s8,0xa
    800018d4:	978c0c13          	addi	s8,s8,-1672 # 8000b248 <wait_lock>
    ...
    80001912:	93a50513          	addi	a0,a0,-1734 # 8000b248 <wait_lock>
    ...
    80001946:	90650513          	addi	a0,a0,-1786 # 8000b248 <wait_lock>
    ...
    800019a2:	cc248493          	addi	s1,s1,-830 # 8000b660 <proc>
    800019a6:	bf65                	j	8000195e <wait+0xd0>
      release(&wait_lock);
    800019a8:	0000a517          	auipc	a0,0xa
    800019ac:	8a050513          	addi	a0,a0,-1888 # 8000b248 <wait_lock>
...
procdump(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80001a92:	d2a48493          	addi	s1,s1,-726 # 8000b7b8 <proc+0x158>
    80001a96:	0000f917          	auipc	s2,0xf
    80001a9a:	72290913          	addi	s2,s2,1826 # 800111b8 <bcache+0x140>
    if(p->state == UNUSED)
      continue;
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001b96:	4ce50513          	addi	a0,a0,1230 # 80011060 <tickslock>
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80001c66:	3fe48493          	addi	s1,s1,1022 # 80011060 <tickslock>
  ...
  ticks++;
    ...
    80001c78:	58450513          	addi	a0,a0,1412 # 8000b1f8 <ticks>
...
sys_sleep(void)
{
  ...
  while(ticks - ticks0 < n){
    ...
    8000221e:	e4698993          	addi	s3,s3,-442 # 80011060 <tickslock>
    80002222:	00009497          	auipc	s1,0x9
    80002226:	fd648493          	addi	s1,s1,-42 # 8000b1f8 <ticks>
    if(killed(myproc())){
  ...
  release(&tickslock);
    ...
    8000225e:	e0650513          	addi	a0,a0,-506 # 80011060 <tickslock>
  ...
  return 0;
    ...
    80002280:	de450513          	addi	a0,a0,-540 # 80011060 <tickslock>
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    800022cc:	d9850513          	addi	a0,a0,-616 # 80011060 <tickslock>
    800022d0:	00004097          	auipc	ra,0x4
    800022d4:	03c080e7          	jalr	60(ra) # 8000630c <acquire>
  xticks = ticks;
    800022d8:	00009497          	auipc	s1,0x9
    800022dc:	f204a483          	lw	s1,-224(s1) # 8000b1f8 <ticks>
  release(&tickslock);
    800022e0:	0000f517          	auipc	a0,0xf
    800022e4:	d8050513          	addi	a0,a0,-640 # 80011060 <tickslock>
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    8000231c:	d6050513          	addi	a0,a0,-672 # 80011078 <bcache>
  ...
  bcache.head.prev = &bcache.head;
    ...
    8000232c:	d5078793          	addi	a5,a5,-688 # 80019078 <bcache+0x8000>
    80002330:	00017717          	auipc	a4,0x17
    80002334:	fb070713          	addi	a4,a4,-80 # 800192e0 <bcache+0x8268>
    80002338:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    8000233c:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002340:	0000f497          	auipc	s1,0xf
    80002344:	d5048493          	addi	s1,s1,-688 # 80011090 <bcache+0x18>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    800023a4:	cd850513          	addi	a0,a0,-808 # 80011078 <bcache>
    800023a8:	00004097          	auipc	ra,0x4
    800023ac:	f64080e7          	jalr	-156(ra) # 8000630c <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    800023b0:	00017497          	auipc	s1,0x17
    800023b4:	f804b483          	ld	s1,-128(s1) # 80019330 <bcache+0x82b8>
    800023b8:	00017797          	auipc	a5,0x17
    800023bc:	f2878793          	addi	a5,a5,-216 # 800192e0 <bcache+0x8268>
    ...
    800023e4:	c9850513          	addi	a0,a0,-872 # 80011078 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    80002402:	f2a4b483          	ld	s1,-214(s1) # 80019328 <bcache+0x82b0>
    80002406:	00017797          	auipc	a5,0x17
    8000240a:	eda78793          	addi	a5,a5,-294 # 800192e0 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    80002442:	c3a50513          	addi	a0,a0,-966 # 80011078 <bcache>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    800024ea:	b9250513          	addi	a0,a0,-1134 # 80011078 <bcache>
  ...
  if (b->refcnt == 0) {
    ...
    80002510:	b6c78793          	addi	a5,a5,-1172 # 80019078 <bcache+0x8000>
    80002514:	2b87b703          	ld	a4,696(a5)
    80002518:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    8000251a:	00017717          	auipc	a4,0x17
    8000251e:	dc670713          	addi	a4,a4,-570 # 800192e0 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    80002532:	b4a50513          	addi	a0,a0,-1206 # 80011078 <bcache>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000256a:	b1250513          	addi	a0,a0,-1262 # 80011078 <bcache>
  ...
  release(&bcache.lock);
    ...
    80002580:	afc50513          	addi	a0,a0,-1284 # 80011078 <bcache>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800025a6:	ad650513          	addi	a0,a0,-1322 # 80011078 <bcache>
  ...
  release(&bcache.lock);
    ...
    800025bc:	ac050513          	addi	a0,a0,-1344 # 80011078 <bcache>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    800025e8:	1707a783          	lw	a5,368(a5) # 80019754 <sb+0x1c>
...
000000008000264e <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    8000265c:	0e47a783          	lw	a5,228(a5) # 8001973c <sb+0x4>
    ...
    8000267c:	0c0b0b13          	addi	s6,s6,192 # 80019738 <sb>
...
bmap(struct inode *ip, uint bn)
{
  ...
  if(bn < NINDIRECT){
    ...
    if((addr = a[bn]) == 0){
    8000281c:	02049713          	slli	a4,s1,0x20
    80002820:	01e75593          	srli	a1,a4,0x1e
  ...
  panic("bmap: out of range");
    ...
    80002876:	bbe50513          	addi	a0,a0,-1090 # 80008430 <etext+0x430>
...
0000000080002882 <iget>:
{
  ...
  acquire(&itable.lock);
    80002896:	00017517          	auipc	a0,0x17
    8000289a:	ec250513          	addi	a0,a0,-318 # 80019758 <itable>
    8000289e:	00004097          	auipc	ra,0x4
    800028a2:	a6e080e7          	jalr	-1426(ra) # 8000630c <acquire>
  empty = 0;
    800028a6:	4901                	li	s2,0
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    800028a8:	00017497          	auipc	s1,0x17
    800028ac:	ec848493          	addi	s1,s1,-312 # 80019770 <itable+0x18>
    800028b0:	00019697          	auipc	a3,0x19
    800028b4:	95068693          	addi	a3,a3,-1712 # 8001b200 <log>
    800028b8:	a039                	j	800028c6 <iget+0x44>
    if(empty == 0 && ip->ref == 0)    // Remember empty slot.
    800028ba:	02090b63          	beqz	s2,800028f0 <iget+0x6e>
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    800028be:	08848493          	addi	s1,s1,136
    ...
    800028da:	c49c                	sw	a5,8(s1)
      release(&itable.lock);
    800028dc:	00017517          	auipc	a0,0x17
    800028e0:	e7c50513          	addi	a0,a0,-388 # 80019758 <itable>
  ...
  release(&itable.lock);
    8000290c:	00017517          	auipc	a0,0x17
    80002910:	e4c50513          	addi	a0,a0,-436 # 80019758 <itable>
    ...
    80002932:	b1a50513          	addi	a0,a0,-1254 # 80008448 <etext+0x448>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    8000295a:	00017997          	auipc	s3,0x17
    8000295e:	dde98993          	addi	s3,s3,-546 # 80019738 <sb>
    80002962:	02000613          	li	a2,32
    80002966:	05850593          	addi	a1,a0,88
  ...
  if(sb.magic != FSMAGIC)
    ...
    80002986:	04078793          	addi	a5,a5,64 # 10203040 <_entry-0x6fdfcfc0>
    8000298a:	02f71263          	bne	a4,a5,800029ae <fsinit+0x70>
  initlog(dev, &sb);
    8000298e:	00017597          	auipc	a1,0x17
    80002992:	daa58593          	addi	a1,a1,-598 # 80019738 <sb>
    ...
    800029b2:	aaa50513          	addi	a0,a0,-1366 # 80008458 <etext+0x458>
...
00000000800029be <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    800029d0:	aa458593          	addi	a1,a1,-1372 # 80008470 <etext+0x470>
    800029d4:	00017517          	auipc	a0,0x17
    800029d8:	d8450513          	addi	a0,a0,-636 # 80019758 <itable>
    800029dc:	00004097          	auipc	ra,0x4
    800029e0:	8a0080e7          	jalr	-1888(ra) # 8000627c <initlock>
  for(i = 0; i < NINODE; i++) {
    800029e4:	00017497          	auipc	s1,0x17
    800029e8:	d9c48493          	addi	s1,s1,-612 # 80019780 <itable+0x28>
    800029ec:	00019997          	auipc	s3,0x19
    800029f0:	82498993          	addi	s3,s3,-2012 # 8001b210 <log+0x10>
    initsleeplock(&itable.inode[i].lock, "inode");
    800029f4:	00006917          	auipc	s2,0x6
    800029f8:	a8490913          	addi	s2,s2,-1404 # 80008478 <etext+0x478>
  ...
  for(i = 0; i < NINODE; i++) {
    80002a08:	08848493          	addi	s1,s1,136
...
0000000080002a1e <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    80002a26:	00017717          	auipc	a4,0x17
    80002a2a:	d1e72703          	lw	a4,-738(a4) # 80019744 <sb+0xc>
    ...
    80002a46:	00017a17          	auipc	s4,0x17
    80002a4a:	cf2a0a13          	addi	s4,s4,-782 # 80019738 <sb>
    80002a4e:	00495593          	srli	a1,s2,0x4
    ...
    80002a68:	00f97793          	andi	a5,s2,15
  ...
  printf("ialloc: no inodes\n");
    ...
    80002a9c:	9e850513          	addi	a0,a0,-1560 # 80008480 <etext+0x480>
...
0000000080002af6 <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80002b0a:	00017597          	auipc	a1,0x17
    80002b0e:	c465a583          	lw	a1,-954(a1) # 80019750 <sb+0x18>
...
0000000080002b84 <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    80002b94:	bc850513          	addi	a0,a0,-1080 # 80019758 <itable>
  ...
  release(&itable.lock);
    80002ba6:	00017517          	auipc	a0,0x17
    80002baa:	bb250513          	addi	a0,a0,-1102 # 80019758 <itable>
...
0000000080002bc2 <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80002bf4:	8a850513          	addi	a0,a0,-1880 # 80008498 <etext+0x498>
    ...
    80002c08:	00017597          	auipc	a1,0x17
    80002c0c:	b485a583          	lw	a1,-1208(a1) # 80019750 <sb+0x18>
    ...
    80002c7c:	82850513          	addi	a0,a0,-2008 # 800084a0 <etext+0x4a0>
...
0000000080002c88 <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80002cc8:	7ec50513          	addi	a0,a0,2028 # 800084b0 <etext+0x4b0>
...
0000000080002d80 <iput>:
{
  ...
  acquire(&itable.lock);
    80002d8c:	00017517          	auipc	a0,0x17
    80002d90:	9cc50513          	addi	a0,a0,-1588 # 80019758 <itable>
  ...
  release(&itable.lock);
    80002daa:	00017517          	auipc	a0,0x17
    80002dae:	9ae50513          	addi	a0,a0,-1618 # 80019758 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80002de2:	97a50513          	addi	a0,a0,-1670 # 80019758 <itable>
    ...
    acquire(&itable.lock);
    80002e14:	00017517          	auipc	a0,0x17
    80002e18:	94450513          	addi	a0,a0,-1724 # 80019758 <itable>
    ...
    80002e7c:	10d7e563          	bltu	a5,a3,80002f86 <readi+0x10c>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    ...
    80002ece:	05890613          	addi	a2,s2,88
  ...
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    ...
    m = min(n - tot, BSIZE - off%BSIZE);
    80002f20:	3ff4f713          	andi	a4,s1,1023
    ...
    80002f8c:	10d7ee63          	bltu	a5,a3,800030a8 <writei+0x11e>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    ...
    80002fd6:	020d1d93          	slli	s11,s10,0x20
    80002fda:	020ddd93          	srli	s11,s11,0x20
    80002fde:	05848513          	addi	a0,s1,88
  ...
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    ...
    uint addr = bmap(ip, off/BSIZE);
    80003018:	00a9559b          	srliw	a1,s2,0xa
    ...
    m = min(n - tot, BSIZE - off%BSIZE);
    8000303a:	3ff97713          	andi	a4,s2,1023
...
00000000800032de <dirlink>:
{
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80003384:	16050513          	addi	a0,a0,352 # 800084e0 <etext+0x4e0>
...
namei(char *path)
{
  ...
  return namex(path, 0, name);
    80003398:	fe040613          	addi	a2,s0,-32
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    800033d6:	00018917          	auipc	s2,0x18
    800033da:	e2a90913          	addi	s2,s2,-470 # 8001b200 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800033fa:	00018717          	auipc	a4,0x18
    800033fe:	e3670713          	addi	a4,a4,-458 # 8001b230 <log+0x30>
    80003402:	87aa                	mv	a5,a0
    80003404:	060a                	slli	a2,a2,0x2
    80003406:	962a                	add	a2,a2,a0
    hb->block[i] = log.lh.block[i];
    80003408:	4314                	lw	a3,0(a4)
    8000340a:	cff4                	sw	a3,92(a5)
  for (i = 0; i < log.lh.n; i++) {
    8000340c:	0711                	addi	a4,a4,4
...
0000000080003434 <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    80003434:	00018797          	auipc	a5,0x18
    80003438:	df87a783          	lw	a5,-520(a5) # 8001b22c <log+0x2c>
    8000343c:	0af05d63          	blez	a5,800034f6 <install_trans+0xc2>
{
    ...
    80003456:	00018a97          	auipc	s5,0x18
    8000345a:	ddaa8a93          	addi	s5,s5,-550 # 8001b230 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    8000345e:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003460:	00018997          	auipc	s3,0x18
    80003464:	da098993          	addi	s3,s3,-608 # 8001b200 <log>
...
00000000800034f8 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    8000350a:	00018497          	auipc	s1,0x18
    8000350e:	cf648493          	addi	s1,s1,-778 # 8001b200 <log>
    80003512:	00005597          	auipc	a1,0x5
    80003516:	fde58593          	addi	a1,a1,-34 # 800084f0 <etext+0x4f0>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003548:	00018717          	auipc	a4,0x18
    8000354c:	ce870713          	addi	a4,a4,-792 # 8001b230 <log+0x30>
    80003550:	060a                	slli	a2,a2,0x2
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    80003572:	00018797          	auipc	a5,0x18
    80003576:	ca07ad23          	sw	zero,-838(a5) # 8001b22c <log+0x2c>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    800035a0:	c6450513          	addi	a0,a0,-924 # 8001b200 <log>
    800035a4:	00003097          	auipc	ra,0x3
    800035a8:	d68080e7          	jalr	-664(ra) # 8000630c <acquire>
  while(1){
    if(log.committing){
    800035ac:	00018497          	auipc	s1,0x18
    800035b0:	c5448493          	addi	s1,s1,-940 # 8001b200 <log>
      sleep(&log, &log.lock);
    ...
    800035ea:	bfe9                	j	800035c4 <begin_op+0x34>
      ...
      log.outstanding += 1;
    800035ec:	00018517          	auipc	a0,0x18
    800035f0:	c1450513          	addi	a0,a0,-1004 # 8001b200 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    80003616:	00018497          	auipc	s1,0x18
    8000361a:	bea48493          	addi	s1,s1,-1046 # 8001b200 <log>
  ...
  if(log.outstanding == 0){
    ...
    do_commit = 1;
    log.committing = 1;
    8000363a:	00018497          	auipc	s1,0x18
    8000363e:	bc648493          	addi	s1,s1,-1082 # 8001b200 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    acquire(&log.lock);
    80003656:	00018497          	auipc	s1,0x18
    8000365a:	baa48493          	addi	s1,s1,-1110 # 8001b200 <log>
    ...
    8000368c:	e7050513          	addi	a0,a0,-400 # 800084f8 <etext+0x4f8>
    80003690:	00002097          	auipc	ra,0x2
    80003694:	702080e7          	jalr	1794(ra) # 80005d92 <panic>
    wakeup(&log);
    80003698:	00018497          	auipc	s1,0x18
    8000369c:	b6848493          	addi	s1,s1,-1176 # 8001b200 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    800036c6:	00018a97          	auipc	s5,0x18
    800036ca:	b6aa8a93          	addi	s5,s5,-1174 # 8001b230 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    800036ce:	00018a17          	auipc	s4,0x18
    800036d2:	b32a0a13          	addi	s4,s4,-1230 # 8001b200 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    log.lh.n = 0;
    80003750:	00018797          	auipc	a5,0x18
    80003754:	ac07ae23          	sw	zero,-1316(a5) # 8001b22c <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    80003776:	00018917          	auipc	s2,0x18
    8000377a:	a8a90913          	addi	s2,s2,-1398 # 8001b200 <log>
  ...
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    ...
    80003792:	00018797          	auipc	a5,0x18
    80003796:	a8a7a783          	lw	a5,-1398(a5) # 8001b21c <log+0x1c>
    8000379a:	37fd                	addiw	a5,a5,-1
    8000379c:	04f65e63          	bge	a2,a5,800037f8 <log_write+0x90>
    panic("too big a transaction");
  if (log.outstanding < 1)
    800037a0:	00018797          	auipc	a5,0x18
    800037a4:	a807a783          	lw	a5,-1408(a5) # 8001b220 <log+0x20>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800037b4:	00018717          	auipc	a4,0x18
    800037b8:	a7c70713          	addi	a4,a4,-1412 # 8001b230 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    800037d0:	00018797          	auipc	a5,0x18
    800037d4:	a3078793          	addi	a5,a5,-1488 # 8001b200 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    log.lh.n++;
    800037e8:	00018717          	auipc	a4,0x18
    800037ec:	a1870713          	addi	a4,a4,-1512 # 8001b200 <log>
    ...
    800037fc:	d1050513          	addi	a0,a0,-752 # 80008508 <etext+0x508>
    80003800:	00002097          	auipc	ra,0x2
    80003804:	592080e7          	jalr	1426(ra) # 80005d92 <panic>
    panic("log_write outside of trans");
    80003808:	00005517          	auipc	a0,0x5
    8000380c:	d1850513          	addi	a0,a0,-744 # 80008520 <etext+0x520>
    80003810:	00002097          	auipc	ra,0x2
    80003814:	582080e7          	jalr	1410(ra) # 80005d92 <panic>
  log.lh.block[i] = b->blockno;
    80003818:	00878693          	addi	a3,a5,8
    8000381c:	068a                	slli	a3,a3,0x2
    8000381e:	00018717          	auipc	a4,0x18
    80003822:	9e270713          	addi	a4,a4,-1566 # 8001b200 <log>
  ...
  release(&log.lock);
    80003830:	00018517          	auipc	a0,0x18
    80003834:	9d050513          	addi	a0,a0,-1584 # 8001b200 <log>
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    80003860:	ce458593          	addi	a1,a1,-796 # 80008540 <etext+0x540>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    80003982:	bd258593          	addi	a1,a1,-1070 # 80008550 <etext+0x550>
    80003986:	00018517          	auipc	a0,0x18
    8000398a:	9c250513          	addi	a0,a0,-1598 # 8001b348 <ftable>
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    800039a8:	00018517          	auipc	a0,0x18
    800039ac:	9a050513          	addi	a0,a0,-1632 # 8001b348 <ftable>
    800039b0:	00003097          	auipc	ra,0x3
    800039b4:	95c080e7          	jalr	-1700(ra) # 8000630c <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    800039b8:	00018497          	auipc	s1,0x18
    800039bc:	9a848493          	addi	s1,s1,-1624 # 8001b360 <ftable+0x18>
    800039c0:	00019717          	auipc	a4,0x19
    800039c4:	94070713          	addi	a4,a4,-1728 # 8001c300 <disk>
    if(f->ref == 0){
  ...
  release(&ftable.lock);
    ...
    800039d8:	97450513          	addi	a0,a0,-1676 # 8001b348 <ftable>
  ...
  return 0;
    ...
    800039ea:	c0dc                	sw	a5,4(s1)
      release(&ftable.lock);
    800039ec:	00018517          	auipc	a0,0x18
    800039f0:	95c50513          	addi	a0,a0,-1700 # 8001b348 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    80003a14:	00018517          	auipc	a0,0x18
    80003a18:	93450513          	addi	a0,a0,-1740 # 8001b348 <ftable>
  ...
  release(&ftable.lock);
    ...
    80003a32:	91a50513          	addi	a0,a0,-1766 # 8001b348 <ftable>
  ...
  return f;
    ...
    80003a4e:	b0e50513          	addi	a0,a0,-1266 # 80008558 <etext+0x558>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    80003a66:	00018517          	auipc	a0,0x18
    80003a6a:	8e250513          	addi	a0,a0,-1822 # 8001b348 <ftable>
  ...
  release(&ftable.lock);
    ...
    80003aac:	8a050513          	addi	a0,a0,-1888 # 8001b348 <ftable>
  ...
  if(ff.type == FD_PIPE){
    ...
    80003adc:	a8850513          	addi	a0,a0,-1400 # 80008560 <etext+0x560>
    80003ae0:	00002097          	auipc	ra,0x2
    80003ae4:	2b2080e7          	jalr	690(ra) # 80005d92 <panic>
    release(&ftable.lock);
    80003ae8:	00018517          	auipc	a0,0x18
    80003aec:	86050513          	addi	a0,a0,-1952 # 8001b348 <ftable>
...
filestat(struct file *f, uint64 addr)
{
  ...
  if(f->type == FD_INODE || f->type == FD_DEVICE){
    ...
    stati(f->ip, &st);
    80003b6c:	fb840593          	addi	a1,s0,-72
    ...
    80003b86:	fb840613          	addi	a2,s0,-72
    ...
    80003b98:	41f5551b          	sraiw	a0,a0,0x1f
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80003c34:	03079693          	slli	a3,a5,0x30
    80003c38:	92c1                	srli	a3,a3,0x30
    80003c3a:	4725                	li	a4,9
    80003c3c:	02d76a63          	bltu	a4,a3,80003c70 <fileread+0xc2>
    80003c40:	0792                	slli	a5,a5,0x4
    80003c42:	00017717          	auipc	a4,0x17
    80003c46:	66670713          	addi	a4,a4,1638 # 8001b2a8 <devsw>
    ...
    80003c60:	91450513          	addi	a0,a0,-1772 # 80008570 <etext+0x570>
    ...
    80003c84:	12078963          	beqz	a5,80003db6 <filewrite+0x136>
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003cec:	00017717          	auipc	a4,0x17
    80003cf0:	5bc70713          	addi	a4,a4,1468 # 8001b2a8 <devsw>
  ...
  return ret;
    ...
    80003daa:	7da50513          	addi	a0,a0,2010 # 80008580 <etext+0x580>
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80003e20:	77458593          	addi	a1,a1,1908 # 80008590 <etext+0x590>
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    wakeup(&pi->nwrite);
    80003efe:	21c48513          	addi	a0,s1,540
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  int i = 0;
    ...
    80003f50:	5b7d                	li	s6,-1
      wakeup(&pi->nread);
    80003f52:	21848c13          	addi	s8,s1,536
      sleep(&pi->nwrite, &pi->lock);
    80003f56:	21c48b93          	addi	s7,s1,540
  ...
  while(i < n){
    ...
    80003fc4:	faf40593          	addi	a1,s0,-81
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    ...
    80004054:	21848993          	addi	s3,s1,536
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
  ...
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    ...
    800040ca:	fbf40613          	addi	a2,s0,-65
  ...
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    800040e0:	2985                	addiw	s3,s3,1
    800040e2:	0905                	addi	s2,s2,1
    800040e4:	fd3a91e3          	bne	s5,s3,800040a6 <piperead+0x86>
    800040e8:	89d6                	mv	s3,s5
      break;
  }
  wakeup(&pi->nwrite);  //DOC: piperead-wakeup
    800040ea:	21c48513          	addi	a0,s1,540
...
exec(char *path, char **argv)
{
  ...
  if(readi(ip, 0, (uint64)&elf, 0, sizeof(elf)) != sizeof(elf))
    ...
    8000417c:	e5040613          	addi	a2,s0,-432
  ...
  if(elf.magic != ELF_MAGIC)
    ...
    8000419c:	57f78793          	addi	a5,a5,1407 # 464c457f <_entry-0x39b3ba81>
 ...
 bad:
  ...
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    ...
    8000420a:	fffc8793          	addi	a5,s9,-1 # fff <_entry-0x7ffff001>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    8000421a:	38250513          	addi	a0,a0,898 # 80008598 <etext+0x598>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    pa = walkaddr(pagetable, va + i);
    80004248:	02091593          	slli	a1,s2,0x20
    8000424c:	9181                	srli	a1,a1,0x20
  ...
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    80004272:	2d85                	addiw	s11,s11,1
    80004274:	038d0d1b          	addiw	s10,s10,56 # 1038 <_entry-0x7fffefc8>
    ...
    80004288:	e1840613          	addi	a2,s0,-488
  ...
  sz = PGROUNDUP(sz);
    ...
    8000432c:	19fd                	addi	s3,s3,-1 # fff <_entry-0x7ffff001>
  ...
  ustack[argc] = 0;
    ...
    800043e8:	f9078793          	addi	a5,a5,-112 # ffffffffffffef90 <end+0xffffffff7ffda910>
...
argfd(int n, int *pfd, struct file **pf)
{
  ...
  argint(n, &fd);
    8000451e:	fdc40593          	addi	a1,s0,-36
...
fdalloc(struct file *f)
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    80004584:	0d050793          	addi	a5,a0,208
  ...
  for(fd = 0; fd < NOFILE; fd++){
    80004590:	2505                	addiw	a0,a0,1
    80004592:	07a1                	addi	a5,a5,8
  ...
  return -1;
    ...
    800045a2:	8082                	ret
      p->ofile[fd] = f;
    800045a4:	01a50793          	addi	a5,a0,26
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    800046b6:	f0658593          	addi	a1,a1,-250 # 800085b8 <etext+0x5b8>
    ...
    800046ce:	ef658593          	addi	a1,a1,-266 # 800085c0 <etext+0x5c0>
...
0000000080004736 <sys_dup>:
{
  ...
  if(argfd(0, 0, &f) < 0)
    8000473e:	fd840613          	addi	a2,s0,-40
...
00000000800048d2 <sys_link>:
{
    ...
    800048d8:	1a00                	addi	s0,sp,304
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    800048da:	08000613          	li	a2,128
    800048de:	ed040593          	addi	a1,s0,-304
  ...
  return -1;
    ...
    80004a20:	6155                	addi	sp,sp,304
    80004a22:	8082                	ret

0000000080004a24 <sys_unlink>:
{
    80004a24:	7151                	addi	sp,sp,-240
  ...
  if((dp = nameiparent(path, name)) == 0){
    ...
    80004a50:	f3040513          	addi	a0,s0,-208
  ...
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    ...
    80004a6c:	b5058593          	addi	a1,a1,-1200 # 800085b8 <etext+0x5b8>
    80004a70:	fb040513          	addi	a0,s0,-80
    ...
    80004a84:	b4058593          	addi	a1,a1,-1216 # 800085c0 <etext+0x5c0>
    80004a88:	fb040513          	addi	a0,s0,-80
  ...
  return 0;
    ...
    80004b4e:	a7e50513          	addi	a0,a0,-1410 # 800085c8 <etext+0x5c8>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    80004b70:	f1840613          	addi	a2,s0,-232
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    80004b9e:	a4650513          	addi	a0,a0,-1466 # 800085e0 <etext+0x5e0>
    ...
    80004bb0:	a4c50513          	addi	a0,a0,-1460 # 800085f8 <etext+0x5f8>
...
sys_open(void)
{
  ...
  argint(1, &omode);
    80004c0e:	f4c40593          	addi	a1,s0,-180
  ...
  if((n = argstr(0, path, MAXPATH)) < 0)
    ...
    80004c20:	f5040593          	addi	a1,s0,-176
...
sys_chdir(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || (ip = namei(path)) == 0){
    ...
    80004eaa:	f6040593          	addi	a1,s0,-160
...
sys_exec(void)
{
    80004f36:	7121                	addi	sp,sp,-448
    80004f38:	ff06                	sd	ra,440(sp)
    80004f3a:	fb22                	sd	s0,432(sp)
    80004f3c:	0380                	addi	s0,sp,448
  char path[MAXPATH], *argv[MAXARG];
  int i;
  uint64 uargv, uarg;

  argaddr(1, &uargv);
    80004f3e:	e4840593          	addi	a1,s0,-440
  ...
  memset(argv, 0, sizeof(argv));
    ...
    80004f8c:	00391513          	slli	a0,s2,0x3
    80004f90:	e4040593          	addi	a1,s0,-448
 ...
 bad:
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80004fd6:	f5040913          	addi	s2,s0,-176
  ...
  return -1;
    ...
    80004ffe:	fd078793          	addi	a5,a5,-48
    80005002:	97a2                	add	a5,a5,s0
    80005004:	e807b023          	sd	zero,-384(a5)
  int ret = exec(path, argv);
    80005008:	e5040593          	addi	a1,s0,-432
  ...
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    8000501a:	f5040993          	addi	s3,s0,-176
...
sys_pipe(void)
{
  ...
  if(pipealloc(&rf, &wf) < 0)
    80005070:	fc840593          	addi	a1,s0,-56
    80005074:	fd040513          	addi	a0,s0,-48
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    800050b4:	fc440613          	addi	a2,s0,-60
...
free_desc(int i)
{
  ...
  if(i >= NUM)
    ...
    panic("free_desc 1");
  if(disk.free[i])
    800052c8:	00017797          	auipc	a5,0x17
    800052cc:	03878793          	addi	a5,a5,56 # 8001c300 <disk>
  ...
  disk.desc[i].addr = 0;
    ...
    800052dc:	00017797          	auipc	a5,0x17
    800052e0:	02478793          	addi	a5,a5,36 # 8001c300 <disk>
  ...
  wakeup(&disk.free[0]);
    ...
    80005308:	01450513          	addi	a0,a0,20 # 8001c318 <disk+0x18>
...
000000008000533c <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005354:	0d850513          	addi	a0,a0,216 # 8001c428 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    800053c0:	75f70713          	addi	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47fda0df>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    80005416:	00017497          	auipc	s1,0x17
    8000541a:	eea48493          	addi	s1,s1,-278 # 8001c300 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    8000543c:	00017717          	auipc	a4,0x17
    80005440:	ecc73703          	ld	a4,-308(a4) # 8001c308 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    80005458:	00017497          	auipc	s1,0x17
    8000545c:	ea848493          	addi	s1,s1,-344 # 8001c300 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80005598:	e9450513          	addi	a0,a0,-364 # 8001c428 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    800055a6:	44a1                	li	s1,8
      disk.free[i] = 0;
    800055a8:	00017b17          	auipc	s6,0x17
    800055ac:	d58b0b13          	addi	s6,s6,-680 # 8001c300 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    800055b2:	00017c17          	auipc	s8,0x17
    800055b6:	e76c0c13          	addi	s8,s8,-394 # 8001c428 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    800055d4:	00017717          	auipc	a4,0x17
    800055d8:	d2c70713          	addi	a4,a4,-724 # 8001c300 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005614:	00017517          	auipc	a0,0x17
    80005618:	d0450513          	addi	a0,a0,-764 # 8001c318 <disk+0x18>
  ...
  if(write)
    80005634:	00017797          	auipc	a5,0x17
    80005638:	ccc78793          	addi	a5,a5,-820 # 8001c300 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    8000570a:	00017917          	auipc	s2,0x17
    8000570e:	d1e90913          	addi	s2,s2,-738 # 8001c428 <disk+0x128>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    80005736:	00017797          	auipc	a5,0x17
    8000573a:	bca78793          	addi	a5,a5,-1078 # 8001c300 <disk>
    8000573e:	97ba                	add	a5,a5,a4
    80005740:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    80005744:	00017997          	auipc	s3,0x17
    80005748:	bbc98993          	addi	s3,s3,-1092 # 8001c300 <disk>
  ...
  release(&disk.vdisk_lock);
    8000576c:	00017517          	auipc	a0,0x17
    80005770:	cbc50513          	addi	a0,a0,-836 # 8001c428 <disk+0x128>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    800057a0:	00017497          	auipc	s1,0x17
    800057a4:	b6048493          	addi	s1,s1,-1184 # 8001c300 <disk>
    800057a8:	00017517          	auipc	a0,0x17
    800057ac:	c8050513          	addi	a0,a0,-896 # 8001c428 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80005828:	c0450513          	addi	a0,a0,-1020 # 8001c428 <disk+0x128>
...
timerinit()
{
  ...
  *(uint64*)CLINT_MTIMECMP(id) = *(uint64*)CLINT_MTIME + interval;
  ...
  uint64 *scratch = &timer_scratch[id][0];
    ...
    80005882:	00017717          	auipc	a4,0x17
    80005886:	bbe70713          	addi	a4,a4,-1090 # 8001c440 <timer_scratch>
...
00000000800058be <start>:
{
  ...
  x &= ~MSTATUS_MPP_MASK;
    ...
    800058cc:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffda17f>
...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  acquire(&cons.lock);
    ...
    800059c2:	bc250513          	addi	a0,a0,-1086 # 80024580 <cons>
  ...
  while(n > 0){
    ...
    while(cons.r == cons.w){
    800059ce:	0001f497          	auipc	s1,0x1f
    800059d2:	bb248493          	addi	s1,s1,-1102 # 80024580 <cons>
      if(killed(myproc())){
        release(&cons.lock);
        return -1;
      }
      sleep(&cons.r, &cons.lock);
    800059d6:	0001f917          	auipc	s2,0x1f
    800059da:	c4290913          	addi	s2,s2,-958 # 80024618 <cons+0x98>
  while(n > 0){
    ...
    80005a1a:	0001f717          	auipc	a4,0x1f
    80005a1e:	b6670713          	addi	a4,a4,-1178 # 80024580 <cons>
    ...
    80005a66:	bfa5                	j	800059de <consoleread+0x3e>
        release(&cons.lock);
    80005a68:	0001f517          	auipc	a0,0x1f
    80005a6c:	b1850513          	addi	a0,a0,-1256 # 80024580 <cons>
  ...
  return target - n;
    ...
    80005a92:	01677a63          	bgeu	a4,s6,80005aa6 <consoleread+0x106>
        cons.r--;
    80005a96:	0001f717          	auipc	a4,0x1f
    80005a9a:	b8f72123          	sw	a5,-1150(a4) # 80024618 <cons+0x98>
  ...
  release(&cons.lock);
    ...
    80005ab0:	ad450513          	addi	a0,a0,-1324 # 80024580 <cons>
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    80005b14:	0001f517          	auipc	a0,0x1f
    80005b18:	a6c50513          	addi	a0,a0,-1428 # 80024580 <cons>
  ...
  release(&cons.lock);
    80005b42:	0001f517          	auipc	a0,0x1f
    80005b46:	a3e50513          	addi	a0,a0,-1474 # 80024580 <cons>
  ...
  switch(c){
    ...
    80005b64:	0001f717          	auipc	a4,0x1f
    80005b68:	a1c70713          	addi	a4,a4,-1508 # 80024580 <cons>
    ...
    80005b8e:	0001f797          	auipc	a5,0x1f
    80005b92:	9f278793          	addi	a5,a5,-1550 # 80024580 <cons>
    ...
    80005bbc:	0001f797          	auipc	a5,0x1f
    80005bc0:	a5c7a783          	lw	a5,-1444(a5) # 80024618 <cons+0x98>
    ...
    while(cons.e != cons.w &&
    80005bd2:	0001f717          	auipc	a4,0x1f
    80005bd6:	9ae70713          	addi	a4,a4,-1618 # 80024580 <cons>
    80005bda:	0a072783          	lw	a5,160(a4)
    80005bde:	09c72703          	lw	a4,156(a4)
          cons.buf[(cons.e-1) % INPUT_BUF_SIZE] != '\n'){
    80005be2:	0001f497          	auipc	s1,0x1f
    80005be6:	99e48493          	addi	s1,s1,-1634 # 80024580 <cons>
    while(cons.e != cons.w &&
    ...
    80005c2c:	95870713          	addi	a4,a4,-1704 # 80024580 <cons>
    ...
    80005c42:	9ef72123          	sw	a5,-1566(a4) # 80024620 <cons+0xa0>
      consputc(BACKSPACE);
    ...
    80005c60:	e6a080e7          	jalr	-406(ra) # 80005ac6 <consputc>
      cons.buf[cons.e++ % INPUT_BUF_SIZE] = c;
    80005c64:	0001f797          	auipc	a5,0x1f
    80005c68:	91c78793          	addi	a5,a5,-1764 # 80024580 <cons>
    ...
    80005c84:	00e78c23          	sb	a4,24(a5)
        cons.w = cons.e;
    80005c88:	0001f797          	auipc	a5,0x1f
    80005c8c:	98c7aa23          	sw	a2,-1644(a5) # 8002461c <cons+0x9c>
        wakeup(&cons.r);
    80005c90:	0001f517          	auipc	a0,0x1f
    80005c94:	98850513          	addi	a0,a0,-1656 # 80024618 <cons+0x98>
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    80005cb6:	8ce50513          	addi	a0,a0,-1842 # 80024580 <cons>
  ...
  devsw[CONSOLE].read = consoleread;
    80005cca:	00015797          	auipc	a5,0x15
    80005cce:	5de78793          	addi	a5,a5,1502 # 8001b2a8 <devsw>
...
printint(int xx, int base, int sign)
{
  ...
  do {
    ...
    80005d0c:	b6060613          	addi	a2,a2,-1184 # 80008868 <digits>
...
panic(char *s)
{
  ...
  pr.locking = 0;
    ...
    80005da2:	8a07a123          	sw	zero,-1886(a5) # 80024640 <pr+0x18>
  printf("panic: ");
    80005da6:	00003517          	auipc	a0,0x3
    80005daa:	96a50513          	addi	a0,a0,-1686 # 80008710 <etext+0x710>
  ...
  panicked = 1; // freeze uart output from other CPUs
    ...
    80005dd6:	42f72523          	sw	a5,1066(a4) # 8000b1fc <panicked>
  for(;;)
...
0000000080005ddc <printf>:
{
  ...
  locking = pr.locking;
    80005dfc:	0001fd17          	auipc	s10,0x1f
    80005e00:	844d2d03          	lw	s10,-1980(s10) # 80024640 <pr+0x18>
  if(locking)
  ...
  consputc('x');
    ...
    80005e3e:	a2ea8a93          	addi	s5,s5,-1490 # 80008868 <digits>
    switch(c){
    ...
    80005e50:	7dc50513          	addi	a0,a0,2012 # 80024628 <pr>
    ...
    80005e74:	8b050513          	addi	a0,a0,-1872 # 80008720 <etext+0x720>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    80005f70:	7ac48493          	addi	s1,s1,1964 # 80008718 <etext+0x718>
      for(; *s; s++)
  ...
  if(locking)
    ...
    release(&pr.lock);
    80005fd2:	0001e517          	auipc	a0,0x1e
    80005fd6:	65650513          	addi	a0,a0,1622 # 80024628 <pr>
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    80005fee:	0001e497          	auipc	s1,0x1e
    80005ff2:	63a48493          	addi	s1,s1,1594 # 80024628 <pr>
    80005ff6:	00002597          	auipc	a1,0x2
    80005ffa:	73a58593          	addi	a1,a1,1850 # 80008730 <etext+0x730>
...
uartinit(void)
{
  ...
  initlock(&uart_tx_lock, "uart");
    ...
    80006056:	6e658593          	addi	a1,a1,1766 # 80008738 <etext+0x738>
    8000605a:	0001e517          	auipc	a0,0x1e
    8000605e:	5ee50513          	addi	a0,a0,1518 # 80024648 <uart_tx_lock>
...
uartputc_sync(int c)
{
  ...
  if(panicked){
    80006086:	00005797          	auipc	a5,0x5
    8000608a:	1767a783          	lw	a5,374(a5) # 8000b1fc <panicked>
...
uartstart()
{
  while(1){
    ...
    800060c0:	00005797          	auipc	a5,0x5
    800060c4:	1407b783          	ld	a5,320(a5) # 8000b200 <uart_tx_r>
    800060c8:	00005717          	auipc	a4,0x5
    800060cc:	14073703          	ld	a4,320(a4) # 8000b208 <uart_tx_w>
    800060d0:	06f70f63          	beq	a4,a5,8000614e <uartstart+0x8e>
{
    ...
    800060ee:	0001ea97          	auipc	s5,0x1e
    800060f2:	55aa8a93          	addi	s5,s5,1370 # 80024648 <uart_tx_lock>
    uart_tx_r += 1;
    800060f6:	00005497          	auipc	s1,0x5
    800060fa:	10a48493          	addi	s1,s1,266 # 8000b200 <uart_tx_r>
    ...
    if(uart_tx_w == uart_tx_r){
    80006102:	00005997          	auipc	s3,0x5
    80006106:	10698993          	addi	s3,s3,262 # 8000b208 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
...
0000000080006150 <uartputc>:
{
    ...
    8000615e:	1800                	addi	s0,sp,48
    80006160:	8a2a                	mv	s4,a0
  acquire(&uart_tx_lock);
    80006162:	0001e517          	auipc	a0,0x1e
    80006166:	4e650513          	addi	a0,a0,1254 # 80024648 <uart_tx_lock>
    8000616a:	00000097          	auipc	ra,0x0
    8000616e:	1a2080e7          	jalr	418(ra) # 8000630c <acquire>
  if(panicked){
    80006172:	00005797          	auipc	a5,0x5
    80006176:	08a7a783          	lw	a5,138(a5) # 8000b1fc <panicked>
    8000617a:	e7c9                	bnez	a5,80006204 <uartputc+0xb4>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    8000617c:	00005717          	auipc	a4,0x5
    80006180:	08c73703          	ld	a4,140(a4) # 8000b208 <uart_tx_w>
    80006184:	00005797          	auipc	a5,0x5
    80006188:	07c7b783          	ld	a5,124(a5) # 8000b200 <uart_tx_r>
    8000618c:	02078793          	addi	a5,a5,32
    sleep(&uart_tx_r, &uart_tx_lock);
    80006190:	0001e997          	auipc	s3,0x1e
    80006194:	4b898993          	addi	s3,s3,1208 # 80024648 <uart_tx_lock>
    80006198:	00005497          	auipc	s1,0x5
    8000619c:	06848493          	addi	s1,s1,104 # 8000b200 <uart_tx_r>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    800061a0:	00005917          	auipc	s2,0x5
    800061a4:	06890913          	addi	s2,s2,104 # 8000b208 <uart_tx_w>
  ...
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    ...
    800061be:	02078793          	addi	a5,a5,32
    800061c2:	fee785e3          	beq	a5,a4,800061ac <uartputc+0x5c>
  uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    800061c6:	0001e497          	auipc	s1,0x1e
    800061ca:	48248493          	addi	s1,s1,1154 # 80024648 <uart_tx_lock>
    800061ce:	01f77793          	andi	a5,a4,31
    800061d2:	97a6                	add	a5,a5,s1
    800061d4:	01478c23          	sb	s4,24(a5)
  uart_tx_w += 1;
    800061d8:	0705                	addi	a4,a4,1
    800061da:	00005797          	auipc	a5,0x5
    800061de:	02e7b723          	sd	a4,46(a5) # 8000b208 <uart_tx_w>
  uartstart();
...
uartintr(void)
{
  ...
  acquire(&uart_tx_lock);
    ...
    80006252:	3fa48493          	addi	s1,s1,1018 # 80024648 <uart_tx_lock>
...
000000008000630c <acquire>:
{
  ...
  lk->cpu = mycpu();
    ...
    80006354:	3f050513          	addi	a0,a0,1008 # 80008740 <etext+0x740>
...
pop_off(void)
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    800063a4:	3a850513          	addi	a0,a0,936 # 80008748 <etext+0x748>
    800063a8:	00000097          	auipc	ra,0x0
    800063ac:	9ea080e7          	jalr	-1558(ra) # 80005d92 <panic>
    panic("pop_off");
    800063b0:	00002517          	auipc	a0,0x2
    800063b4:	3b050513          	addi	a0,a0,944 # 80008760 <etext+0x760>
...
00000000800063c0 <release>:
{
  ...
  __sync_lock_release(&lk->locked);
    800063de:	0310000f          	fence	rw,w
    800063e2:	0004a023          	sw	zero,0(s1)
  pop_off();
    ...
    800063fc:	37050513          	addi	a0,a0,880 # 80008768 <etext+0x768>
